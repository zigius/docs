...
- Tutorial: Create a Kubernetes cluster on a cloud provider
  [Amazon EKS]({{< ref "/docs/quickstart/aws/tutorial-eks" >}}),
  [Google GKE]({{< ref "/docs/quickstart/gcp/tutorial-gke" >}}), or
  [Azure AKS](https://github.com/pulumi/examples/tree/master/azure-ts-aks-mean)
- Tutorial: [Operate and deploy to a Kubernetes cluster]({{< ref "/docs/quickstart/kubernetes/tutorial-exposed-deployment" >}})
