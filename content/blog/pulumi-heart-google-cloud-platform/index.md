...
this [GCE Web Server]({{ ref "/docs/quickstart/gcp/tutorial-gce-webserver" >}})
tutorial.
...
- [GKE Tutorial]({{< ref "/docs/quickstart/gcp/tutorial-gke" >}})
- [GCE Tutorial]({{< ref "/docs/quickstart/gcp/tutorial-gce-webserver" >}})
