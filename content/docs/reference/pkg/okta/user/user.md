...
<dl class="resources-properties">
    ...
    <dd>User's First Name, required by default.
</dd>
    ...
    <dd>User's Last Name, required by default.
</dd>
    ...
    <dd>User password recovery answer.
</dd>
    ...
    <dd>User password recovery question.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The raw status of the User in Okta - (status is mapped)
</dd>
