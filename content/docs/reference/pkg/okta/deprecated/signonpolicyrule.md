...
<dl class="resources-properties">
    ...
    <dd>Allow or deny access based on the rule conditions: ALLOW or DENY.
</dd>
...
invalid priority is provided. API defaults it to the last/lowest if not there.
    ...
    <dd>Whether session cookies will last across browser sessions. Okta Administrators can never have persistent session
cookies.
</dd>
