...
<dl class="resources-properties">
    ...
    <dd>The list of group ids to assign the users to.
</dd>
    ...
    <dd>The expression type to use to invoke the rule. The default is `"urn:okta:expression:1.0"`.
</dd>
    ...
    <dd>The status of the group rule.
</dd>
