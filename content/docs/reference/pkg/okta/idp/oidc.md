...
<dl class="resources-properties">
    ...
    <dd>The method of making a request for the OIDC JWKS. It can be set to `"HTTP-POST"` or `"HTTP-REDIRECT"`.
</dd>
    ...
    <dd>Endpoint where the signer of the keys publishes its keys in a JWK Set.
</dd>
    ...
    <dd>The type of ACS. Default is `"INSTANCE"`.
</dd>
    ...
    <dd>algorithm to use to sign requests
</dd>
    ...
    <dd>algorithm to use to sign response
</dd>
    ...
    <dd>Protected resource endpoint that returns claims about the authenticated user.
</dd>
