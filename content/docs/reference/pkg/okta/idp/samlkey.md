...
<dl class="resources-properties">
    ...
    <dd>base64-encoded X.509 certificate chain with DER encoding.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Identifies the cryptographic algorithm family used with the key.
</dd>
    ...
    <dd>Intended use of the public key.
</dd>
    ...
    <dd>base64url-encoded SHA-256 thumbprint of the DER encoding of an X.509 certificate.
</dd>
