...
<dl class="resources-properties">
    ...
    <dd>The name of the auth server to retrieve.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>last time credentials were rotated.
</dd>
    ...
    <dd>next time credentials will be rotated
</dd>
    ...
    <dd>mode of credential rotation, auto or manual.
</dd>
    ...
    <dd>description of Authorization server.
</dd>
    ...
    <dd>The name of the auth server.
</dd>
    ...
    <dd>the activation status of the authorization server.
</dd>
