...
<dl class="resources-properties">
    ...
    <dd>Specifies whether the claim is for an access token `"RESOURCE"` or ID token `"IDENTITY"`.
</dd>
    ...
    <dd>Specifies whether to include claims in token, by default is is set to `true`.
</dd>
    ...
    <dd>Specifies the type of group filter if `value_type` is `"GROUPS"`. Can be set to one of the following `"STARTS_WITH"`, `"EQUALS"`, `"CONTAINS"`, `"REGEX"`.
</dd>
    ...
    <dd>The list of scopes the auth server claim is tied to.
</dd>
    ...
    <dd>The status of the application. It defaults to `"ACTIVE"`.
</dd>
    ...
    <dd>The type of value of the claim. It can be set to `"EXPRESSION"` or `"GROUPS"`. It defaults to `"EXPRESSION"`.
</dd>
