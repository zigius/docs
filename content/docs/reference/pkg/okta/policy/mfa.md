...
<dl class="resources-properties">
    ...
    <dd>Fido U2F MFA policy settings.
</dd>
    ...
    <dd>Fido Web Authn MFA policy settings.
</dd>
    ...
    <dd>Google OTP MFA policy settings.
</dd>
    ...
    <dd>Okta Call MFA policy settings.
</dd>
    ...
    <dd>Okta OTP MFA policy settings.
</dd>
    ...
    <dd>Okta Password MFA policy settings.
</dd>
    ...
    <dd>Okta Push MFA policy settings.
</dd>
    ...
    <dd>Okta Question MFA policy settings.
</dd>
    ...
    <dd>Okta SMS MFA policy settings.
</dd>
    ...
    <dd>RSA Token MFA policy settings.
</dd>
    ...
    <dd>Symantec VIP MFA policy settings.
</dd>
    ...
    <dd>Yubikey Token MFA policy settings.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>User consent type required before enrolling in the factor: `"NONE"` or `"TERMS_OF_SERVICE"`. By default it is `"NONE"`.
</dd>
    ...
    <dd>Requirements for user initiated enrollment. Can be `"NOT_ALLOWED"`, `"OPTIONAL"`, or `"REQUIRED"`. By default it is `"OPTIONAL"`.
</dd>
