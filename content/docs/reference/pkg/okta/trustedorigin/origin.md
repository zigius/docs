...
<dl class="resources-properties">
    ...
    <dd>Scopes of the Trusted Origin - can be `"CORS"` and/or `"REDIRECT"`.
</dd>
    ...
    <dd>Whether the Trusted Origin is active or not - can only be issued post-creation.
</dd>
    ...
    <dd>Name of the Trusted Origin Resource.
</dd>
