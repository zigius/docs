...
<dl class="resources-properties">
    ...
    <dd>Type of the Network Zone - can either be IP or DYNAMIC only.
</dd>
    ...
    <dd>Array of locations ISO-3166-1(2). Format code: countryCode OR countryCode-regionCode.
</dd>
    ...
    <dd>Array of values in CIDR/range form.
</dd>
    ...
    <dd>Name of the Network Zone Resource.
</dd>
