...
<dl class="resources-properties">
    ...
    <dd>The interval (in minutes) at which this monitor should run.
</dd>
    ...
    <dd>The locations in which this monitor should be run.
</dd>
    ...
    <dd>The monitor status (i.e. `ENABLED`, `MUTED`, `DISABLED`).
</dd>
    ...
    <dd>The monitor type. Valid values are `SIMPLE`, `BROWSER`, `SCRIPT_BROWSER`, and `SCRIPT_API`.
</dd>
    ...
    <dd>The base threshold for the SLA report.
</dd>
    ...
    <dd>Fail the monitor check if redirected.
</dd>
    ...
    <dd>The URI for the monitor to hit.
</dd>
    ...
    <dd>The string to validate against in the response.
</dd>
