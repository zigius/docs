...
<dl class="resources-properties">
    ...
    <dd>An array of channel IDs (integers) to assign to the policy. Adding or removing channel IDs from this array will result
...
imported via terraform import.
    ...
    <dd>The rollup strategy for the policy.  Options include: `PER_POLICY`, `PER_CONDITION`, or `PER_CONDITION_AND_TARGET`.  The default is `PER_POLICY`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The time the policy was created.
</dd>
    ...
    <dd>The time the policy was last updated.
</dd>
