...
<dl class="resources-properties">
    ...
    <dd>The name of the algorithm to use for
the key. Currently-supported values are "RSA" and "ECDSA".
    ...
    <dd>When `algorithm` is "ECDSA", the name of the elliptic
...
default.
    ...
    <dd>When `algorithm` is "RSA", the size of the generated
...
<dl class="resources-properties">
    ...
    <dd>The private key data in PEM format.
</dd>
    ...
    <dd>The md5 hash of the public key data in
...
`public_key_openssh`.
    ...
    <dd>The public key data in OpenSSH `authorized_keys`
...
is selected.
    ...
    <dd>The public key data in PEM format.
</dd>
