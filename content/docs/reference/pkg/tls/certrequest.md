...
in `private_key_pem`.
    ...
    <dd>PEM-encoded private key that the certificate will belong to
</dd>
    ...
    <dd>The subject for which a certificate is being requested. This is
a nested configuration block whose structure is described below.
    ...
    <dd>List of DNS names for which a certificate is being requested.
</dd>
    ...
    <dd>List of IP addresses for which a certificate is being requested.
</dd>
    ...
    <dd>List of URIs for which a certificate is being requested.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The certificate request data in PEM format.
</dd>
