...
<dl class="resources-properties">
    ...
    <dd>The organization configured users must be part of.
</dd>
    ...
    <dd>The API endpoint to use. Useful if you
are running GitHub Enterprise or an API-compatible authentication server.
    ...
    <dd>Specifies the description of the mount.
This overrides the current stored value, if any.
    ...
    <dd>(Optional; Deprecated, use `token_max_ttl` instead if you are running Vault >= 1.2) The maximum allowed lifetime of tokens
...
<p class="property-message">Deprecated: use `token_max_ttl` instead if you are running Vault &gt;= 1.2</p></dd>
    ...
    <dd>Path where the auth backend is mounted. Defaults to `auth/github`
if not specified.
</dd>
    ...
    <dd>(Optional) List of CIDR blocks; if set, specifies blocks of IP
...
as well.
    ...
    <dd>(Optional) If set, will encode an
...
`token_max_ttl` would otherwise allow a renewal.
    ...
    <dd>(Optional) The maximum lifetime for generated tokens in number of seconds.
Its current value will be referenced at renewal time.
    ...
    <dd>(Optional) If set, the default policy will not be set on
...
value of this field. Specified in seconds.
    ...
    <dd>(Optional) List of policies to encode onto generated tokens. Depending
on the auth method, this list may be supplemented by user/group/other values.
    ...
    <dd>(Optional) The incremental lifetime for generated tokens in number of seconds.
Its current value will be referenced at renewal time.
</dd>
...
the mount. Valid values are "default-service", "default-batch", "service", "batch".
    ...
    <dd>(Optional; Deprecated, use `token_ttl` instead if you are running Vault >= 1.2) The TTL period of tokens issued
