...
<dl class="resources-properties">
    ...
    <dd>The path where the SSH secret backend is mounted. Defaults to 'ssh'
</dd>
    ...
    <dd>Whether Vault should generate the signing key pair internally. Defaults to true
</dd>
    ...
    <dd>The private key part the SSH CA key pair; required if generate_signing_key is false.
</dd>
    ...
    <dd>The public key part the SSH CA key pair; required if generate_signing_key is false.
</dd>
