...
<dl class="resources-properties">
    ...
    <dd>The unique name of the database connection to use for the static role.
</dd>
    ...
    <dd>The amount of time Vault should wait before rotating the password, in seconds.
</dd>
    ...
    <dd>The database username that this static role corresponds to.
</dd>
    ...
    <dd>A unique name to give the static role.
</dd>
    ...
    <dd>Database statements to execute to rotate the password for the configured database user.
</dd>
