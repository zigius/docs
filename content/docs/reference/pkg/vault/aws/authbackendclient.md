...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-vault/sdk/v2/go/vault/aws?tab=doc#AuthBackendClientArgs">AuthBackendClientArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dd>The AWS access key that Vault should use for the
auth backend.
</dd>
    ...
    <dd>The path the AWS auth backend being configured was
mounted at.  Defaults to `aws`.
    ...
    <dd>Override the URL Vault uses when making EC2 API
calls.
</dd>
    ...
    <dd>Override the URL Vault uses when making IAM API
calls.
</dd>
    ...
    <dd>The value to require in the
...
that are used in the IAM auth method.
    ...
    <dd>The AWS secret key that Vault should use for the
auth backend.
</dd>
    ...
    <dd>Override the URL Vault uses when making STS API
calls.
</dd>
