...
<dl class="resources-properties">
    ...
    <dd>DN of object to bind when performing user search
</dd>
    ...
    <dd>Password to use with `binddn` when performing user search
</dd>
    ...
    <dd>Trusted CA to validate TLS certificate
</dd>
    ...
    <dd>Description for the LDAP auth backend mount
</dd>
    ...
    <dd>LDAP attribute to follow on objects returned by groupfilter
</dd>
    ...
    <dd>Base DN under which to perform group search
</dd>
    ...
    <dd>Go template used to construct group membership query
</dd>
    ...
    <dd>Control whether or TLS certificates must be validated
</dd>
    ...
    <dd>Path to mount the LDAP auth backend under
</dd>
    ...
    <dd>Control use of TLS when conecting to LDAP
</dd>
    ...
    <dd>Maximum acceptable version of TLS
</dd>
    ...
    <dd>Minimum acceptable version of TLS
</dd>
...
requests a different type at generation time.
    ...
    <dd>The userPrincipalDomain used to construct UPN string
</dd>
    ...
    <dd>Use the Active Directory tokenGroups constructed attribute of the user to find the group memberships
</dd>
    ...
    <dd>Attribute on user object matching username passed in
</dd>
    ...
    <dd>Base DN under which to perform user search
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The accessor for this auth mount.
</dd>
