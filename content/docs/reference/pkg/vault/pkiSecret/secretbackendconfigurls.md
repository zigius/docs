...
<dl class="resources-properties">
    ...
    <dd>Specifies the URL values for the CRL Distribution Points field.
</dd>
    ...
    <dd>Specifies the URL values for the Issuing Certificate field.
</dd>
    ...
    <dd>Specifies the URL values for the OCSP Servers field.
</dd>
