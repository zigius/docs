...
<dl class="resources-properties">
    ...
    <dd>The ID of the role to log in with.
</dd>
    ...
    <dd>The unique path of the Vault backend to log in with.
</dd>
    ...
    <dd>The secret ID of the role to log in with. Required
...
<dl class="resources-properties">
    ...
    <dd>How long the token is valid for, in seconds.
</dd>
    ...
    <dd>The date and time the lease started, in RFC 3339 format.
</dd>
    ...
    <dd>The metadata associated with the token.
</dd>
    ...
    <dd>A list of policies applied to the token.
</dd>
    ...
    <dd>Whether the token is renewable or not.
</dd>
