...
<dl class="resources-properties">
    ...
    <dd>List of allowed policies for given role.
</dd>
...
<p class="property-message">Deprecated: use `token_bound_cidrs` instead if you are running Vault &gt;= 1.2</p></dd>
    ...
    <dd>List of disallowed policies for given role.
</dd>
    ...
    <dd>Number of seconds after which issued tokens can no longer be renewed.
<p class="property-message">Deprecated: use `token_explicit_max_ttl` instead if you are running Vault &gt;= 1.2</p></dd>
    ...
    <dd>If true, tokens created against this policy will be orphan tokens.
</dd>
    ...
    <dd>Tokens created against this role will have the given suffix as part of their path in addition to the role name.
</dd>
...
<p class="property-message">Deprecated: use `token_period` instead if you are running Vault &gt;= 1.2</p></dd>
    ...
    <dd>Wether to disable the ability of the token to be renewed past its initial TTL.
</dd>
