...
<dl class="resources-properties">
    ...
    <dd>The zone where the cluster is hosted.
</dd>
    ...
    <dd>The name of the GKE cluster you wish to import.
<p class="property-message">Deprecated: Please define cluster_id under integration_gke</p></dd>
    ...
    <dd>The image that will be used for the node VMs. Possible values: COS, UBUNTU.
</dd>
