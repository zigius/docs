...
<dl class="resources-properties">
    ...
    <dd>The Ocean cluster ID required for launchSpec create. 
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Optionally configure the amount of memory (MB) to allocate for each headroom unit.
</dd>
