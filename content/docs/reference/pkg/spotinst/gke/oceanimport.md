...
<dl class="resources-properties">
    ...
    <dd>The zone the master cluster is located in. 
</dd>
    ...
    <dd>Describes the backend service configurations.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Sets which location the backend services will be active. Valid values: `regional`, `global`.
</dd>
    ...
    <dd>Use when `location_type` is `regional`. Set the traffic for the backend service to either between the instances in the vpc or to traffic from the internet. Valid values: `INTERNAL`, `EXTERNAL`.
</dd>
