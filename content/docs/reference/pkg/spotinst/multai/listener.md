...
<dl class="resources-properties">
    ...
    <dd>The protocol to allow connections to the load balancer.
</dd>
    ...
    <dd>A list of key:value paired tags.
</dd>
    ...
    <dd>Describes the TLSConfig configuration.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Contains one or more certificate chains to present to the other side of the connection.
</dd>
    ...
    <dd>List of supported cipher suites. If cipherSuites is nil, TLS uses a list of suites supported by the implementation.
</dd>
    ...
    <dd>MaxVersion contains the maximum SSL/TLS version that is acceptable.
</dd>
    ...
    <dd>MinVersion contains the minimum SSL/TLS version that is acceptable (1.0 is the minimum).
</dd>
    ...
    <dd>Controls whether the server selects the client’s most preferred ciphersuite, or the server’s most preferred ciphersuite.
</dd>
    ...
    <dd>May be set to true to disable session ticket (resumption) support.
</dd>
