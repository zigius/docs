...
<dl class="resources-properties">
    ...
    <dd>The balancer name. May contain only alphanumeric characters or hyphens, and must not begin or end with a hyphen.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The time for the load balancer to keep connections alive before reporting the target as de-registered, in seconds (range: 1 - 3600).
</dd>
    ...
    <dd>The idle timeout value, in seconds. (range: 1 - 3600).
</dd>
