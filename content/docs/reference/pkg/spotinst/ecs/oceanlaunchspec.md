...
<dl class="resources-properties">
    ...
    <dd>The Ocean Launch Specification name. 
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Optionally configure the number of CPUs to allocate for each headroom unit. CPUs are denoted in CPU units, where 1024 units = 1 vCPU.
</dd>
