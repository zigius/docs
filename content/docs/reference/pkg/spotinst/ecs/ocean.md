...
<dl class="resources-properties">
    ...
    <dd>Describes the Ocean ECS autoscaler.
</dd>
    ...
    <dd>Instance types allowed in the Ocean cluster.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Spare resource capacity management enabling fast assignment of tasks without waiting for new resources to launch.
</dd>
    ...
    <dd>Enable the Ocean ECS autoscaler.
</dd>
