...
<dl class="resources-properties">
    ...
    <dd>One or more instance types. To maximize the availability of Spot instances, select as many instance types as possible.
</dd>
...
For EC2 Classic instances:  `"Linux/UNIX (Amazon VPC)"`, `"SUSE Linux (Amazon VPC)"`, `"Windows (Amazon VPC)"`.
    ...
    <dd>The AWS region your group will be created in. Cannot be changed after the group has been created.
</dd>
    ...
    <dd>The id of an existing Beanstalk environment. 
</dd>
    ...
    <dd>The name of an existing Beanstalk environment.
</dd>
    ...
    <dd>Preferences when performing a roll
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Should roll perform automatically
</dd>
    ...
    <dd>Amount of time to wait between batches
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Bool value if to wait to drain instance 
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Actions to perform (options: timeWindow, never)
</dd>
    ...
    <dd>Time Window for when action occurs ex. Mon:23:50-Tue:00:20
</dd>
