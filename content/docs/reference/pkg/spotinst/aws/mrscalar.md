...
<dl class="resources-properties">
    ...
    <dd>The MrScaler strategy. Allowed values are `new` `clone` and `wrap`.
</dd>
    ...
    <dd><p class="property-message">Deprecated: This field has been removed from our API and is no longer functional.</p></dd>
