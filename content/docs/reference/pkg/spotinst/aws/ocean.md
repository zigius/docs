...
<dl class="resources-properties">
    ...
    <dd>A comma-separated list of subnet identifiers for the Ocean cluster. Subnet IDs should be configured with auto assign public ip.
</dd>
    ...
    <dd>Configure public IP address allocation.
</dd>
    ...
    <dd>Describes the Ocean Kubernetes autoscaler.
</dd>
    ...
    <dd>Instance types not allowed in the Ocean cluster. Cannot be configured if `whitelist` is configured.
</dd>
    ...
    <dd>The ocean cluster identifier. Example: `ocean.k8s`
</dd>
    ...
    <dd>The number of instances to launch and maintain in the cluster.
</dd>
    ...
    <dd>Enable EBS optimized for cluster. Flag will enable optimized capacity for high bandwidth connectivity to the EB service for non EBS optimized instance types. For instances that are EBS optimized this flag will be ignored.
</dd>
    ...
    <dd>If not Spot instance markets are available, enable Ocean to launch On-Demand instances instead.
</dd>
    ...
    <dd>The amount of time, in seconds, after the instance has launched to start checking its health.
</dd>
    ...
    <dd>The instance profile iam role.
</dd>
    ...
    <dd>ID of the image used to launch the instances.
</dd>
    ...
    <dd>The key pair to attach the instances.
</dd>
    ...
    <dd>- Array of load balancer objects to add to ocean cluster
</dd>
    ...
    <dd>The upper limit of instances the cluster can scale up to.
</dd>
    ...
    <dd>The lower limit of instances the cluster can scale down to.
</dd>
    ...
    <dd>Enable detailed monitoring for cluster. Flag will enable Cloud Watch detailed detailed monitoring (one minute increments). Note: there are additional hourly costs for this service based on the region used.
</dd>
    ...
    <dd>Required if type is set to CLASSIC
</dd>
    ...
    <dd>The region the cluster will run in.
</dd>
    ...
    <dd>The size (in Gb) to allocate for the root volume. Minimum `20`.
</dd>
    ...
    <dd>Optionally adds tags to instances launched in an Ocean cluster.
</dd>
    ...
    <dd>Base64-encoded MIME user data to make available to the instances.
</dd>
    ...
    <dd>If Reserved instances exist, OCean will utilize them before launching Spot instances.
</dd>
    ...
    <dd>Instance types allowed in the Ocean cluster. Cannot be configured if `blacklist` is configured.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Set the auto headroom percentage (a number in the range [0, 200]) which controls the percentage of headroom from the cluster. Relevant only when `isAutoConfig` toggled on.
</dd>
    ...
    <dd>Cooldown period between scaling actions.
</dd>
    ...
    <dd>Auto Scaling scale down operations.
</dd>
    ...
    <dd>Spare resource capacity management enabling fast assignment of Pods without waiting for new resources to launch.
</dd>
    ...
    <dd>Automatically configure and optimize headroom resources.
</dd>
    ...
    <dd>Enable the Ocean Kubernetes autoscaler.
</dd>
    ...
    <dd>Optionally set upper and lower bounds on the resource usage of the cluster.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The number of evaluation periods that should accumulate before a scale down action takes place.
</dd>
    ...
    <dd>Would represent the maximum % to scale-down. Number between 1-100.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Optionally configure the number of CPUs to allocate the headroom. CPUs are denoted in millicores, where 1000 millicores = 1 vCPU.
</dd>
    ...
    <dd>Optionally configure the number of GPUS to allocate the headroom.
</dd>
    ...
    <dd>Optionally configure the amount of memory (MB) to allocate the headroom.
</dd>
    ...
    <dd>The number of units to retain as headroom, where each unit has the defined headroom CPU and memory.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The maximum memory in GiB units that can be allocated to the cluster.
</dd>
    ...
    <dd>The maximum cpu in vCPU units that can be allocated to the cluster.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Required if type is set to TARGET_GROUP
</dd>
    ...
    <dd>Can be set to CLASSIC or TARGET_GROUP
</dd>
