...
<dl class="resources-properties">
    ...
    <dd>The ocean cluster you wish to 
</dd>
    ...
    <dd>Set custom headroom per launch spec. provide list of headrooms object.
</dd>
    ...
    <dd>Optionally adds labels to instances launched in an Ocean cluster.
</dd>
    ...
    <dd>Set Launch Specification name 
</dd>
    ...
    <dd>Optionally adds security group IDs.
</dd>
    ...
    <dd>Set subnets in launchSpec. Each element in array should be subnet ID.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The number of units to retain as headroom, where each unit has the defined headroom CPU, memory and GPU.
</dd>
    ...
    <dd>Optionally configure the number of CPUs to allocate for each headroom unit. CPUs are denoted in millicores, where 1000 millicores = 1 vCPU.
</dd>
    ...
    <dd>Optionally configure the number of GPUS to allocate for each headroom unit.
</dd>
    ...
    <dd>Optionally configure the amount of memory (MiB) to allocate for each headroom unit.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The effect of the taint. Valid values: `"NoSchedule"`, `"PreferNoSchedule"`, `"NoExecute"`.
</dd>
