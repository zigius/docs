...
<dl class="resources-properties">
    ...
    <dd>The ID of the Droplet from which the snapshot will be taken.
</dd>
    ...
    <dd>A name for the Droplet snapshot.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The minimum size in gigabytes required for a Droplet to be created based on this snapshot.
</dd>
