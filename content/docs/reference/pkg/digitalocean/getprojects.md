...
<dl class="resources-properties">
    ...
    <dd>A set of projects satisfying any `filter` and `sort` criteria. Each project has
...
<dl class="resources-properties">
    ...
    <dd>Filter the projects by this key. This may be one of `name`,
`purpose`, `description`, `environment`, or `is_default`.
    ...
    <dd>A list of values to match against the `key` field. Only retrieves projects
...
<dl class="resources-properties">
    ...
    <dd>Sort the projects by this key. This may be one of `name`,
