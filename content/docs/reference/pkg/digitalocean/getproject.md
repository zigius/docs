...
<dl class="resources-properties">
    ...
    <dd>the ID of the project to retrieve
</dd>
    ...
    <dd>the name of the project to retrieve. The data source will raise an error if more than
...
<dl class="resources-properties">
    ...
    <dd>The date and time when the project was created, (ISO8601)
</dd>
    ...
    <dd>The environment of the project's resources. The possible values are: `Development`, `Staging`, `Production`.
</dd>
    ...
    <dd>The ID of the project owner.
</dd>
    ...
    <dd>The unique universal identifier of the project owner.
</dd>
    ...
    <dd>The purpose of the project, (Default: "Web Application")
</dd>
    ...
    <dd>A set of uniform resource names (URNs) for the resources associated with the project
</dd>
    ...
    <dd>The date and time when the project was last updated, (ISO8601)
</dd>
