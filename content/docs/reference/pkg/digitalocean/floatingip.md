...
<dl class="resources-properties">
    ...
    <dd>The region that the Floating IP is reserved to.
</dd>
    ...
    <dd>The ID of Droplet that the Floating IP will be assigned to.
</dd>
    ...
    <dd>The IP Address of the resource
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The uniform resource name of the floating ip
</dd>
