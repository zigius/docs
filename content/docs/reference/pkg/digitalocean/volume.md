...
<dl class="resources-properties">
    ...
    <dd>The region that the block storage volume will be created in.
</dd>
    ...
    <dd>The size of the block storage volume in GiB. If updated, can only be expanded.
</dd>
    ...
    <dd>A free-form text field up to a limit of 1024 bytes to describe a block storage volume.
</dd>
    ...
    <dd>Filesystem type (`xfs` or `ext4`) for the block storage volume.
<p class="property-message">Deprecated: This fields functionality has been replaced by `initial_filesystem_type`. The property will still remain as a computed attribute representing the current volumes filesystem type.</p></dd>
    ...
    <dd>Initial filesystem label for the block storage volume.
</dd>
    ...
    <dd>Initial filesystem type (`xfs` or `ext4`) for the block storage volume.
</dd>
    ...
    <dd>A name for the block storage volume. Must be lowercase and be composed only of numbers, letters and "-", up to a limit of 64 characters.
</dd>
    ...
    <dd>The ID of an existing volume snapshot from which the new volume will be created. If supplied, the region and size will be limitied on creation to that of the referenced snapshot
</dd>
    ...
    <dd>A list of the tags to be applied to this Volume.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of associated droplet ids.
</dd>
    ...
    <dd>Filesystem label for the block storage volume.
</dd>
    ...
    <dd>The uniform resource name for the volume.
</dd>
