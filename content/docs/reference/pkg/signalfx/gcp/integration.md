...
<dl class="resources-properties">
    ...
    <dd>GCP integration poll rate in seconds. Can be set to either 60 or 300 (1 minute or 5 minutes).
</dd>
    ...
    <dd>GCP service metrics to import. Can be an empty list, or not included, to import 'All services'.
</dd>
