...
<dl class="resources-properties">
    ...
    <dd>The name of this integration
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The external ID to use with your IAM role and with `signalfx.aws.Integration`.
</dd>
    ...
    <dd>The AWS Account ARN to use with your policies/roles, provided by SignalFx.
</dd>
