...
<dl class="resources-properties">
    ...
    <dd>List of user IDs to include in the team.
</dd>
    ...
    <dd>Where to send notifications for critical alerts
</dd>
    ...
    <dd>Where to send notifications for default alerts
</dd>
    ...
    <dd>Where to send notifications for info alerts
</dd>
    ...
    <dd>Where to send notifications for major alerts
</dd>
    ...
    <dd>Where to send notifications for minor alerts
</dd>
    ...
    <dd>Where to send notifications for warning alerts
</dd>
