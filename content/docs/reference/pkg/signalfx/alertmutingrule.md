...
<dl class="resources-properties">
    ...
    <dd>The description for this muting rule
</dd>
    ...
    <dd>Filters for this rule. See [Creating muting rules from scratch](https://docs.signalfx.com/en/latest/detect-alert/mute-notifications.html#rule-from-scratch) for more information.
</dd>
    ...
    <dd>Starting time of an alert muting rule as a Unit time stamp in seconds.
</dd>
    ...
    <dd>A convenience attribute that associated this muting rule with specific detector ids.
</dd>
    ...
    <dd>Starting time of an alert muting rule as a Unix time stamp in seconds.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The property value to filter.
</dd>
    ...
    <dd>Determines if this is a "not" filter. Defaults to `false`.
</dd>
