...
<dl class="resources-properties">
    ...
    <dd>The ARN of the resource share.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ARN of the resource share invitation.
</dd>
    ...
    <dd>The account ID of the receiver account which accepts the invitation.
</dd>
    ...
    <dd>A list of the resource ARNs shared via the resource share.
</dd>
    ...
    <dd>The account ID of the sender account which submits the invitation.
</dd>
    ...
    <dd>The ID of the resource share as displayed in the console.
</dd>
    ...
    <dd>The status of the resource share (ACTIVE, PENDING, FAILED, DELETING, DELETED).
</dd>
