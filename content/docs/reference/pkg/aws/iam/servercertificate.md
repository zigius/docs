...
PEM-encoded format.
    ...
    <dd>The contents of the private key in PEM-encoded format.
</dd>
    ...
    <dd>The Amazon Resource Name (ARN) specifying the server certificate.
</dd>
...
of the chain.
    ...
    <dd>The name of the Server Certificate. Do not include the
