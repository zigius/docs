...
<dl class="resources-properties">
    ...
    <dd>A list of client IDs (also known as audiences). When a mobile or web app registers with an OpenID Connect provider, they establish a value that identifies the application. (This is the value that's sent as the client_id parameter on OAuth requests.)
</dd>
    ...
    <dd>A list of server certificate thumbprints for the OpenID Connect (OIDC) identity provider's server certificate(s). 
</dd>
    ...
    <dd>The URL of the identity provider. Corresponds to the _iss_ claim.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ARN assigned by AWS for this provider.
</dd>
