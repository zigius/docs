...
<dl class="resources-properties">
    ...
    <dd>The IAM Group name to attach the list of `users` to
</dd>
    ...
    <dd>A list of IAM User names to associate with the Group
</dd>
    ...
    <dd>The name to identify the Group Membership
</dd>
