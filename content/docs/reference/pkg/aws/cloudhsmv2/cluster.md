...
<dl class="resources-properties">
    ...
    <dd>The type of HSM module in the cluster. Currently, only hsm1.medium is supported.
</dd>
    ...
    <dd>The IDs of subnets in which cluster will operate.
</dd>
    ...
    <dd>The id of Cloud HSM v2 cluster backup to be restored.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The list of cluster certificates.
...
* `cluster_certificates.0.manufacturer_hardware_certificate` - The HSM hardware certificate issued (signed) by the hardware manufacturer.
    ...
    <dd>The id of the CloudHSM cluster.
</dd>
    ...
    <dd>The ID of the security group associated with the CloudHSM cluster.
</dd>
    ...
    <dd>The id of the VPC that the CloudHSM cluster resides in.
</dd>
