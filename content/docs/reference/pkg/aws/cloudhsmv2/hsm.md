...
<dl class="resources-properties">
    ...
    <dd>The ID of Cloud HSM v2 cluster to which HSM will be added.
</dd>
    ...
    <dd>The IDs of AZ in which HSM module will be located. Do not use together with subnet_id.
</dd>
    ...
    <dd>The IP address of HSM module. Must be within the CIDR of selected subnet.
</dd>
    ...
    <dd>The ID of subnet in which HSM module will be located.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The id of the ENI interface allocated for HSM module.
</dd>
    ...
    <dd>The state of the HSM module.
</dd>
