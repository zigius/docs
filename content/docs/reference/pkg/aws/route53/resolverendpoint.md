...
<dl class="resources-properties">
    ...
    <dd>The direction of DNS queries to or from the Route 53 Resolver endpoint.
...
or `OUTBOUND` (resolver forwards DNS queries from the DNS service for a VPC to your network or another VPC).
    ...
    <dd>The subnets and IP addresses in your VPC that you want DNS queries to pass through on the way from your VPCs
to your network (for outbound endpoints) or on the way from your network to your VPCs (for inbound endpoints). Described below.
    ...
    <dd>The ID of one or more security groups that you want to use to control access to this VPC.
</dd>
    ...
    <dd>The friendly name of the Route 53 Resolver endpoint.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ARN of the Route 53 Resolver endpoint.
</dd>
    ...
    <dd>The ID of the VPC that you want to create the resolver endpoint in.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ID of the subnet that contains the IP address.
</dd>
    ...
    <dd>The IP address in the subnet that you want to use for DNS queries.
</dd>
