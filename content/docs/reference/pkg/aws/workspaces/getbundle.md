...
<dl class="resources-properties">
    ...
    <dd>The compute type. See supported fields below.
</dd>
    ...
    <dd>The description of the bundle.
</dd>
    ...
    <dd>The name of the compute type.
</dd>
    ...
    <dd>The root volume. See supported fields below.
</dd>
    ...
    <dd>The user storage. See supported fields below.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The size of the user storage.
</dd>
