...
<dl class="resources-properties">
    ...
    <dd>Specific runtime the layer version must support. Conflicts with `version`. If specified, the latest available layer version supporting the provided runtime will be used.
</dd>
    ...
    <dd>Specific layer version. Conflicts with `compatible_runtime`. If omitted, the latest available layer version will be used.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The Amazon Resource Name (ARN) of the Lambda Layer with version.
</dd>
    ...
    <dd>A list of [Runtimes][1] the specific Lambda Layer version is compatible with.
</dd>
    ...
    <dd>The date this resource was created.
</dd>
    ...
    <dd>Description of the specific Lambda Layer version.
</dd>
    ...
    <dd>The Amazon Resource Name (ARN) of the Lambda Layer without version.
</dd>
    ...
    <dd>License info associated with the specific Lambda Layer version.
</dd>
