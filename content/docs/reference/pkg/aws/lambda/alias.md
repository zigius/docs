...
<dl class="resources-properties">
    ...
    <dd>The function ARN of the Lambda function for which you want to create an alias.
</dd>
    ...
    <dd>Lambda function version for which you are creating the alias. Pattern: `(\$LATEST|[0-9]+)`.
</dd>
    ...
    <dd>Name for the alias you are creating. Pattern: `(?!^[0-9]+$)([a-zA-Z0-9-_]+)`
</dd>
    ...
    <dd>The Lambda alias' route configuration settings. Fields documented below
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The Amazon Resource Name (ARN) identifying your Lambda function alias.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A map that defines the proportion of events that should be sent to different versions of a lambda function.
</dd>
