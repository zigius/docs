...
<dl class="resources-properties">
    ...
    <dd>Name or Amazon Resource Name (ARN) of the Lambda Function.
</dd>
    ...
    <dd>Amount of capacity to allocate. Must be greater than or equal to `1`.
</dd>
    ...
    <dd>Lambda Function version or Lambda Alias name.
</dd>
