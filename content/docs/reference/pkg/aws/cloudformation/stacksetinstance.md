...
<dl class="resources-properties">
    ...
    <dd>Target AWS Account ID to create a Stack based on the StackSet. Defaults to current account.
</dd>
    ...
    <dd>Key-value map of input parameters to override from the StackSet for this Instance.
</dd>
    ...
    <dd>Target AWS Region to create a Stack based on the StackSet. Defaults to current region.
</dd>
    ...
    <dd>During resource destroy, remove Instance from StackSet while keeping the Stack and its associated resources. Must be enabled in the state _before_ destroy operation to take effect. You cannot reassociate a retained Stack or add an existing, saved Stack to a new StackSet. Defaults to `false`.
</dd>
