...
<dl class="resources-properties">
    ...
    <dd>Configuration block containing encryption configuration. Detailed below.
</dd>
    ...
    <dd>Name of the security configuration.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A `s3_encryption ` block as described below, which contains encryption configuration for S3 data.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Encryption mode to use for CloudWatch data. Valid values: `DISABLED`, `SSE-KMS`. Default value: `DISABLED`.
</dd>
    ...
    <dd>Amazon Resource Name (ARN) of the KMS key to be used to encrypt the data.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Encryption mode to use for job bookmarks data. Valid values: `CSE-KMS`, `DISABLED`. Default value: `DISABLED`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Encryption mode to use for S3 data. Valid values: `DISABLED`, `SSE-KMS`, `SSE-S3`. Default value: `DISABLED`.
</dd>
