...
<dl class="resources-properties">
    ...
    <dd>List of actions initiated by this trigger when it fires. Defined below.
</dd>
    ...
    <dd>The type of trigger. Valid values are `CONDITIONAL`, `ON_DEMAND`, and `SCHEDULED`.
</dd>
    ...
    <dd>A description of the new trigger.
</dd>
    ...
    <dd>Start the trigger. Defaults to `true`. Not valid to disable for `ON_DEMAND` type.
</dd>
    ...
    <dd>A predicate to specify when the new trigger should fire. Required when trigger type is `CONDITIONAL`. Defined below.
</dd>
    ...
    <dd>A cron expression used to specify the schedule. [Time-Based Schedules for Jobs and Crawlers](https://docs.aws.amazon.com/glue/latest/dg/monitor-data-warehouse-schedule.html)
</dd>
    ...
    <dd>A workflow to which the trigger should be associated to. Every workflow graph (DAG) needs a starting trigger (`ON_DEMAND` or `SCHEDULED` type) and can contain multiple additional `CONDITIONAL` triggers.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Amazon Resource Name (ARN) of Glue Trigger
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Arguments to be passed to the job. You can specify arguments here that your own job-execution script consumes, as well as arguments that AWS Glue itself consumes.
</dd>
    ...
    <dd>The name of the crawler to be executed. Conflicts with `job_name`.
</dd>
    ...
    <dd>The name of a job to be executed. Conflicts with `crawler_name`.
</dd>
    ...
    <dd>The job run timeout in minutes. It overrides the timeout value of the job.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of the conditions that determine when the trigger will fire. Defined below.
</dd>
    ...
    <dd>How to handle multiple conditions. Defaults to `AND`. Valid values are `AND` or `ANY`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The condition crawl state. Currently, the values supported are `RUNNING`, `SUCCEEDED`, `CANCELLED`, and `FAILED`. If this is specified, `crawler_name` must also be specified. Conflicts with `state`.
</dd>
    ...
    <dd>The name of the crawler to watch. If this is specified, `crawl_state` must also be specified. Conflicts with `job_name`.
</dd>
    ...
    <dd>The name of the job to watch. If this is specified, `state` must also be specified. Conflicts with `crawler_name`.
</dd>
    ...
    <dd>A logical operator. Defaults to `EQUALS`.
</dd>
    ...
    <dd>The condition job state. Currently, the values supported are `SUCCEEDED`, `STOPPED`, `TIMEOUT` and `FAILED`. If this is specified, `job_name` must also be specified. Conflicts with `crawler_state`.
</dd>
