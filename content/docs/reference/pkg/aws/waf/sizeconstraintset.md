...
<dl class="resources-properties">
    ...
    <dd>The name or description of the Size Constraint Set.
</dd>
    ...
    <dd>Specifies the parts of web requests that you want to inspect the size of.
</dd>
...
See [docs](http://docs.aws.amazon.com/waf/latest/APIReference/API_SizeConstraint.html#WAF-Type-SizeConstraint-ComparisonOperator) for all supported values.
    ...
    <dd>Specifies where in a web request to look for the size constraint.
</dd>
    ...
    <dd>The size in bytes that you want to compare against the size of the specified `field_to_match`.
