...
<dl class="resources-properties">
    ...
    <dd>The Unix epoch time stamp in seconds for when the cluster was created.
</dd>
    ...
    <dd>The enabled control plane logs.
</dd>
    ...
    <dd>The Amazon Resource Name (ARN) of the IAM role that provides permissions for the Kubernetes control plane to make calls to AWS API operations on your behalf.
</dd>
    ...
    <dd>The Kubernetes server version for the cluster.
</dd>
    ...
    <dd>Nested list containing VPC configuration for the cluster.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Indicates whether or not the Amazon EKS private API server endpoint is enabled.
</dd>
    ...
    <dd>Indicates whether or not the Amazon EKS public API server endpoint is enabled.
</dd>
    ...
    <dd>List of CIDR blocks. Indicates which CIDR blocks can access the Amazon EKS public API server endpoint.
</dd>
