...
<dl class="resources-properties">
    ...
    <dd>Returns the list of snapshots created by the specific db_cluster
</dd>
...
The default is `false`.
    ...
    <dd>The type of snapshots to be returned. If you don't specify a SnapshotType
...
<dl class="resources-properties">
    ...
    <dd>List of EC2 Availability Zones that instances in the DB cluster snapshot can be restored in.
</dd>
    ...
    <dd>The Amazon Resource Name (ARN) for the DB Cluster Snapshot.
</dd>
    ...
    <dd>Version of the database engine for this DB cluster snapshot.
</dd>
    ...
    <dd>If storage_encrypted is true, the AWS KMS key identifier for the encrypted DB cluster snapshot.
</dd>
    ...
    <dd>License model information for the restored DB cluster.
</dd>
    ...
    <dd>Port that the DB cluster was listening on at the time of the snapshot.
</dd>
    ...
    <dd>Time when the snapshot was taken, in Universal Coordinated Time (UTC).
</dd>
    ...
    <dd>The status of this DB Cluster Snapshot.
</dd>
    ...
    <dd>Specifies whether the DB cluster snapshot is encrypted.
</dd>
    ...
    <dd>The VPC ID associated with the DB cluster snapshot.
</dd>
    ...
    <dd>Specifies the DB cluster identifier of the DB cluster that this DB cluster snapshot was created from.
</dd>
