...
<dl class="resources-properties">
    ...
    <dd>The global cluster identifier.
</dd>
    ...
    <dd>Name for an automatically created database on cluster creation.
</dd>
    ...
    <dd>If the Global Cluster should have deletion protection enabled. The database can't be deleted when this value is set to `true`. The default is `false`.
</dd>
    ...
    <dd>Name of the database engine to be used for this DB cluster. Valid values: `aurora`, `aurora-mysql`, `aurora-postgresql`. Defaults to `aurora`.
</dd>
    ...
    <dd>Engine version of the Aurora global database.
...
<dl class="resources-properties">
    ...
    <dd>RDS Global Cluster Amazon Resource Name (ARN)
</dd>
    ...
    <dd>AWS Region-unique, immutable identifier for the global database cluster. This identifier is found in AWS CloudTrail log entries whenever the AWS KMS key for the DB cluster is accessed
</dd>
