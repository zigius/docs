...
<dl class="resources-properties">
    ...
    <dd>Specifies the name of the engine that this option group should be associated with.
</dd>
    ...
    <dd>Specifies the major version of the engine that this option group should be associated with.
</dd>
    ...
    <dd>Creates a unique name beginning with the specified prefix. Conflicts with `name`. Must be lowercase, to match as it is stored in AWS.
</dd>
    ...
    <dd>The description of the option group. Defaults to "Managed by Pulumi".
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ARN of the db option group.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The Name of the Option (e.g. MEMCACHED).
</dd>
    ...
    <dd>A list of DB Security Groups for which the option is enabled.
</dd>
    ...
    <dd>A list of option settings to apply.
</dd>
    ...
    <dd>The Port number when connecting to the Option (e.g. 11211).
</dd>
    ...
    <dd>The version of the option (e.g. 13.1.0.0).
</dd>
    ...
    <dd>A list of VPC Security Groups for which the option is enabled.
</dd>
