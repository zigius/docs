...
<dl class="resources-properties">
    ...
    <dd>A list of filters. Passed directly to the API (see GetProducts API reference). These filters must describe a single product, this resource will fail if more than one product is returned by the API.
</dd>
    ...
    <dd>The code of the service. Available service codes can be fetched using the DescribeServices pricing API call.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Set to the product returned from the API.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The product attribute name that you want to filter on.
</dd>
    ...
    <dd>The product attribute value that you want to filter on.
</dd>
