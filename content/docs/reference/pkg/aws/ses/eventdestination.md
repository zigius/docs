...
<dl class="resources-properties">
    ...
    <dd>The name of the configuration set
</dd>
    ...
    <dd>A list of matching types. May be any of `"send"`, `"reject"`, `"bounce"`, `"complaint"`, `"delivery"`, `"open"`, `"click"`, or `"renderingFailure"`.
</dd>
    ...
    <dd>CloudWatch destination for the events
</dd>
    ...
    <dd>If true, the event destination will be enabled
</dd>
    ...
    <dd>Send the events to a kinesis firehose destination
</dd>
    ...
    <dd>The name of the event destination
</dd>
    ...
    <dd>Send the events to an SNS Topic destination
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The default value for the event
</dd>
    ...
    <dd>The source for the value. It can be either `"messageTag"` or `"emailHeader"`
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ARN of the role that has permissions to access the Kinesis Stream
</dd>
