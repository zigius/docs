...
<dl class="resources-properties">
    ...
    <dd>ID of the mount target that you want to have described
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The DNS name for the given subnet/AZ per [documented convention](http://docs.aws.amazon.com/efs/latest/ug/mounting-fs-mount-cmd-dns-name.html).
</dd>
    ...
    <dd>Amazon Resource Name of the file system for which the mount target is intended.
</dd>
    ...
    <dd>ID of the file system for which the mount target is intended.
</dd>
    ...
    <dd>Address at which the file system may be mounted via the mount target.
</dd>
    ...
    <dd>The ID of the network interface that Amazon EFS created when it created the mount target.
</dd>
    ...
    <dd>List of VPC security group IDs attached to the mount target.
</dd>
    ...
    <dd>ID of the mount target's subnet.
</dd>
