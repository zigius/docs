...
<dl class="resources-properties">
    ...
    <dd>The full path of the resource.  If no path is found, an error will be returned.
</dd>
    ...
    <dd>The REST API id that owns the resource. If no REST API is found, an error will be returned.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Set to the ID of the parent Resource.
</dd>
    ...
    <dd>Set to the path relative to the parent Resource.
</dd>
