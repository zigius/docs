...
<dl class="resources-properties">
    ...
    <dd>The associated API stages of the usage plan.
</dd>
    ...
    <dd>The description of a usage plan.
</dd>
    ...
    <dd>The AWS Markeplace product identifier to associate with the usage plan as a SaaS product on AWS Marketplace.
</dd>
    ...
    <dd>The quota settings of the usage plan.
</dd>
    ...
    <dd>The throttling limits of the usage plan.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>API Id of the associated API stage in a usage plan.
</dd>
    ...
    <dd>API stage name of the associated API stage in a usage plan.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The maximum number of requests that can be made in a given time period.
</dd>
    ...
    <dd>The time period in which the limit applies. Valid values are "DAY", "WEEK" or "MONTH".
</dd>
    ...
    <dd>The number of requests subtracted from the given limit in the initial time period.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The API request burst limit, the maximum rate limit over a time ranging from one to a few seconds, depending upon whether the underlying token bucket is at its full capacity.
</dd>
    ...
    <dd>The API request steady-state rate limit.
</dd>
