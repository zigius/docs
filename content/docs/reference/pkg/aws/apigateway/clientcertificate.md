...
<dl class="resources-properties">
    ...
    <dd>The description of the client certificate.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The date when the client certificate was created.
</dd>
    ...
    <dd>The date when the client certificate will expire.
</dd>
    ...
    <dd>The PEM-encoded public key of the client certificate.
</dd>
