...
<dl class="resources-properties">
    ...
    <dd>Hash key to use for lookups and identification of the item
</dd>
    ...
    <dd>JSON representation of a map of attribute name/value pairs, one for each attribute.
Only the primary key attributes are required; you can optionally provide other attribute name-value pairs for the item.
    ...
    <dd>The name of the table to contain the item.
</dd>
    ...
    <dd>Range key to use for lookups and identification of the item. Required if there is range key defined in the table.
</dd>
