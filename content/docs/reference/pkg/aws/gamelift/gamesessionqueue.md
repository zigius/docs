...
<dl class="resources-properties">
    ...
    <dd>List of fleet/alias ARNs used by session queue for placing game sessions.
</dd>
    ...
    <dd>One or more policies used to choose fleet based on player latency. See below.
</dd>
    ...
    <dd>Maximum time a game session request can remain in the queue.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Maximum latency value that is allowed for any player.
</dd>
    ...
    <dd>Length of time that the policy is enforced while placing a new game session. Absence of value for this attribute means that the policy is enforced until the queue times out.
</dd>
