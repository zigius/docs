...
<dl class="resources-properties">
    ...
    <dd>The type of instance to connect to the environment, e.g. `t2.micro`.
</dd>
    ...
    <dd>The number of minutes until the running instance is shut down after the environment has last been used.
</dd>
    ...
    <dd>The description of the environment.
</dd>
    ...
    <dd>The ARN of the environment owner. This can be ARN of any AWS IAM principal. Defaults to the environment's creator.
</dd>
    ...
    <dd>The ID of the subnet in Amazon VPC that AWS Cloud9 will use to communicate with the Amazon EC2 instance.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The type of the environment (e.g. `ssh` or `ec2`)
</dd>
