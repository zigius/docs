...
<dl class="resources-properties">
    ...
    <dd>The name of the service mesh in which to create the virtual service.
</dd>
    ...
    <dd>The virtual service specification to apply.
</dd>
    ...
    <dd>The name to use for the virtual service.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ARN of the virtual service.
</dd>
    ...
    <dd>The creation date of the virtual service.
</dd>
    ...
    <dd>The last update date of the virtual service.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The virtual node associated with a virtual service.
</dd>
    ...
    <dd>The virtual router associated with a virtual service.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The name of the virtual node that is acting as a service provider.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The name of the virtual router that is acting as a service provider.
</dd>
