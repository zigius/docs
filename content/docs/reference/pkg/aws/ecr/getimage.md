...
<dl class="resources-properties">
    ...
    <dd>The name of the ECR Repository.
</dd>
    ...
    <dd>The sha256 digest of the image manifest. At least one of `image_digest` or `image_tag` must be specified.
</dd>
    ...
    <dd>The tag associated with this image. At least one of `image_digest` or `image_tag` must be specified.
</dd>
    ...
    <dd>The ID of the Registry where the repository resides.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The date and time, expressed as a unix timestamp, at which the current image was pushed to the repository.
</dd>
    ...
    <dd>The size, in bytes, of the image in the repository.
</dd>
    ...
    <dd>The list of tags associated with this image.
</dd>
