...
<dl class="resources-properties">
    ...
    <dd>If true the source will query all regions regardless of availability.
</dd>
    ...
    <dd>Configuration block(s) to use as filters. Detailed below.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Names of regions that meets the criteria.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The name of the filter field. Valid values can be found in the [describe-regions AWS CLI Reference][1].
</dd>
