...
<dl class="resources-properties">
    ...
    <dd>Amazon Resource Name (ARN) of the IAM role.
...
See [AWS Docs](http://docs.aws.amazon.com/config/latest/developerguide/iamrole-permissions.html) for more details.
    ...
    <dd>The name of the recorder. Defaults to `default`. Changing it recreates the resource.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies whether AWS Config records configuration changes
...
Conflicts with `resource_types`. Defaults to `true`.
    ...
    <dd>Specifies whether AWS Config includes all supported types of *global resources*
with the resources that it records. Requires `all_supported = true`. Conflicts with `resource_types`.
    ...
    <dd>A list that specifies the types of AWS resources for which
