...
<dl class="resources-properties">
    ...
    <dd>The database to which the query belongs.
</dd>
    ...
    <dd>The text of the query itself. In other words, all query statements. Maximum length of 262144.
</dd>
    ...
    <dd>A brief explanation of the query. Maximum length of 1024.
</dd>
    ...
    <dd>The plain language name for the query. Maximum length of 128.
</dd>
    ...
    <dd>The workgroup to which the query belongs. Defaults to `primary`
</dd>
