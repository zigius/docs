...
<dl class="resources-properties">
    ...
    <dd>Nested argument defining the provider for the ECS auto scaling group. Defined below.
</dd>
    ...
    <dd>The name of the capacity provider.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The Amazon Resource Name (ARN) that identifies the capacity provider.
</dd>
