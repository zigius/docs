...
<dl class="resources-properties">
    ...
    <dd>The arn of the listener. Required if `load_balancer_arn` and `port` is not set.
</dd>
    ...
    <dd>The arn of the load balancer. Required if `arn` is not set.
</dd>
    ...
    <dd>The port of the listener. Required if `arn` is not set.
</dd>
