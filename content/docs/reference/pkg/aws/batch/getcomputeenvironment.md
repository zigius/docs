...
<dl class="resources-properties">
    ...
    <dd>The name of the Batch Compute Environment
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ARN of the compute environment.
</dd>
    ...
    <dd>The ARN of the underlying Amazon ECS cluster used by the compute environment.
</dd>
    ...
    <dd>The ARN of the IAM role that allows AWS Batch to make calls to other AWS services on your behalf.
</dd>
    ...
    <dd>The state of the compute environment (for example, `ENABLED` or `DISABLED`). If the state is `ENABLED`, then the compute environment accepts jobs from a queue and can scale out automatically based on queues.
</dd>
    ...
    <dd>The type of the compute environment (for example, `MANAGED` or `UNMANAGED`).
</dd>
