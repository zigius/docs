...
<dl class="resources-properties">
    ...
    <dd>The AZ where the EBS volume will exist.
</dd>
    ...
    <dd>The amount of IOPS to provision for the disk.
</dd>
    ...
    <dd>A snapshot to base the EBS volume off of.
</dd>
    ...
    <dd>The type of EBS volume. Can be "standard", "gp2", "io1", "sc1" or "st1" (Default: "gp2").
</dd>
