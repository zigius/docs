...
<dl class="resources-properties">
    ...
    <dd>The db instance to register for this stack. Changing this will force a new resource.
</dd>
    ...
    <dd>The stack to register a db instance for. Changing this will force a new resource.
</dd>
