...
<dl class="resources-properties">
    ...
    <dd>The ssh username, with witch this user wants to log in
</dd>
    ...
    <dd>Whether users can specify their own SSH public key through the My Settings page
</dd>
