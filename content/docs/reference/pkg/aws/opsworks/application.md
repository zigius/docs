...
<dl class="resources-properties">
    ...
    <dd>The id of the stack the application will belong to.
</dd>
    ...
    <dd>Opsworks application type. One of `aws-flow-ruby`, `java`, `rails`, `php`, `nodejs`, `static` or `other`.
</dd>
    ...
    <dd>SCM configuration of the app as described below.
</dd>
    ...
    <dd>Run bundle install when deploying for application of type `rails`.
</dd>
    ...
    <dd>Specify activity and workflow workers for your app using the aws-flow gem.
</dd>
    ...
    <dd>The data source's type one of `AutoSelectOpsworksMysqlInstance`, `OpsworksMysqlInstance`, or `RdsDbInstance`.
</dd>
    ...
    <dd>Subfolder for the document root for application of type `rails`.
</dd>
    ...
    <dd>A list of virtual host alias.
</dd>
    ...
    <dd>Whether to enable SSL for the app. This must be set in order to let `ssl_configuration.private_key`, `ssl_configuration.certificate` and `ssl_configuration.chain` take effect.
</dd>
    ...
    <dd>Object to define environment variables.  Object is described below.
</dd>
    ...
    <dd>A human-readable name for the application.
</dd>
    ...
    <dd>The name of the Rails environment for application of type `rails`.
</dd>
    ...
    <dd>A short, machine-readable name for the application. This can only be defined on resource creation and ignored on resource update.
</dd>
    ...
    <dd>The SSL configuration of the app. Object is described below.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The type of source to use. For example, "archive".
</dd>
    ...
    <dd>Password to use when authenticating to the source. This provider cannot perform drift detection of this configuration.
</dd>
    ...
    <dd>For sources that are version-aware, the revision to use.
</dd>
    ...
    <dd>SSH key to use when authenticating to the source. This provider cannot perform drift detection of this configuration.
</dd>
    ...
    <dd>The URL where the app resource can be found.
</dd>
    ...
    <dd>Username to use when authenticating to the source.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Set visibility of the variable value to `true` or `false`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The contents of the certificate's domain.crt file.
</dd>
    ...
    <dd>The private key; the contents of the certificate's domain.key file.
</dd>
    ...
    <dd>Can be used to specify an intermediate certificate authority key or client authentication.
</dd>
