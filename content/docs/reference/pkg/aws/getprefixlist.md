...
<dl class="resources-properties">
    ...
    <dd>The name of the filter field. Valid values can be found in the [EC2 DescribePrefixLists API Reference](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribePrefixLists.html).
</dd>
    ...
    <dd>The ID of the prefix list to select.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The list of CIDR blocks for the AWS service associated with the prefix list.
</dd>
    ...
    <dd>The name of the selected prefix list.
</dd>
