...
<dl class="resources-properties">
    ...
    <dd>The name of the report definition to match.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of additional artifacts.
</dd>
    ...
    <dd>Preferred format for report.
</dd>
    ...
    <dd>Preferred compression format for report.
</dd>
    ...
    <dd>Preferred report path prefix.
</dd>
    ...
    <dd>Region of customer S3 bucket.
</dd>
    ...
    <dd>The frequency on which report data are measured and displayed.
</dd>
