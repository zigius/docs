...
<dl class="resources-properties">
    ...
    <dd>The ID of the Direct Connect virtual interface on which to create the BGP peer.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The Direct Connect endpoint on which the BGP peer terminates.
</dd>
    ...
    <dd>The Up/Down state of the BGP peer.
</dd>
