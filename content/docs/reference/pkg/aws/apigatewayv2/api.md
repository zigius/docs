...
<dl class="resources-properties">
    ...
    <dd>The API protocol. Valid values: `HTTP`, `WEBSOCKET`.
</dd>
    ...
    <dd>An [API key selection expression](https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-websocket-api-selection-expressions.html#apigateway-websocket-api-apikey-selection-expressions).
...
Applicable for WebSocket APIs.
    ...
    <dd>The [route selection expression](https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-websocket-api-selection-expressions.html#apigateway-websocket-api-route-selection-expressions) for the API.
Defaults to `$request.method $request.path`.
    ...
    <dd>A mapping of tags to assign to the API.
</dd>
    ...
    <dd>A version identifier for the API.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The URI of the API, of the form `{api-id}.execute-api.{region}.amazonaws.com`.
</dd>
