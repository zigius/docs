...
<dl class="resources-properties">
    ...
    <dd>The authorizer type. Valid values: `JWT`, `REQUEST`.
...
For HTTP APIs, specify `JWT` to use JSON Web Tokens.
    ...
    <dd>The identity sources for which authorization is requested.
...
For `JWT` authorizers the single entry specifies where to extract the JSON Web Token (JWT) from inbound requests.
    ...
    <dd>The required credentials as an IAM role for API Gateway to invoke the authorizer.
Supported only for `REQUEST` authorizers.
    ...
    <dd>The authorizer's Uniform Resource Identifier (URI).
...
Supported only for `REQUEST` authorizers.
    ...
    <dd>The configuration of a JWT authorizer. Required for the `JWT` authorizer type.
...
<dl class="resources-properties">
    ...
    <dd>A list of the intended recipients of the JWT. A valid JWT must provide an aud that matches at least one entry in this list.
</dd>
    ...
    <dd>The base domain of the identity provider that issues JSON Web Tokens, such as the `endpoint` attribute of the [`aws.cognito.UserPool`](https://www.terraform.io/docs/providers/aws/r/cognito_user_pool.html) resource.
</dd>
