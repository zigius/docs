...
<dl class="resources-properties">
    ...
    <dd>IAM role for failure feedback
</dd>
    ...
    <dd>The IAM role permitted to receive success feedback for this topic
</dd>
    ...
    <dd>Percentage of success to sample
</dd>
    ...
    <dd>The SNS delivery policy. More on [AWS documentation](https://docs.aws.amazon.com/sns/latest/dg/DeliveryPolicies.html)
</dd>
    ...
    <dd>The display name for the SNS topic
</dd>
    ...
    <dd>The ID of an AWS-managed customer master key (CMK) for Amazon SNS or a custom CMK. For more information, see [Key Terms](https://docs.aws.amazon.com/sns/latest/dg/sns-server-side-encryption.html#sse-key-terms)
</dd>
    ...
    <dd>The friendly name for the SNS topic. By default generated by this provider.
</dd>
    ...
    <dd>The friendly name for the SNS topic. Conflicts with `name`.
</dd>
    ...
    <dd>The fully-formed AWS policy as JSON.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ARN of the SNS topic, as a more obvious property (clone of id)
</dd>
