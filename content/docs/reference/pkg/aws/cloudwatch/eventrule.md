...
See full documentation of [CloudWatch Events and Event Patterns](http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/CloudWatchEventsandEventPatterns.html) for details.
    ...
    <dd>Whether the rule should be enabled (defaults to `true`).
</dd>
    ...
    <dd>The rule's name. By default generated by this provider.
</dd>
    ...
    <dd>The rule's name. Conflicts with `name`.
</dd>
    ...
    <dd>The Amazon Resource Name (ARN) associated with the role that is used for target invocation.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The Amazon Resource Name (ARN) of the rule.
</dd>
