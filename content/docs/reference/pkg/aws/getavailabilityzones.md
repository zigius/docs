...
<dl class="resources-properties">
    ...
    <dd>List of blacklisted Availability Zone names.
</dd>
    ...
    <dd>List of blacklisted Availability Zone IDs.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of the Availability Zone names available to the account.
</dd>
    ...
    <dd>A list of the Availability Zone IDs available to the account.
</dd>
