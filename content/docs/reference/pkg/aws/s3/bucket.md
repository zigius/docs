...
<dl class="resources-properties">
    ...
    <dd>Sets the accelerate configuration of an existing bucket. Can be `Enabled` or `Suspended`.
</dd>
    ...
    <dd>The [canned ACL](https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#canned-acl) to apply. Defaults to "private".  Conflicts with `grant`.
</dd>
    ...
    <dd>The ARN of the bucket. Will be of format `arn:aws:s3:::bucketname`.
</dd>
    ...
    <dd>The name of the bucket. If omitted, this provider will assign a random, unique name.
</dd>
    ...
    <dd>Creates a unique bucket name beginning with the specified prefix. Conflicts with `bucket`.
</dd>
    ...
    <dd>A rule of [Cross-Origin Resource Sharing](https://docs.aws.amazon.com/AmazonS3/latest/dev/cors.html) (documented below).
</dd>
    ...
    <dd>A boolean that indicates all objects (including any [locked objects](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock-overview.html)) should be deleted from the bucket so that the bucket can be destroyed without error. These objects are *not* recoverable.
</dd>
    ...
    <dd>An [ACL policy grant](https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#sample-acl) (documented below). Conflicts with `acl`.
</dd>
    ...
    <dd>The [Route 53 Hosted Zone ID](https://docs.aws.amazon.com/general/latest/gr/rande.html#s3_website_region_endpoints) for this bucket's region.
</dd>
    ...
    <dd>A configuration of [object lifecycle management](http://docs.aws.amazon.com/AmazonS3/latest/dev/object-lifecycle-mgmt.html) (documented below).
</dd>
    ...
    <dd>A settings of [bucket logging](https://docs.aws.amazon.com/AmazonS3/latest/UG/ManagingBucketLogging.html) (documented below).
</dd>
    ...
    <dd>A configuration of [S3 object locking](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html) (documented below)
</dd>
    ...
    <dd>A valid [bucket policy](https://docs.aws.amazon.com/AmazonS3/latest/dev/example-bucket-policies.html) JSON document.
</dd>
    ...
    <dd>If specified, the AWS region this bucket should reside in. Otherwise, the region used by the callee.
</dd>
    ...
    <dd>A configuration of [replication configuration](http://docs.aws.amazon.com/AmazonS3/latest/dev/crr.html) (documented below).
</dd>
...
developer guide for more information.
    ...
    <dd>A configuration of [server-side encryption configuration](http://docs.aws.amazon.com/AmazonS3/latest/dev/bucket-encryption.html) (documented below)
</dd>
    ...
    <dd>A mapping of tags to assign to the bucket.
</dd>
    ...
    <dd>A state of [versioning](https://docs.aws.amazon.com/AmazonS3/latest/dev/Versioning.html) (documented below)
</dd>
    ...
    <dd>A website object (documented below).
</dd>
    ...
    <dd>The domain of the website endpoint, if the bucket is configured with a website. If not, this will be an empty string. This is used to create Route 53 alias records.
</dd>
    ...
    <dd>The website endpoint, if the bucket is configured with a website. If not, this will be an empty string.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The bucket domain name. Will be of format `bucketname.s3.amazonaws.com`.
</dd>
    ...
    <dd>The bucket region-specific domain name. The bucket domain name including the region name, please refer [here](https://docs.aws.amazon.com/general/latest/gr/rande.html#s3_region) for format. Note: The AWS CloudFront allows specifying S3 region-specific endpoint when creating S3 origin, it will prevent [redirect issues](https://forums.aws.amazon.com/thread.jspa?threadID=216814) from CloudFront to S3 Origin URL.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies which methods are allowed. Can be `GET`, `PUT`, `POST`, `DELETE` or `HEAD`.
</dd>
    ...
    <dd>Specifies which origins are allowed.
</dd>
    ...
    <dd>Specifies which headers are allowed.
</dd>
    ...
    <dd>Specifies expose header in the response.
</dd>
    ...
    <dd>Specifies time in seconds that browser can cache the response for a preflight request.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>List of permissions to apply for grantee. Valid values are `READ`, `WRITE`, `READ_ACP`, `WRITE_ACP`, `FULL_CONTROL`.
</dd>
    ...
    <dd>- Type of grantee to apply for. Valid values are `CanonicalUser` and `Group`. `AmazonCustomerByEmail` is not supported.
</dd>
    ...
    <dd>Canonical user id to grant for. Used only when `type` is `CanonicalUser`.  
</dd>
    ...
    <dd>Uri address to grant for. Used only when `type` is `Group`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the number of days after initiating a multipart upload when the multipart upload must be completed.
</dd>
    ...
    <dd>Specifies a period in the object's expire (documented below).
</dd>
    ...
    <dd>Specifies when noncurrent object versions expire (documented below).
</dd>
    ...
    <dd>Specifies when noncurrent object versions transitions (documented below).
</dd>
    ...
    <dd>Specifies object tags key and value.
</dd>
    ...
    <dd>Specifies a period in the object's transitions (documented below).
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the date after which you want the corresponding action to take effect.
</dd>
    ...
    <dd>Specifies the number of days after object creation when the specific rule action takes effect.
</dd>
    ...
    <dd>On a versioned bucket (versioning-enabled or versioning-suspended bucket), you can add this element in the lifecycle configuration to direct Amazon S3 to delete expired object delete markers.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the number of days an object is noncurrent object versions expire.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the Amazon S3 storage class to which you want the noncurrent versions object to transition. Can be `ONEZONE_IA`, `STANDARD_IA`, `INTELLIGENT_TIERING`, `GLACIER`, or `DEEP_ARCHIVE`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the Amazon S3 storage class to which you want the object to transition. Can be `ONEZONE_IA`, `STANDARD_IA`, `INTELLIGENT_TIERING`, `GLACIER`, or `DEEP_ARCHIVE`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The name of the bucket that will receive the log objects.
</dd>
    ...
    <dd>To specify a key prefix for log objects.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Indicates whether this bucket has an Object Lock configuration enabled. Valid value is `Enabled`.
</dd>
    ...
    <dd>The Object Lock rule in place for this bucket.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The default retention period that you want to apply to new objects placed in this bucket.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The default Object Lock retention mode you want to apply to new objects placed in this bucket. Valid values are `GOVERNANCE` and `COMPLIANCE`.
</dd>
    ...
    <dd>The number of days that you want to specify for the default retention period.
</dd>
    ...
    <dd>The number of years that you want to specify for the default retention period.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ARN of the IAM role for Amazon S3 to assume when replicating the objects.
</dd>
    ...
    <dd>Specifies the rules managing the replication (documented below).
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the destination for the rule (documented below).
</dd>
    ...
    <dd>The status of the rule. Either `Enabled` or `Disabled`. The rule is ignored if status is not Enabled.
</dd>
    ...
    <dd>Filter that identifies subset of objects to which the replication rule applies (documented below).
</dd>
    ...
    <dd>Object keyname prefix identifying one or more objects to which the rule applies.
</dd>
    ...
    <dd>The priority associated with the rule.
</dd>
    ...
    <dd>Specifies special object selection criteria (documented below).
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ARN of the S3 bucket where you want Amazon S3 to store replicas of the object identified by the rule.
</dd>
    ...
    <dd>Specifies the overrides to use for object owners on replication. Must be used in conjunction with `account_id` owner override configuration.
</dd>
    ...
    <dd>The Account ID to use for overriding the object owner on replication. Must be used in conjunction with `access_control_translation` override configuration.
</dd>
...
`sse_kms_encrypted_objects` source selection criteria.
    ...
    <dd>The class of storage used to store the object. Can be `STANDARD`, `REDUCED_REDUNDANCY`, `STANDARD_IA`, `ONEZONE_IA`, `INTELLIGENT_TIERING`, `GLACIER`, or `DEEP_ARCHIVE`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The override value for the owner on replicated objects. Currently only `Destination` is supported.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Object keyname prefix that identifies subset of objects to which the rule applies.
</dd>
    ...
    <dd>A mapping of tags that identifies subset of objects to which the rule applies.
...
<dl class="resources-properties">
    ...
    <dd>Match SSE-KMS encrypted objects (documented below). If specified, `replica_kms_key_id`
...
<dl class="resources-properties">
    ...
    <dd>Boolean which indicates if this criteria is enabled.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A single object for server-side encryption by default configuration. (documented below)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A single object for setting server-side encryption by default. (documented below)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The server-side encryption algorithm to use. Valid values are `AES256` and `aws:kms`
</dd>
    ...
    <dd>The AWS KMS master key ID used for the SSE-KMS encryption. This can only be used when you set the value of `sse_algorithm` as `aws:kms`. The default `aws/s3` AWS KMS master key is used if this element is absent while the `sse_algorithm` is `aws:kms`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Enable versioning. Once you version-enable a bucket, it can never return to an unversioned state. You can, however, suspend versioning on that bucket.
</dd>
    ...
    <dd>Enable MFA delete for either `Change the versioning state of your bucket` or `Permanently delete an object version`. Default is `false`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>An absolute path to the document to return in case of a 4XX error.
</dd>
    ...
    <dd>Amazon S3 returns this index document when requests are made to the root domain or any of the subfolders.
</dd>
    ...
    <dd>A hostname to redirect all website requests for this bucket to. Hostname can optionally be prefixed with a protocol (`http://` or `https://`) to use when redirecting requests. The default is the protocol that is used in the original request.
</dd>
    ...
    <dd>A json array containing [routing rules](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-websiteconfiguration-routingrules.html)
