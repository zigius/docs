...
<dl class="resources-properties">
    ...
    <dd>The name of the bucket to put notification configuration.
</dd>
    ...
    <dd>Used to configure notifications to a Lambda Function (documented below).
</dd>
    ...
    <dd>The notification configuration to SQS Queue (documented below).
</dd>
    ...
    <dd>The notification configuration to SNS Topic (documented below).
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies [event](http://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html#notification-how-to-event-types-and-destinations) for which to send notifications.
</dd>
    ...
    <dd>Specifies object key name prefix.
</dd>
    ...
    <dd>Specifies object key name suffix.
</dd>
    ...
    <dd>Specifies unique identifier for each of the notification configurations.
</dd>
    ...
    <dd>Specifies Amazon Lambda function ARN.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies Amazon SQS queue ARN.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies Amazon SNS topic ARN.
</dd>
