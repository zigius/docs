...
<dl class="resources-properties">
    ...
    <dd>Boolean flag to indicate if the certificate should be active
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ARN of the created certificate.
</dd>
    ...
    <dd>When no CSR is provided, the private key.
</dd>
    ...
    <dd>When no CSR is provided, the public key.
</dd>
