...
<dl class="resources-properties">
    ...
    <dd>A filter used to scope the list e.g. by tags. See [related docs](http://docs.aws.amazon.com/AutoScaling/latest/APIReference/API_Filter.html).
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of the Autoscaling Groups Arns in the current region.
</dd>
    ...
    <dd>A list of the Autoscaling Groups in the current region.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The name of the filter. The valid values are: `auto-scaling-group`, `key`, `value`, and `propagate-at-launch`.
</dd>
