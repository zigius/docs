...
<dl class="resources-properties">
    ...
    <dd>The ARNs of one or more Network Load Balancers for the endpoint service.
</dd>
    ...
    <dd>The ARNs of one or more principals allowed to discover the endpoint service.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The state of the VPC endpoint service.
</dd>
