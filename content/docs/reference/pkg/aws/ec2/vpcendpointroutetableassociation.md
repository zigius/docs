...
<dl class="resources-properties">
    ...
    <dd>Identifier of the EC2 Route Table to be associated with the VPC Endpoint.
</dd>
    ...
    <dd>Identifier of the VPC Endpoint with which the EC2 Route Table will be associated.
</dd>
