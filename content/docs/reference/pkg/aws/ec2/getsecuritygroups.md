...
[describe-security-groups in the AWS CLI reference][1].
    ...
    <dd>A mapping of tags, each pair of which must exactly match for
...
<dl class="resources-properties">
    ...
    <dd>IDs of the matches security groups.
</dd>
    ...
    <dd>The VPC IDs of the matched security groups. The data source's tag or filter *will span VPCs*
