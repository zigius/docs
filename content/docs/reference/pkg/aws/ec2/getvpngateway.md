...
<dl class="resources-properties">
    ...
    <dd>The Autonomous System Number (ASN) for the Amazon side of the specific VPN Gateway to retrieve.
</dd>
    ...
    <dd>The ID of a VPC attached to the specific VPN Gateway to retrieve.
</dd>
    ...
    <dd>The Availability Zone of the specific VPN Gateway to retrieve.
</dd>
    ...
    <dd>The ID of the specific VPN Gateway to retrieve.
</dd>
    ...
    <dd>The state of the specific VPN Gateway to retrieve.
</dd>
