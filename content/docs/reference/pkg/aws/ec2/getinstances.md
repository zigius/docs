...
[describe-instances in the AWS CLI reference][1].
    ...
    <dd>A list of instance states that should be applicable to the desired instances. The permitted values are: `pending, running, shutting-down, stopped, stopping, terminated`. The default value is `running`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>IDs of instances found through the filter
</dd>
    ...
    <dd>Private IP addresses of instances found through the filter
</dd>
    ...
    <dd>Public IP addresses of instances found through the filter
</dd>
