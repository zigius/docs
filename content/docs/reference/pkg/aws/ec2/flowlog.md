...
<dl class="resources-properties">
    ...
    <dd>The type of traffic to capture. Valid values: `ACCEPT`,`REJECT`, `ALL`.
</dd>
    ...
    <dd>Elastic Network Interface ID to attach to
</dd>
    ...
    <dd>The ARN for the IAM role that's used to post flow logs to a CloudWatch Logs log group
</dd>
    ...
    <dd>The ARN of the logging destination.
</dd>
    ...
    <dd>The type of the logging destination. Valid values: `cloud-watch-logs`, `s3`. Default: `cloud-watch-logs`.
</dd>
    ...
    <dd>The fields to include in the flow log record, in the order in which they should appear.
</dd>
    ...
    <dd>*Deprecated:* Use `log_destination` instead. The name of the CloudWatch log group.
<p class="property-message">Deprecated: use &#39;log_destination&#39; argument instead</p></dd>
