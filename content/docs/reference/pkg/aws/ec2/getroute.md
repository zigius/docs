...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupRoute<span class="p">(</span><span class="nx">ctx</span> *<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">pulumi.Context</a></span><span class="p">, </span><span class="nx">args</span> <span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-aws/sdk/v2/go/aws/ec2?tab=doc#LookupRouteArgs">LookupRouteArgs</a></span><span class="p">, </span><span class="nx">opts</span> ...<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">pulumi.InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-aws/sdk/v2/go/aws/ec2?tab=doc#LookupRouteResult">LookupRouteResult</a></span>, error)</span></code></pre></div>
...
<dl class="resources-properties">
    ...
    <dd>The id of the specific Route Table containing the Route entry.
</dd>
    ...
    <dd>The CIDR block of the Route belonging to the Route Table.
</dd>
    ...
    <dd>The IPv6 CIDR block of the Route belonging to the Route Table.
</dd>
    ...
    <dd>The Egress Only Gateway ID of the Route belonging to the Route Table.
</dd>
    ...
    <dd>The Gateway ID of the Route belonging to the Route Table.
</dd>
    ...
    <dd>The Instance ID of the Route belonging to the Route Table.
</dd>
    ...
    <dd>The NAT Gateway ID of the Route belonging to the Route Table.
</dd>
    ...
    <dd>The Network Interface ID of the Route belonging to the Route Table.
</dd>
    ...
    <dd>The EC2 Transit Gateway ID of the Route belonging to the Route Table.
</dd>
    ...
    <dd>The VPC Peering Connection ID of the Route belonging to the Route Table.
</dd>
