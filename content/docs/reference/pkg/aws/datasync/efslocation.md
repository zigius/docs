...
<dl class="resources-properties">
    ...
    <dd>Configuration block containing EC2 configurations for connecting to the EFS File System.
</dd>
    ...
    <dd>Amazon Resource Name (ARN) of EFS File System.
</dd>
    ...
    <dd>Subdirectory to perform actions as source or destination. Default `/`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>List of Amazon Resource Names (ARNs) of the EC2 Security Groups that are associated with the EFS Mount Target.
</dd>
    ...
    <dd>Amazon Resource Name (ARN) of the EC2 Subnet that is associated with the EFS Mount Target.
</dd>
