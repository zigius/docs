...
<dl class="resources-properties">
    ...
    <dd>The ARN of an ISSUED ACM certificate in us-east-1 for a custom domain.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The AWS account ID for the user pool owner.
</dd>
    ...
    <dd>The ARN of the CloudFront distribution.
</dd>
    ...
    <dd>The S3 bucket where the static files for this domain are stored.
</dd>
