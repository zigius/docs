...
<dl class="resources-properties">
    ...
    <dd>The configuration for AdminCreateUser requests.
</dd>
    ...
    <dd>Attributes supported as an alias for this user pool. Possible values: phone_number, email, or preferred_username. Conflicts with `username_attributes`.
</dd>
    ...
    <dd>The attributes to be auto-verified. Possible values: email, phone_number.
</dd>
    ...
    <dd>The configuration for the user pool's device tracking.
</dd>
    ...
    <dd>A string representing the email verification message. Conflicts with `verification_message_template` configuration block `email_message` argument.
</dd>
    ...
    <dd>A string representing the email verification subject. Conflicts with `verification_message_template` configuration block `email_subject` argument.
</dd>
    ...
    <dd>A container for the AWS Lambda triggers associated with the user pool.
</dd>
    ...
    <dd>Multi-Factor Authentication (MFA) configuration for the User Pool. Defaults of `OFF`. Valid values:
</dd>
    ...
    <dd>A container for information about the user pool password policy.
</dd>
    ...
    <dd>A container with the schema attributes of a user pool. Schema attributes from the [standard attribute set](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-attributes.html#cognito-user-pools-standard-attributes) only need to be specified if they are different from the default configuration. Maximum of 50 attributes.
</dd>
    ...
    <dd>A string representing the SMS authentication message. The message must contain the `{####}` placeholder, which will be replaced with the code.
</dd>
    ...
    <dd>A string representing the SMS verification message. Conflicts with `verification_message_template` configuration block `sms_message` argument.
</dd>
    ...
    <dd>Configuration block for software token Mult-Factor Authentication (MFA) settings. Detailed below.
</dd>
    ...
    <dd>A mapping of tags to assign to the User Pool.
</dd>
    ...
    <dd>Configuration block for user pool add-ons to enable user pool advanced security mode features.
</dd>
    ...
    <dd>Specifies whether email addresses or phone numbers can be specified as usernames when a user signs up. Conflicts with `alias_attributes`.
</dd>
    ...
    <dd>The verification message templates configuration.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The date the user pool was created.
</dd>
    ...
    <dd>The endpoint name of the user pool. Example format: cognito-idp.REGION.amazonaws.com/xxxx_yyyyy
</dd>
    ...
    <dd>The date the user pool was last modified.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Set to True if only the administrator is allowed to create user profiles. Set to False if users can sign themselves up via an app.
</dd>
    ...
    <dd>The invite message template structure.
</dd>
    ...
    <dd>**DEPRECATED** Use password_policy.temporary_password_validity_days instead - The user account expiration limit, in days, after which the account is no longer usable.
<p class="property-message">Deprecated: Use password_policy.temporary_password_validity_days instead</p></dd>
...
<dl class="resources-properties">
    ...
    <dd>The email message template. Must contain the `{####}` placeholder. Conflicts with `email_verification_message` argument.
</dd>
    ...
    <dd>The subject line for the email message template. Conflicts with `email_verification_subject` argument.
</dd>
    ...
    <dd>The SMS message template. Must contain the `{####}` placeholder. Conflicts with `sms_verification_message` argument.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Indicates whether a challenge is required on a new device. Only applicable to a new device.
</dd>
    ...
    <dd>If true, a device is only remembered on user prompt.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Instruct Cognito to either use its built-in functional or Amazon SES to send out emails.
</dd>
    ...
    <dd>Sender’s email address or sender’s name with their email address (e.g. "john@smith.com" or "John Smith <john@smith.com>")
</dd>
    ...
    <dd>The ARN of the email source.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ARN of the lambda creating an authentication challenge.
</dd>
    ...
    <dd>A custom Message AWS Lambda trigger.
</dd>
    ...
    <dd>Defines the authentication challenge.
</dd>
    ...
    <dd>A post-authentication AWS Lambda trigger.
</dd>
    ...
    <dd>A post-confirmation AWS Lambda trigger.
</dd>
    ...
    <dd>A pre-authentication AWS Lambda trigger.
</dd>
    ...
    <dd>A pre-registration AWS Lambda trigger.
</dd>
    ...
    <dd>Allow to customize identity token claims before token generation.
</dd>
    ...
    <dd>The user migration Lambda config type.
</dd>
    ...
    <dd>Verifies the authentication challenge response.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The minimum length of the password policy that you have set.
</dd>
    ...
    <dd>Whether you have required users to use at least one lowercase letter in their password.
</dd>
    ...
    <dd>Whether you have required users to use at least one number in their password.
</dd>
    ...
    <dd>Whether you have required users to use at least one symbol in their password.
</dd>
    ...
    <dd>Whether you have required users to use at least one uppercase letter in their password.
</dd>
    ...
    <dd>In the password policy you have set, refers to the number of days a temporary password is valid. If the user does not sign-in during this time, their password will need to be reset by an administrator.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The attribute data type. Must be one of `Boolean`, `Number`, `String`, `DateTime`.
</dd>
    ...
    <dd>Specifies whether the attribute type is developer only.
</dd>
    ...
    <dd>Specifies whether the attribute can be changed once it has been created.
</dd>
    ...
    <dd>Specifies the constraints for an attribute of the number type.
</dd>
    ...
    <dd>Specifies whether a user pool attribute is required. If the attribute is required and the user does not provide a value, registration or sign-in will fail.
</dd>
    ...
    <dd>-Specifies the constraints for an attribute of the string type.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The maximum value of an attribute that is of the number data type.
</dd>
    ...
    <dd>The minimum value of an attribute that is of the number data type.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The maximum length of an attribute value of the string type.
</dd>
    ...
    <dd>The minimum length of an attribute value of the string type.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The external ID used in IAM role trust relationships. For more information about using external IDs, see [How to Use an External ID When Granting Access to Your AWS Resources to a Third Party](http://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_create_for-user_externalid.html).
</dd>
    ...
    <dd>The ARN of the Amazon SNS caller. This is usually the IAM role that you've given Cognito permission to assume.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The mode for advanced security, must be one of `OFF`, `AUDIT` or `ENFORCED`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies whether username case sensitivity will be applied for all users in the user pool through Cognito APIs.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The default email option. Must be either `CONFIRM_WITH_CODE` or `CONFIRM_WITH_LINK`. Defaults to `CONFIRM_WITH_CODE`.
</dd>
    ...
    <dd>The email message template for sending a confirmation link to the user, it must contain the `{##Click Here##}` placeholder.
</dd>
    ...
    <dd>The subject line for the email message template for sending a confirmation link to the user.
</dd>
