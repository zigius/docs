...
<dl class="resources-properties">
    ...
    <dd>An identifier for the resource server.
</dd>
    ...
    <dd>A name for the resource server.
</dd>
    ...
    <dd>A list of Authorization Scope.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of all scopes configured for this resource server in the format identifier/scope_name.
</dd>
