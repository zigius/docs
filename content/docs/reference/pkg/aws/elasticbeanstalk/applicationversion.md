...
<dl class="resources-properties">
    ...
    <dd>Name of the Beanstalk Application the version is associated with.
</dd>
    ...
    <dd>S3 bucket that contains the Application Version source bundle.
</dd>
    ...
    <dd>S3 object that is the Application Version source bundle.
</dd>
    ...
    <dd>Short description of the Application Version.
</dd>
    ...
    <dd>On delete, force an Application Version to be deleted when it may be in use
by multiple Elastic Beanstalk Environments.
    ...
    <dd>A unique name for the this Application Version.
</dd>
    ...
    <dd>Key-value mapping of tags for the Elastic Beanstalk Application Version.
</dd>
