...
<dl class="resources-properties">
    ...
    <dd>The attributes of the accelerator. Fields documented below.
</dd>
    ...
    <dd>Indicates whether the accelerator is enabled. The value is true or false. The default value is true.
</dd>
    ...
    <dd>The value for the address type must be `IPV4`.
</dd>
    ...
    <dd>The name of the accelerator.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The DNS name of the accelerator. For example, `a5d53ff5ee6bca4ce.awsglobalaccelerator.com`.
...
is simply an alias for the zone ID `Z2BJ6XQ5FK7U4H`.
    ...
    <dd>IP address set associated with the accelerator.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Indicates whether flow logs are enabled.
</dd>
    ...
    <dd>The name of the Amazon S3 bucket for the flow logs.
</dd>
    ...
    <dd>The prefix for the location in the Amazon S3 bucket for the flow logs.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of IP addresses in the IP address set.
</dd>
    ...
    <dd>The types of IP addresses included in this IP set.
</dd>
