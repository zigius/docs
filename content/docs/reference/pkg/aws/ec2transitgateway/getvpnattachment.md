...
<dl class="resources-properties">
    ...
    <dd>A mapping of tags, each pair of which must exactly match a pair on the desired Transit Gateway VPN Attachment.
</dd>
    ...
    <dd>Identifier of the EC2 VPN Connection.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Key-value tags for the EC2 Transit Gateway VPN Attachment
</dd>
