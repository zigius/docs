...
<dl class="resources-properties">
    ...
    <dd>The ARN of the Amazon Kinesis data stream that receives the audit events.
</dd>
    ...
    <dd>The certificate chain, including intermediate certificates and the root certificate authority certificate used to issue device certificates.
</dd>
    ...
    <dd>Provide this to allow manage the identity provider configuration for the fleet. Fields documented below.
</dd>
    ...
    <dd>Provide this to allow manage the company network configuration for the fleet. Fields documented below.
</dd>
    ...
    <dd>The option to optimize for better performance by routing traffic through the closest AWS Region to users, which may be outside of your home Region. Defaults to `true`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ARN of the created WorkLink Fleet.
</dd>
    ...
    <dd>The identifier used by users to sign in to the Amazon WorkLink app.
</dd>
    ...
    <dd>The time that the fleet was created.
</dd>
    ...
    <dd>The time that the fleet was last updated.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The SAML metadata document provided by the customer’s identity provider.
</dd>
    ...
    <dd>The type of identity provider.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of security group IDs associated with access to the provided subnets.
</dd>
    ...
    <dd>A list of subnet IDs used for X-ENI connections from Amazon WorkLink rendering containers.
</dd>
    ...
    <dd>The VPC ID with connectivity to associated websites.
</dd>
