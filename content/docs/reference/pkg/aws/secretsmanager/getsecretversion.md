...
<dl class="resources-properties">
    ...
    <dd>Specifies the secret containing the version that you want to retrieve. You can specify either the Amazon Resource Name (ARN) or the friendly name of the secret.
</dd>
    ...
    <dd>Specifies the unique identifier of the version of the secret that you want to retrieve. Overrides `version_stage`.
</dd>
    ...
    <dd>Specifies the secret version that you want to retrieve by the staging label attached to the version. Defaults to `AWSCURRENT`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The decrypted part of the protected secret information that was originally provided as a binary. Base64 encoded.
</dd>
    ...
    <dd>The decrypted part of the protected secret information that was originally provided as a string.
</dd>
    ...
    <dd>The unique identifier of this version of the secret.
</dd>
