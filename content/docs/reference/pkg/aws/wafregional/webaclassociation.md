...
<dl class="resources-properties">
    ...
    <dd>ARN of the resource to associate with. For example, an Application Load Balancer or API Gateway Stage.
</dd>
    ...
    <dd>The ID of the WAF Regional WebACL to create an association.
</dd>
