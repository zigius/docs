...
<dl class="resources-properties">
    ...
    <dd>An Array of IPv4 addresses in CIDR format specifying the A records for the agent endpoint.
</dd>
    ...
    <dd>An Array of IPv6 addresses in CIDR format specifying the A records for the agent endpoint.
</dd>
    ...
    <dd>An Array of IPv4 addresses in CIDR format specifying the A records for the api endpoint.
</dd>
    ...
    <dd>An Array of IPv6 addresses in CIDR format specifying the A records for the api endpoint.
</dd>
    ...
    <dd>An Array of IPv4 addresses in CIDR format specifying the A records for the apm endpoint.
</dd>
    ...
    <dd>An Array of IPv6 addresses in CIDR format specifying the A records for the apm endpoint.
</dd>
    ...
    <dd>An Array of IPv4 addresses in CIDR format specifying the A records for the logs endpoint.
</dd>
    ...
    <dd>An Array of IPv6 addresses in CIDR format specifying the A records for the logs endpoint.
</dd>
    ...
    <dd>An Array of IPv4 addresses in CIDR format specifying the A records for the process endpoint.
</dd>
    ...
    <dd>An Array of IPv6 addresses in CIDR format specifying the A records for the process endpoint.
</dd>
    ...
    <dd>An Array of IPv4 addresses in CIDR format specifying the A records for the synthetics endpoint.
</dd>
    ...
    <dd>An Array of IPv6 addresses in CIDR format specifying the A records for the synthetics endpoint.
</dd>
    ...
    <dd>An Array of IPv4 addresses in CIDR format specifying the A records for the webhooks endpoint.
</dd>
    ...
    <dd>An Array of IPv6 addresses in CIDR format specifying the A records for the webhooks endpoint.
</dd>
