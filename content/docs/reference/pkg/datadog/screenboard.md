...
<dl class="resources-properties">
    ...
    <dd>A list of widget definitions.
</dd>
    ...
    <dd>Whether the screenboard is shared or not
</dd>
    ...
    <dd>A list of template variables for using Dashboard templating.
</dd>
