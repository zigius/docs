...
<dl class="resources-properties">
    ...
    <dd>(Computed) The cluster alert group annotations (map)
</dd>
    ...
    <dd>(Computed) The cluster alert group description (string)
</dd>
    ...
    <dd>(Computed) The cluster alert group interval seconds. Default: `180` (int)
</dd>
    ...
    <dd>(Computed) The cluster alert group wait seconds. Default: `180` (int)
</dd>
    ...
    <dd>(Computed) The cluster alert group labels (map)
</dd>
    ...
    <dd>(Computed) The cluster alert group recipients (list)
</dd>
    ...
    <dd>(Computed) The cluster alert group wait seconds. Default: `3600` (int)
</dd>
