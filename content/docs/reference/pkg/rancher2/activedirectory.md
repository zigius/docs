...
<dl class="resources-properties">
    ...
    <dd>ActiveDirectory servers list (list)
</dd>
    ...
    <dd>Service account password for access ActiveDirectory service (string)
</dd>
    ...
    <dd>Service account DN for access ActiveDirectory service (string)
</dd>
    ...
    <dd>Allowed principal ids for auth. Required if `access_mode` is `required` or `restricted`. Ex: `activedirectory_user://<DN>`  `activedirectory_group://<DN>` (list)
</dd>
    ...
    <dd>CA certificate for TLS if selfsigned (string)
</dd>
    ...
    <dd>ActiveDirectory connection timeout. Default `5000` (int)
</dd>
    ...
    <dd>ActiveDirectory defult lgoin domain (string)
</dd>
    ...
    <dd>Group DN attribute. Default `distinguishedName` (string)
</dd>
    ...
    <dd>Group member user attribute. Default `distinguishedName` (string)
</dd>
    ...
    <dd>Group name attribute. Default `name` (string)
</dd>
    ...
    <dd>Group object class. Default `group` (string)
</dd>
    ...
    <dd>Group search attribute. Default `sAMAccountName` (string)
</dd>
    ...
    <dd>ActiveDirectory port. Default `389` (int)
</dd>
    ...
    <dd>User disabled bit mask. Default `2` (int)
</dd>
    ...
    <dd>User login attribute. Default `sAMAccountName` (string)
</dd>
    ...
    <dd>User name attribute. Default `name` (string)
</dd>
    ...
    <dd>User object class. Default `person` (string)
</dd>
    ...
    <dd>User search attribute. Default `sAMAccountName|sn|givenName` (string)
</dd>
