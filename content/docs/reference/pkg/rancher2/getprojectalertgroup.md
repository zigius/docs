...
<dl class="resources-properties">
    ...
    <dd>(Computed) The project alert group annotations (map)
</dd>
    ...
    <dd>(Computed) The project alert group description (string)
</dd>
    ...
    <dd>(Computed) The project alert group interval seconds. Default: `180` (int)
</dd>
    ...
    <dd>(Computed) The project alert group wait seconds. Default: `180` (int)
</dd>
    ...
    <dd>(Computed) The project alert group labels (map)
</dd>
    ...
    <dd>(Computed) The project alert group recipients (list)
</dd>
    ...
    <dd>(Computed) The project alert group wait seconds. Default: `3600` (int)
</dd>
