...
<dl class="resources-properties">
    ...
    <dd>The url of the catalog repo (string)
</dd>
    ...
    <dd>Annotations for the catalog (map)
</dd>
    ...
    <dd>The branch of the catalog repo to use. Default `master` (string)
</dd>
    ...
    <dd>The cluster id of the catalog. Mandatory if `scope = cluster` (string)
</dd>
    ...
    <dd>A catalog description (string)
</dd>
    ...
    <dd>The kind of the catalog. Just helm by the moment (string)
</dd>
    ...
    <dd>The name of the catalog (string)
</dd>
    ...
    <dd>The password to access the catalog if needed (string)
</dd>
    ...
    <dd>The project id of the catalog. Mandatory if `scope = project` (string)
</dd>
    ...
    <dd>Catalog will wait for refresh after tf creation and on every tf read. Default `false` (bool)
</dd>
    ...
    <dd>The username to access the catalog if needed (string)
</dd>
    ...
    <dd>Helm version for the catalog. Available options: `helm_v2` and `helm_v3` (string)
</dd>
