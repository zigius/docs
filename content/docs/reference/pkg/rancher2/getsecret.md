...
<dl class="resources-properties">
    ...
    <dd>The name of the secret (string)
</dd>
    ...
    <dd>The project id where to assign the secret (string)
</dd>
    ...
    <dd>The namespace id where to assign the namespaced secret (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>(Computed) Annotations for secret object (map)
</dd>
    ...
    <dd>(Computed) Secret key/value data. Base64 encoding required for values (map)
</dd>
    ...
    <dd>(Computed) A secret description (string)
</dd>
    ...
    <dd>(Computed) Labels for secret object (map)
</dd>
