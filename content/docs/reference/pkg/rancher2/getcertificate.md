...
<dl class="resources-properties">
    ...
    <dd>The project id where to assign the certificate (string)
</dd>
    ...
    <dd>The namespace id where to assign the namespaced certificate (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>(Computed) Annotations for certificate object (map)
</dd>
    ...
    <dd>(Computed) Base64 encoded certs (string)
</dd>
    ...
    <dd>(Computed) A certificate description (string)
</dd>
    ...
    <dd>(Computed) Labels for certificate object (map)
</dd>
