...
<dl class="resources-properties">
    ...
    <dd>(Computed) Specify if the cluster driver state (bool)
</dd>
    ...
    <dd>(Computed) Actual url of the cluster driver (string)
</dd>
    ...
    <dd>(Computed) Specify whether the cluster driver is an internal cluster driver or not (bool)
</dd>
    ...
    <dd>(Computed) The URL to load for customized Add Clusters screen for this driver (string)
</dd>
