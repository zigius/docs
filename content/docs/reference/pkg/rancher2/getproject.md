...
<dl class="resources-properties">
    ...
    <dd>ID of the Rancher 2 cluster (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>(Computed) Annotations of the rancher2 project (map)
</dd>
    ...
    <dd>(Computed) Default containers resource limits on project (List maxitem:1)
</dd>
    ...
    <dd>(Computed) The project's description (string)
</dd>
    ...
    <dd>(Computed) Enable built-in project monitoring. Default `false` (bool)
</dd>
    ...
    <dd>(Computed) Labels of the rancher2 project (map)
</dd>
    ...
    <dd>(Computed) Default Pod Security Policy ID for the project (string)
</dd>
    ...
    <dd>(Computed) Resource quota for project. Rancher v2.1.x or higher (list maxitems:1)
</dd>
    ...
    <dd>(Computed) UUID of the project as stored by Rancher 2 (string)
</dd>
