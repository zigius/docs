...
<dl class="resources-properties">
    ...
    <dd>AzureAD auth application ID (string)
</dd>
    ...
    <dd>AzureAD auth application secret (string)
</dd>
    ...
    <dd>AzureAD auth endpoint (string)
</dd>
    ...
    <dd>AzureAD graph endpoint (string)
</dd>
    ...
    <dd>Rancher URL (string). "<rancher_url>/verify-auth-azure"
</dd>
    ...
    <dd>AzureAD token endpoint (string)
</dd>
    ...
    <dd>Allowed principal ids for auth. Required if `access_mode` is `required` or `restricted`. Ex: `azuread_user://<USER_ID>`  `azuread_group://<GROUP_ID>` (list)
</dd>
    ...
    <dd>AzureAD endpoint. Default `https://login.microsoftonline.com/` (string)
</dd>
