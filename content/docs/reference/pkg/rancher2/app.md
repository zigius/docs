...
<dl class="resources-properties">
    ...
    <dd>Catalog name of the app. If modified, app will be upgraded. For use scoped catalogs:
...
* add project ID before name, `p-XXXXX:<name>`
    ...
    <dd>The project id where the app will be installed (string)
</dd>
    ...
    <dd>The namespace name where the app will be installed (string)
</dd>
    ...
    <dd>Template name of the app. If modified, app will be upgraded (string)
</dd>
    ...
    <dd>Annotations for App object (map)
</dd>
    ...
    <dd>Answers for the app template. If modified, app will be upgraded (map)
</dd>
    ...
    <dd>Description for the app (string)
</dd>
    ...
    <dd>Current revision id for the app. If modified, If this argument is provided or modified, app will be rollbacked to `revision_id` (string)
</dd>
    ...
    <dd>Template version of the app. If modified, app will be upgraded. Default: `latest` (string)
</dd>
    ...
    <dd>values.yaml base64 encoded file content for the app template. If modified, app will be upgraded (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>(Computed) The url of the app template on a catalog (string)
</dd>
