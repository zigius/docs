...
<dl class="resources-properties">
    ...
    <dd>Cluster ID to config Etcd Backup (string)
</dd>
    ...
    <dd>Annotations for Etcd Backup object (map)
</dd>
    ...
    <dd>Backup config for etcd backup (list maxitems:1)
</dd>
    ...
    <dd>Filename of the Etcd Backup (string)
</dd>
    ...
    <dd>Labels for Etcd Backup object (map)
</dd>
    ...
    <dd>Manual execution of the Etcd Backup. Default `false` (bool)
</dd>
    ...
    <dd>The name of the Etcd Backup (string)
</dd>
    ...
    <dd>Description for the Etcd Backup (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>S3 config options for etcd backup. Valid for `imported` and `rke` clusters. (list maxitems:1)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Access key for S3 service (string)
</dd>
    ...
    <dd>Region for S3 service (string)
</dd>
    ...
    <dd>Secret key for S3 service (string)
</dd>
