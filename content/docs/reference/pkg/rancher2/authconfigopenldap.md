...
<dl class="resources-properties">
    ...
    <dd>Service account DN for access OpenLdap service (string)
</dd>
    ...
    <dd>Service account password for access OpenLdap service (string)
</dd>
    ...
    <dd>Allowed principal ids for auth. Required if `access_mode` is `required` or `restricted`. Ex: `openldap_user://<DN>`  `openldap_group://<DN>` (list)
</dd>
    ...
    <dd>OpenLdap connection timeout. Default `5000` (int)
</dd>
    ...
    <dd>OpenLdap port. Default `389` (int)
</dd>
