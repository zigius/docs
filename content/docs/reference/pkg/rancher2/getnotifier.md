...
<dl class="resources-properties">
    ...
    <dd>(Computed) Annotations for notifier object (map)
</dd>
    ...
    <dd>(Computed) The notifier description (string)
</dd>
    ...
    <dd>(Computed) Labels for notifier object (map)
</dd>
    ...
    <dd>(Computed) Pagerduty config for notifier (list maxitems:1)
</dd>
    ...
    <dd>(Computed) Slack config for notifier (list maxitems:1)
</dd>
    ...
    <dd>(Computed) SMTP config for notifier (list maxitems:1)
</dd>
    ...
    <dd>(Computed) Webhook config for notifier (list maxitems:1)
</dd>
    ...
    <dd>(Computed) Wechat config for notifier (list maxitems:1)
</dd>
