...
<dl class="resources-properties">
    ...
    <dd>The project id where namespace is assigned (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>(Computed) Default containers resource limits on namespace (List maxitem:1)
</dd>
    ...
    <dd>(Computed) A namespace description (string)
</dd>
    ...
    <dd>(Computed) Resource quota for namespace. Rancher v2.1.x or higher (list maxitems:1)
</dd>
