...
<dl class="resources-properties">
    ...
    <dd>The Azure AKS configuration for `aks` Clusters. Conflicts with `eks_config`, `gke_config`, `k3s_config` and `rke_config` (list maxitems:1)
</dd>
    ...
    <dd>Annotations for cluster registration token object (map)
</dd>
    ...
    <dd>Enabling the [local cluster authorized endpoint](https://rancher.com/docs/rancher/v2.x/en/cluster-provisioning/rke-clusters/options/#local-cluster-auth-endpoint) allows direct communication with the cluster, bypassing the Rancher API proxy. (list maxitems:1)
</dd>
    ...
    <dd>Cluster monitoring config. Any parameter defined in [rancher-monitoring charts](https://github.com/rancher/system-charts/tree/dev/charts/rancher-monitoring) could be configured  (list maxitems:1)
</dd>
    ...
    <dd>Cluster template answers. Just for Rancher v2.3.x and above (list maxitems:1)
</dd>
    ...
    <dd>Cluster template ID. Just for Rancher v2.3.x and above (string)
</dd>
    ...
    <dd>Cluster template questions. Just for Rancher v2.3.x and above (list)
</dd>
    ...
    <dd>Cluster template revision ID. Just for Rancher v2.3.x and above (string)
</dd>
    ...
    <dd>[Default pod security policy template id](https://rancher.com/docs/rancher/v2.x/en/cluster-provisioning/rke-clusters/options/#pod-security-policy-support) (string)
</dd>
    ...
    <dd>An optional description of this cluster (string)
</dd>
    ...
    <dd>Desired agent image. Just for Rancher v2.3.x and above (string)
</dd>
    ...
    <dd>Desired auth image. Just for Rancher v2.3.x and above (string)
</dd>
    ...
    <dd>(Computed) The driver used for the Cluster. `imported`, `azurekubernetesservice`, `amazonelasticcontainerservice`, `googlekubernetesengine` and `rancherKubernetesEngine` are supported (string)
</dd>
    ...
    <dd>The Amazon EKS configuration for `eks` Clusters. Conflicts with `aks_config`, `gke_config`, `k3s_config` and `rke_config` (list maxitems:1)
</dd>
    ...
    <dd>Enable built-in cluster alerting. Default `false` (bool)
</dd>
    ...
    <dd>Enable built-in cluster istio. Default `false`. Just for Rancher v2.3.x and above (bool)
</dd>
    ...
    <dd>Enable built-in cluster monitoring. Default `false` (bool)
</dd>
    ...
    <dd>Enable project network isolation. Default `false` (bool)
* `scheduled_cluster_scan`- (Optional) Cluster scheduled cis scan. For Rancher v2.4.0 or above (List maxitems:1)
    ...
    <dd>The Google GKE configuration for `gke` Clusters. Conflicts with `aks_config`, `eks_config`, `k3s_config` and `rke_config` (list maxitems:1)
</dd>
    ...
    <dd>The K3S configuration for `k3s` imported Clusters. Conflicts with `aks_config`, `eks_config`, `gke_config` and `rke_config` (list maxitems:1)
</dd>
    ...
    <dd>Labels for cluster registration token object (map)
</dd>
    ...
    <dd>Name of cluster registration token (string)
</dd>
    ...
    <dd>The RKE configuration for `rke` Clusters. Conflicts with `aks_config`, `eks_config`, `gke_config` and `k3s_config` (list maxitems:1)
</dd>
    ...
    <dd>Windows preferred cluster. Default: `false` (bool)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>(Computed) Cluster Registration Token generated for the cluster (list maxitems:1)
</dd>
    ...
    <dd>(Computed) Default project ID for the cluster (string)
</dd>
    ...
    <dd>(Computed/Sensitive) Kube Config generated for the cluster (string)
</dd>
    ...
    <dd>(Computed) System project ID for the cluster (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>DNS prefix to be used to create the FQDN for the agent pool (string)
</dd>
    ...
    <dd>Azure client ID to use (string)
</dd>
    ...
    <dd>Azure client secret associated with the \"client id\" (string)
</dd>
    ...
    <dd>The Kubernetes master version (string)
</dd>
    ...
    <dd>DNS prefix to use the Kubernetes cluster control pane (string)
</dd>
    ...
    <dd>The name of the Cluster resource group (string)
</dd>
    ...
    <dd>Contents of the SSH public key used to authenticate with Linux hosts (string)
</dd>
    ...
    <dd>The name of an existing Azure Virtual Subnet. Composite of agent virtual network subnet ID (string)
</dd>
    ...
    <dd>Subscription credentials which uniquely identify Microsoft Azure subscription (string)
</dd>
    ...
    <dd>Azure tenant ID to use (string)
</dd>
    ...
    <dd>The name of the virtual network to use. If it's not specified Rancher will create a new VPC (string)
</dd>
    ...
    <dd>The resource group of an existing Azure Virtual Network. Composite of agent virtual network subnet ID (string)
</dd>
    ...
    <dd>The secret of an Azure Active Directory server application (string)
</dd>
    ...
    <dd>The ID of an Azure Active Directory tenant (string)
</dd>
    ...
    <dd>The ID of an Azure Active Directory client application of type \"Native\". This application is for user login via kubectl (string)
</dd>
    ...
    <dd>The ID of an Azure Active Directory server application of type \"Web app/API\". This application represents the managed cluster's apiserver (Server application) (string)
</dd>
    ...
    <dd>The administrator username to use for Linux hosts. Default `azureuser` (string)
</dd>
    ...
    <dd>GB size to be used to specify the disk for every machine in the agent pool. If you specify 0, it will apply the default according to the \"agent vm size\" specified. Default `0` (int)
</dd>
    ...
    <dd>Name for the agent pool, upto 12 alphanumeric characters. Default `agentpool0` (string)
</dd>
    ...
    <dd>Storage profile specifies what kind of storage used on machine in the agent pool. Chooses from [ManagedDisks StorageAccount]. Default `ManagedDisks` (string)
</dd>
    ...
    <dd>Size of machine in the agent pool. Default `Standard_D1_v2` (string)
</dd>
    ...
    <dd>Different authentication API url to use. Default `https://login.microsoftonline.com/` (string)
</dd>
    ...
    <dd>Different resource management API url to use. Default `https://management.azure.com/` (string)
</dd>
    ...
    <dd>Number of machines (VMs) in the agent pool. Allowed values must be in the range of 1 to 100 (inclusive). Default `1` (int)
</dd>
    ...
    <dd>An IP address assigned to the Kubernetes DNS service. It must be within the Kubernetes Service address range specified in \"service cidr\". Default `10.0.0.10` (string)
</dd>
    ...
    <dd>A CIDR notation IP range assigned to the Docker bridge network. It must not overlap with any Subnet IP ranges or the Kubernetes Service address range specified in \"service cidr\". Default `172.17.0.1/16` (string)
</dd>
    ...
    <dd>Enable the Kubernetes ingress with automatic public DNS name creation. Default `false` (bool)
</dd>
    ...
    <dd>Turn on Azure Log Analytics monitoring. Uses the Log Analytics \"Default\" workspace if it exists, else creates one. if using an existing workspace, specifies \"log analytics workspace resource id\". Default `true` (bool)
</dd>
    ...
    <dd>Azure Kubernetes cluster location. Default `eastus` (string)
</dd>
    ...
    <dd>The name of an existing Azure Log Analytics Workspace to use for storing monitoring data. If not specified, uses '{resource group}-{subscription id}-{location code}' (string)
</dd>
    ...
    <dd>The resource group of an existing Azure Log Analytics Workspace to use for storing monitoring data. If not specified, uses the 'Cluster' resource group (string)
</dd>
    ...
    <dd>Maximum number of pods that can run on a node. Default `110` (int)
</dd>
    ...
    <dd>Network plugin used for building Kubernetes network. Chooses from `azure` or `kubenet`. Default `azure` (string)
</dd>
    ...
    <dd>Network policy used for building Kubernetes network. Chooses from `calico` (string)
</dd>
    ...
    <dd>A CIDR notation IP range from which to assign Kubernetes Pod IPs when \"network plugin\" is specified in \"kubenet\". Default `172.244.0.0/16` (string)
</dd>
    ...
    <dd>A CIDR notation IP range from which to assign Kubernetes Service cluster IPs. It must not overlap with any Subnet IP ranges. Default `10.0.0.0/16` (string)
</dd>
    ...
    <dd>Tags for Kubernetes cluster. For example, foo=bar (map)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>CA certs for the authorized cluster endpoint (string)
</dd>
    ...
    <dd>Enable scheduled cluster scan. Default: `false` (bool)
</dd>
    ...
    <dd>FQDN for the authorized cluster endpoint (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Command to execute in a imported k8s cluster (string)
</dd>
    ...
    <dd>(Computed) The ID of the resource (string)
</dd>
    ...
    <dd>Insecure command to execute in a imported k8s cluster (string)
</dd>
    ...
    <dd>K8s manifest url to execute with `kubectl` to import an existing k8s cluster (string)
</dd>
    ...
    <dd>Node command to execute in linux nodes for custom k8s cluster (string)
</dd>
    ...
    <dd>Token for cluster registration token object (string)
</dd>
    ...
    <dd>Node command to execute in windows nodes for custom k8s cluster (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Project ID to apply answer (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Default variable value (string)
</dd>
    ...
    <dd>Required variable. Default `false` (bool)
</dd>
    ...
    <dd>Variable type. `boolean`, `int` and `string` are allowed. Default `string` (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The AWS Client ID to use (string)
</dd>
    ...
    <dd>The AWS Client Secret associated with the Client ID (string)
</dd>
    ...
    <dd>AMI ID to use for the worker nodes instead of the default (string)
</dd>
    ...
    <dd>Associate public ip EKS worker nodes. Default `true` (bool)
</dd>
    ...
    <dd>The desired number of worker nodes. Just for Rancher v2.3.x and above. Default `3` (int)
</dd>
    ...
    <dd>The type of machine to use for worker nodes. Default `t2.medium` (string)
</dd>
    ...
    <dd>Allow user to specify key name to use. Just for Rancher v2.2.7 and above (string)
</dd>
    ...
    <dd>The maximum number of worker nodes. Default `3` (int)
</dd>
    ...
    <dd>The minimum number of worker nodes. Default `1` (int)
</dd>
    ...
    <dd>The volume size for each node. Default `20` (int)
</dd>
    ...
    <dd>The AWS Region to create the EKS cluster in. Default `us-west-2` (string)
</dd>
    ...
    <dd>List of security groups to use for the cluster. If it's not specified Rancher will create a new security group (list)
</dd>
    ...
    <dd>The service role to use to perform the cluster operations in AWS. If it's not specified Rancher will create a new service role (string)
</dd>
    ...
    <dd>A session token to use with the client key and secret if applicable (string)
</dd>
    ...
    <dd>List of subnets in the virtual network to use. If it's not specified Rancher will create 3 news subnets (list)
</dd>
    ...
    <dd>Pass user-data to the nodes to perform automated configuration tasks (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The IP address range of the container pods (string)
</dd>
    ...
    <dd>The contents of the GC credential file (string)
</dd>
    ...
    <dd>Type of the disk attached to each node (string)
</dd>
    ...
    <dd>The image to use for the worker nodes (string)
</dd>
    ...
    <dd>The IP address range for the cluster pod IPs (string)
</dd>
    ...
    <dd>The name of the secondary range to be used for the cluster CIDR block (string)
</dd>
    ...
    <dd>The IP address range of the instance IPs in this cluster (string)
</dd>
    ...
    <dd>The IP address range of the services IPs in this cluster (string)
</dd>
    ...
    <dd>The name of the secondary range to be used for the services CIDR block (string)
</dd>
    ...
    <dd>A custom subnetwork name to be used if createSubnetwork is true (string)
</dd>
    ...
    <dd>Locations for GKE cluster (list)
</dd>
    ...
    <dd>Machine type for GKE cluster (string)
</dd>
    ...
    <dd>Maintenance window for GKE cluster (string)
</dd>
    ...
    <dd>The IP range in CIDR notation to use for the hosted master network (string)
</dd>
    ...
    <dd>Master version for GKE cluster (string)
</dd>
    ...
    <dd>Network for GKE cluster (string)
</dd>
    ...
    <dd>The ID of the cluster node pool (string)
</dd>
    ...
    <dd>Node version for GKE cluster (string)
</dd>
    ...
    <dd>The set of Google API scopes to be made available on all of the node VMs under the default service account (list)
</dd>
    ...
    <dd>The Google Cloud Platform Service Account to be used by the node VMs (string)
</dd>
    ...
    <dd>Subnetwork for GKE cluster (string)
</dd>
    ...
    <dd>Size of the disk attached to each node. Default `100` (int)
</dd>
    ...
    <dd>To enable Kubernetes alpha feature. Default `true` (bool)
</dd>
    ...
    <dd>Specifies whether the node auto-repair is enabled for the node pool. Default `false` (bool)
</dd>
    ...
    <dd>Specifies whether node auto-upgrade is enabled for the node pool. Default `false` (bool)
</dd>
    ...
    <dd>Enable horizontal pod autoscaling for the cluster. Default `true` (bool)
</dd>
    ...
    <dd>Enable HTTP load balancing on GKE cluster. Default `true` (bool)
</dd>
    ...
    <dd>Whether to enable the Kubernetes dashboard. Default `false` (bool)
</dd>
    ...
    <dd>Whether to enable legacy abac on the cluster. Default `false` (bool)
</dd>
    ...
    <dd>Enable stackdriver logging. Default `true` (bool)
</dd>
    ...
    <dd>Enable nodepool autoscaling. Default `false` (bool)
</dd>
    ...
    <dd>Whether the master's internal IP address is used as the cluster endpoint. Default `false` (bool)
</dd>
    ...
    <dd>Whether nodes have internal IP address only. Default `false` (bool)
</dd>
    ...
    <dd>Enable stackdriver monitoring. Default `true` (bool)
</dd>
    ...
    <dd>Enable stackdriver monitoring on GKE cluster (bool)
</dd>
    ...
    <dd>Whether a new subnetwork will be created automatically for the cluster. Default `false` (bool)
</dd>
    ...
    <dd>Issue a client certificate. Default `false` (bool)
</dd>
    ...
    <dd>Enable the Kubernetes dashboard. Default `false` (bool)
</dd>
    ...
    <dd>The number of local SSD disks to be attached to the node. Default `0` (int)
</dd>
    ...
    <dd>Define up to 10 external networks that could access Kubernetes master through HTTPS (list)
</dd>
    ...
    <dd>Maximum number of nodes in the NodePool. Must be >= minNodeCount. There has to enough quota to scale up the cluster. Default `0` (int)
</dd>
    ...
    <dd>Minimmum number of nodes in the NodePool. Must be >= 1 and <= maxNodeCount. Default `0` (int)
</dd>
    ...
    <dd>Node count for GKE cluster. Default `3` (int)
</dd>
    ...
    <dd>Whether the nodes are created as preemptible VM instances. Default `false` (bool)
</dd>
    ...
    <dd>The map of Kubernetes labels to be applied to each cluster (map)
</dd>
    ...
    <dd>List of Kubernetes taints to be applied to each node (list)
</dd>
    ...
    <dd>Whether alias IPs will be used for pod IPs in the cluster. Default `false` (bool)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>K3S upgrade strategy (List maxitems: 1)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Drain server nodes. Default: `false` (bool)
</dd>
    ...
    <dd>Drain worker nodes. Default: `false` (bool)
</dd>
    ...
    <dd>Server concurrency. Default: `1` (int)
</dd>
    ...
    <dd>Worker concurrency. Default: `1` (int)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Duration in seconds of addon job (int)
</dd>
    ...
    <dd>Addons descripton to deploy on RKE cluster.
</dd>
    ...
    <dd>Addons yaml manifests to deploy on RKE cluster (list)
</dd>
    ...
    <dd>Kubernetes cluster authentication (list maxitems:1)
</dd>
    ...
    <dd>Kubernetes cluster authorization (list maxitems:1)
</dd>
    ...
    <dd>RKE bastion host (list maxitems:1)
</dd>
    ...
    <dd>RKE options for Calico network provider (string)
</dd>
    ...
    <dd>RKE dns add-on. Just for Rancher v2.2.x (list maxitems:1)
</dd>
    ...
    <dd>Ignore docker version. Default `true` (bool)
</dd>
    ...
    <dd>Kubernetes ingress configuration (list maxitems:1)
</dd>
    ...
    <dd>Kubernetes cluster monitoring (list maxitems:1)
</dd>
    ...
    <dd>Prefix to customize Kubernetes path (string)
</dd>
    ...
    <dd>private registries for docker images (list)
</dd>
    ...
    <dd>Kubernetes cluster services (list maxitems:1)
</dd>
    ...
    <dd>Use ssh agent auth. Default `false` (bool)
</dd>
    ...
    <dd>Cluster level SSH certificate path (string)
</dd>
    ...
    <dd>Node SSH private key path (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>RKE sans for authentication ([]string)
</dd>
    ...
    <dd>RKE strategy for authentication (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>RKE mode for authorization. `rbac` and `none` modes are available. Default `rbac` (string)
</dd>
    ...
    <dd>RKE options for network (map)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Port for node. Default `22` (string)
</dd>
    ...
    <dd>Node SSH private key (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>RKE AWS Cloud Provider config for Cloud Provider [rke-aws-cloud-provider](https://rancher.com/docs/rke/latest/en/config-options/cloud-providers/aws/) (list maxitems:1)
</dd>
    ...
    <dd>RKE Azure Cloud Provider config for Cloud Provider [rke-azure-cloud-provider](https://rancher.com/docs/rke/latest/en/config-options/cloud-providers/azure/) (list maxitems:1)
</dd>
    ...
    <dd>RKE Custom Cloud Provider config for Cloud Provider (string) (string)
</dd>
    ...
    <dd>RKE Openstack Cloud Provider config for Cloud Provider [rke-openstack-cloud-provider](https://rancher.com/docs/rke/latest/en/config-options/cloud-providers/openstack/) (list maxitems:1)
</dd>
    ...
    <dd>RKE Vsphere Cloud Provider config for Cloud Provider [rke-vsphere-cloud-provider](https://rancher.com/docs/rke/latest/en/config-options/cloud-providers/vsphere/) Extra argument `name` is required on `virtual_center` configuration. (list maxitems:1)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Required if `domain_name` not provided. (string)
</dd>
    ...
    <dd>Required if `domain_id` not provided. (string)
</dd>
    ...
    <dd>Required if `tenant_id` not provided. (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Folder for S3 service. Available from Rancher v2.2.7 (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Node selector for RKE Ingress (map)
</dd>
    ...
    <dd>Provider for RKE monitoring (string)
</dd>
    ...
    <dd>DNS add-on reverse cidr  (list)
</dd>
    ...
    <dd>DNS add-on upstream nameservers  (list)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Ingress controller DNS policy. `ClusterFirstWithHostNet`, `ClusterFirst`, `Default`, and `None` are supported. [K8S dns Policy](https://kubernetes.io/docs/concepts/services-networking/dns-pod-service/#pod-s-dns-policy) (string)
</dd>
    ...
    <dd>Extra arguments for scheduler service (map)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Calico provider config for RKE network (list maxitems:1)
</dd>
    ...
    <dd>Canal provider config for RKE network (list maxitems:1)
</dd>
    ...
    <dd>Flannel provider config for RKE network (list maxitems:1)
</dd>
    ...
    <dd>Network provider MTU. Default `0` (int)
</dd>
    ...
    <dd>Plugin for RKE network. `canal` (default), `flannel`, `calico`, `none` and `weave` are supported. (string)
</dd>
    ...
    <dd>Weave provider config for RKE network (list maxitems:1)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Iface config Flannel network provider (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Roles for the node. `controlplane`, `etcd` and `worker` are supported. (list)
</dd>
    ...
    <dd>Docker socket for node (string)
</dd>
    ...
    <dd>Hostname override for node (string)
</dd>
    ...
    <dd>Internal ip for node (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Set as default registry. Default `false` (bool)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Etcd options for RKE services (list maxitems:1)
</dd>
    ...
    <dd>Kube API options for RKE services (list maxitems:1)
</dd>
    ...
    <dd>Kube Controller options for RKE services (list maxitems:1)
</dd>
    ...
    <dd>Kubelet options for RKE services (list maxitems:1)
</dd>
    ...
    <dd>Kubeproxy options for RKE services (list maxitems:1)
</dd>
    ...
    <dd>Scheduler options for RKE services (list maxitems:1)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Backup options for etcd service. Just for Rancher v2.2.x (list maxitems:1)
</dd>
    ...
    <dd>TLS CA certificate for etcd service (string)
</dd>
    ...
    <dd>TLS certificate for etcd service (string)
</dd>
    ...
    <dd>Creation option for etcd service (string)
</dd>
    ...
    <dd>External urls for etcd service (list)
</dd>
    ...
    <dd>Extra binds for scheduler service (list)
</dd>
    ...
    <dd>Extra environment for scheduler service (list)
</dd>
    ...
    <dd>Etcd service GID. Default: `0`. For Rancher v2.3.x or above (int)
</dd>
    ...
    <dd>Docker image for scheduler service (string)
</dd>
    ...
    <dd>TLS key for etcd service (string)
</dd>
    ...
    <dd>(Optional) Audit log path. Default: `/var/log/kube-audit/audit-log.json` (string)
</dd>
    ...
    <dd>Retention for etcd backup. Default `6` (int)
</dd>
    ...
    <dd>Snapshot option for etcd service (bool)
</dd>
    ...
    <dd>Etcd service UID. Default: `0`. For Rancher v2.3.x or above (int)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Interval hours for etcd backup. Default `12` (int)
</dd>
    ...
    <dd>S3 config options for etcd backup (list maxitems:1)
</dd>
    ...
    <dd>Safe timestamp for etcd backup. Default: `false` (bool)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Bucket name for S3 service (string)
</dd>
    ...
    <dd>Endpoint for S3 service (string)
</dd>
    ...
    <dd>Base64 encoded custom CA for S3 service. Use filebase64(<FILE>) for encoding file. Available from Rancher v2.2.5 (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Admission configuration (map)
</dd>
    ...
    <dd>Enable [AlwaysPullImages](https://kubernetes.io/docs/reference/access-authn-authz/admission-controllers/#alwayspullimages) Admission controller plugin. [Rancher docs](https://rancher.com/docs/rke/latest/en/config-options/services/#kubernetes-api-server-options) Default: `false` (bool)
</dd>
    ...
    <dd>K8s audit log configuration. (list maxitems: 1)
</dd>
    ...
    <dd>K8s event rate limit configuration. (list maxitems: 1)
</dd>
    ...
    <dd>Pod Security Policy option for kube API service. Default `false` (bool)
</dd>
    ...
    <dd>[Encrypt k8s secret data configration](https://rancher.com/docs/rke/latest/en/config-options/secrets-encryption/). (list maxitem: 1)
</dd>
    ...
    <dd>Service Cluster ip Range option for kube controller service (string)
</dd>
    ...
    <dd>Service Node Port Range option for kube API service (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Event rate limit configuration. (map)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Audit log format. Default: 'json' (string)
</dd>
    ...
    <dd>Audit log max age. Default: `30` (int)
</dd>
    ...
    <dd>Audit log max backup. Default: `10` (int)
</dd>
    ...
    <dd>Audit log max size. Default: `100` (int)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Secrets encryption configuration. (map)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Cluster CIDR option for kube controller service (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Cluster DNS Server option for kubelet service (string)
</dd>
    ...
    <dd>Cluster Domain option for kubelet service (string)
</dd>
    ...
    <dd>Enable or disable failing when swap on is not supported (bool)
* `generate_serving_certificate` [Generate a certificate signed by the kube-ca](https://rancher.com/docs/rke/latest/en/config-options/services/#kubelet-serving-certificate-requirements). Default `false` (bool)
    ...
    <dd>Infra container image for kubelet service (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>RKE drain nodes. Default: `false` (bool)
</dd>
    ...
    <dd>RKE drain node input (list Maxitems: 1)
</dd>
    ...
    <dd>RKE max unavailable controlplane nodes. Default: `1` (string)
</dd>
    ...
    <dd>RKE max unavailable worker nodes. Default: `10%` (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Delete RKE node local data. Default: `false` (bool)
</dd>
    ...
    <dd>Force RKE node drain. Default: `false` (bool)
</dd>
    ...
    <dd>RKE node drain grace period. Default: `-1` (int)
</dd>
    ...
    <dd>Ignore RKE daemon sets. Default: `true` (bool)
</dd>
    ...
    <dd>RKE node drain timeout. Default: `60` (int)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Cluster scan config (List maxitems:1)
</dd>
    ...
    <dd>Cluster scan schedule config (list maxitems:1)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Cluster Cis Scan config (List maxitems:1)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Debug master. Default: `false` (bool)
</dd>
    ...
    <dd>Debug worker. Default: `false` (bool)
</dd>
    ...
    <dd>Override benchmark version (string)
</dd>
    ...
    <dd>Cis scan profile. Allowed values: `"permissive" (default) || "hardened"` (string)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Crontab schedule. It should contains 5 fields `"<min> <hour> <month_day> <month> <week_day>"` (string)
</dd>
