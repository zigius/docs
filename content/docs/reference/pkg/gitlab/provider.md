...
<dl class="resources-properties">
    ...
    <dd>A file containing the ca certificate to use in case ssl certificate is not from a standard chain
</dd>
    ...
    <dd>Disable SSL verification of API calls
</dd>
    ...
    <dd>The OAuth token used to connect to GitLab.
</dd>
