...
<dl class="resources-properties">
    ...
    <dd>Number of merge request approvals required for merging. Default is 0.
</dd>
    ...
    <dd>Whether the project is in read-only mode (archived). Repositories can be archived/unarchived by toggling this parameter.
</dd>
    ...
    <dd>Enable container registry for the project.
</dd>
    ...
    <dd>The default branch for the project.
</dd>
    ...
    <dd>A description of the project.
</dd>
    ...
    <dd>Create master branch with first commit containing a README.md file.
</dd>
    ...
    <dd>Enable issue tracking for the project.
</dd>
    ...
    <dd>Set to `ff` to create fast-forward merges
...
Repositories are created with `merge` by default
    ...
    <dd>Enable merge requests for the project.
</dd>
    ...
    <dd>The namespace (group or user) of the project. Defaults to your user.
See `gitlab..Group` for an example.
    ...
    <dd>Set to true if you want allow merges only if all discussions are resolved.
</dd>
    ...
    <dd>Set to true if you want allow merges only if a pipeline succeeds.
</dd>
    ...
    <dd>Enable pipelines for the project.
</dd>
    ...
    <dd>Allow users to request member access.
</dd>
    ...
    <dd>Enable shared runners for this project.
</dd>
    ...
    <dd>Enable sharing the project with a list of groups (maps).
</dd>
    ...
    <dd>Enable snippets for the project.
</dd>
    ...
    <dd>Set to `public` to create a public project.
...
Repositories are created as private by default.
    ...
    <dd>Enable wiki for the project.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>URL that can be provided to `git clone` to clone the
repository via HTTP.
</dd>
    ...
    <dd>Registration token to use during runner setup.
</dd>
...
repository via SSH.
    ...
    <dd>URL that can be used to find the project in a browser.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Group's sharing permissions. See [group members permission][group_members_permissions] for more info.
Valid values are `guest`, `reporter`, `developer`, `master`.
    ...
    <dd>Group id of the group you want to share the project with.
</dd>
