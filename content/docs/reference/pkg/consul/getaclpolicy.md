...
<dl class="resources-properties">
    ...
    <dd>The datacenters associated with the ACL Policy.
</dd>
    ...
    <dd>The description of the ACL Policy.
</dd>
    ...
    <dd>The namespace to lookup the policy.
</dd>
    ...
    <dd>The rules associated with the ACL Policy.
</dd>
