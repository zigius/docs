...
<dl class="resources-properties">
    ...
    <dd>The name of the ACL auth method this rule apply.
</dd>
    ...
    <dd>The name to bind to a token at login-time.
</dd>
    ...
    <dd>Specifies the way the binding rule affects a token
created at login.
</dd>
    ...
    <dd>A free form human readable description of the
binding rule.
</dd>
    ...
    <dd>The namespace to create the binding
rule within.
</dd>
    ...
    <dd>The expression used to math this rule against valid
