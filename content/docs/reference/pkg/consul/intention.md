...
<dl class="resources-properties">
    ...
    <dd>The intention action. Must be one of `allow` or `deny`.
</dd>
    ...
    <dd>The name of the destination service for the intention. This
service does not have to exist.
    ...
    <dd>The name of the source service for the intention. This
service does not have to exist.
</dd>
    ...
    <dd>Optional description that can be used by Consul
...
namespace of the intention.
    ...
    <dd>Key/value pairs that are opaque to Consul and are associated
with the intention.
</dd>
    ...
    <dd>The source namespace of the
intention.
</dd>
