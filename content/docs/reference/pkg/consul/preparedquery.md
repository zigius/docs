...
<dl class="resources-properties">
    ...
    <dd>The name of the service to query.
</dd>
    ...
    <dd>When `true` the prepared query will return connect
...
agent's default datacenter and the datacenter in the provider setup.
    ...
    <dd>Settings for controlling the DNS response details.
</dd>
    ...
    <dd>Options for controlling behavior when no healthy
nodes are available in the local DC.
    ...
    <dd>The name of the prepared query. Used to identify
...
to configure the query as a catch-all.
    ...
    <dd>Allows specifying the name of a node to sort results
...
request.
    ...
    <dd>When `true`, the prepared query will only
return nodes with passing health checks in the result.
    ...
    <dd>The name of the Consul session to tie this query's
...
parameter is omitted the query will not expire.
    ...
    <dd>The ACL token to store with the prepared
query. This token will be used by default whenever the query is executed.
    ...
    <dd>The list of required and/or disallowed tags.  If a tag is
...
disallowed.
    ...
    <dd>Query templating options. This is used to make a
single prepared query respond to many different requests.
    ...
    <dd>The ACL token to use when saving the prepared query.
...
<dl class="resources-properties">
    ...
    <dd>The TTL to send when returning DNS results.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Remote datacenters to return results from.
</dd>
    ...
    <dd>Return results from this many datacenters,
...
<dl class="resources-properties">
    ...
    <dd>The regular expression to match with. When using
`name_prefix_match`, this regex is applied against the query name.
    ...
    <dd>The type of template matching to perform. Currently
