...
agent's default datacenter and the datacenter in the provider setup.
    ...
    <dd>Specifies a key in Consul to be written.
...
<dl class="resources-properties">
    ...
    <dd>This is the path in Consul that should be written to.
</dd>
    ...
    <dd>If true, then the key will be deleted when
...
to attach to the key (defaults to 0).
    ...
    <dd><p class="property-message">Deprecated: Using consul_keys resource to *read* is deprecated; please use consul_keys data source instead</p></dd>
