...
<dl class="resources-properties">
    ...
    <dd>Whether to remove failing servers when a
...
default datacenter and the datacenter in the provider setup.
    ...
    <dd>Whether to disable [upgrade migrations](https://www.consul.io/docs/guides/autopilot.html#redundancy-zones).
Defaults to false.
</dd>
    ...
    <dd>The time after which a server is
considered as unhealthy and will be removed. Defaults to `"200ms"`.
    ...
    <dd>The maximum number of Raft log entries a
server can trail the leader. Defaults to 250.
    ...
    <dd>The [redundancy zone](https://www.consul.io/docs/guides/autopilot.html#redundancy-zones)
...
of isolated failure domains. Defaults to an empty string.
    ...
    <dd>The period to wait for a server to be
...
`"10s"`.
    ...
    <dd>The tag to override the version information
