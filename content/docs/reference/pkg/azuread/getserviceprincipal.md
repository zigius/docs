...
<dl class="resources-properties">
    ...
    <dd>The ID of the Azure AD Application.
</dd>
    ...
    <dd>The Display Name of the Azure AD Application associated with this Service Principal.
</dd>
    ...
    <dd>The ID of the Azure AD Service Principal.
</dd>
