...
<dl class="resources-properties">
    ...
    <dd>The VCL code that specifies exactly what the snippet does.
</dd>
    ...
    <dd>The ID of the service that the dynamic snippet belongs to
</dd>
    ...
    <dd>The ID of the dynamic snippet that the content belong to
</dd>
