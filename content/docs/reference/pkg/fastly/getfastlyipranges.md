...
meta_desc: "Explore the GetFastlyIpRanges function of the Fastly package, including examples, input properties, output properties, and supporting types. Use this data source to get the [IP ranges][1] of Fastly edge nodes."
---
