...
<dl class="resources-properties">
    ...
    <dd>CIDR notation of subnet from block reserved in the same
project and facility as the device
    ...
    <dd>ID of device to which to assign the subnet
</dd>
...
<dl class="resources-properties">
    ...
    <dd>length of CIDR prefix of the subnet as integer
</dd>
    ...
    <dd>IP address of gateway for the subnet
</dd>
    ...
    <dd>Subnet mask in decimal notation, e.g. "255.255.255.0"
</dd>
    ...
    <dd>boolean flag whether subnet is reachable from the Internet
</dd>
