...
<dl class="resources-properties">
    ...
    <dd>ID of the project from which to list the blocks. 
</dd>
    ...
    <dd>Facility code filtering the IP blocks. Global IPv4 blcoks will be listed anyway. If you omit this, all the block from the project will be listed.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>list of CIDR expressions for Global IPv4 blocks in the project
</dd>
    ...
    <dd>list of CIDR expressions for IPv6 blocks in the project
</dd>
    ...
    <dd>list of CIDR expressions for Private IPv4 blocks in the project
</dd>
    ...
    <dd>list of CIDR expressions for Public IPv4 blocks in the project
</dd>
