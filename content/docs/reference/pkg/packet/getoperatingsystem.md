...
<dl class="resources-properties">
    ...
    <dd>Name of the OS distribution.
</dd>
    ...
    <dd>Name or part of the name of the distribution. Case insensitive.
</dd>
    ...
    <dd>Version of the distribution
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Operating system slug (same as `id`)
</dd>
