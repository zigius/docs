...
<dl class="resources-properties">
    ...
    <dd>The name which is used to look up the project
</dd>
    ...
    <dd>The UUID by which to look up the project
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Whether Backend Transfer is enabled for this project
</dd>
    ...
    <dd>The UUID of this project's parent organization
</dd>
    ...
    <dd>The UUID of payment method for this project
</dd>
    ...
    <dd>List of UUIDs of user accounts which beling to this project
</dd>
