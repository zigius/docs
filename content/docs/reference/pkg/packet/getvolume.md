...
<dl class="resources-properties">
    ...
    <dd>The ID the parent Packet project (for lookup by name)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>UUIDs of devices to which this volume is attached
</dd>
    ...
    <dd>The facility slug the volume resides in
</dd>
    ...
    <dd>Whether the volume is locked or not
</dd>
...
* `project_id ` - The project id the volume is in
    ...
    <dd>Performance plan the volume is on
</dd>
    ...
    <dd>The size in GB of the volume
</dd>
