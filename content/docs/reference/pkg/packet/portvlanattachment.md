...
<dl class="resources-properties">
    ...
    <dd>ID of device to be assigned to the VLAN
</dd>
    ...
    <dd>Name of network port to be assigned to the VLAN
</dd>
    ...
    <dd>VXLAN Network Identifier, integer
</dd>
    ...
    <dd>Add port back to the bond when this resource is removed. Default is false.
</dd>
