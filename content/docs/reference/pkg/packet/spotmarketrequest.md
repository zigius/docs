...
<dl class="resources-properties">
    ...
    <dd>Maximum number devices to be created
</dd>
    ...
    <dd>Miniumum number devices to be created
</dd>
    ...
    <dd>Facility IDs where devices should be created
</dd>
    ...
    <dd>Device parameters. See device resource for details
</dd>
    ...
    <dd>Maximum price user is willing to pay per hour per device
</dd>
    ...
    <dd>On resource creation - wait until all desired devices are active, on resource destruction - wait until devices are removed
</dd>
