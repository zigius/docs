...
<dl class="resources-properties">
    ...
    <dd>The budgeted amount for each usage period.
</dd>
    ...
    <dd>ID of the billing account to set a budget on.
</dd>
    ...
    <dd>Rules that trigger alerts (notifications of thresholds being crossed) when spend exceeds the specified percentages of
the budget.
</dd>
    ...
    <dd>Defines notifications that are sent on every update to the billing account's spend, regardless of the thresholds defined
using threshold rules.
    ...
    <dd>Filters that define which resources are used to compute the actual spend against the budget.
</dd>
    ...
    <dd>User data for display name in UI. Must be <= 60 chars.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Resource name of the budget. The resource name implies the scope of a budget. Values are of the form
