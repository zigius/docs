...
<dl class="resources-properties">
    ...
    <dd>Identifier of the brand to which this client is attached to. The format is
'projects/{project_number}/brands/{brand_id}/identityAwareProxyClients/{client_id}'.
    ...
    <dd>Human-friendly name given to the OAuth client.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Output only. Unique identifier of the OAuth client.
</dd>
    ...
    <dd>Output only. Client secret of the OAuth client.
</dd>
