...
<dl class="resources-properties">
    ...
    <dd>Enables [Bucket Policy Only](https://cloud.google.com/storage/docs/bucket-policy-only) access to a bucket.
</dd>
    ...
    <dd>The bucket's [Cross-Origin Resource Sharing (CORS)](https://www.w3.org/TR/cors/) configuration. Multiple blocks of this type are permitted. Structure is documented below.
</dd>
    ...
    <dd>The bucket's encryption configuration.
</dd>
    ...
    <dd>When deleting a bucket, this
...
bucket that contains objects, the provider will fail that run.
    ...
    <dd>A set of key/value label pairs to assign to the bucket.
</dd>
    ...
    <dd>The bucket's [Lifecycle Rules](https://cloud.google.com/storage/docs/lifecycle#configuration) configuration. Multiple blocks of this type are permitted. Structure is documented below.
</dd>
    ...
    <dd>The [GCS location](https://cloud.google.com/storage/docs/bucket-locations)
</dd>
    ...
    <dd>The bucket's [Access & Storage Logs](https://cloud.google.com/storage/docs/access-logs) configuration.
</dd>
...
is not provided, the provider project is used.
    ...
    <dd>Enables [Requester Pays](https://cloud.google.com/storage/docs/requester-pays) on a storage bucket.
</dd>
    ...
    <dd>Configuration of the bucket's data retention policy for how long objects in the bucket should be retained. Structure is documented below.
</dd>
    ...
    <dd>The target [Storage Class](https://cloud.google.com/storage/docs/storage-classes) of objects affected by this Lifecycle Rule. Supported values include: `MULTI_REGIONAL`, `REGIONAL`, `NEARLINE`, `COLDLINE`.
</dd>
    ...
    <dd>The bucket's [Versioning](https://cloud.google.com/storage/docs/object-versioning) configuration.
</dd>
    ...
    <dd>Configuration if the bucket acts as a website. Structure is documented below.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The base URL of the bucket, in the format `gs://<bucket-name>`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The value, in seconds, to return in the [Access-Control-Max-Age header](https://www.w3.org/TR/cors/#access-control-max-age-response-header) used in preflight responses.
</dd>
    ...
    <dd>The list of HTTP methods on which to include CORS response headers, (GET, OPTIONS, POST, etc) Note: "*" is permitted in the list of methods, and means "any method".
</dd>
    ...
    <dd>The list of [Origins](https://tools.ietf.org/html/rfc6454) eligible to receive CORS response headers. Note: "*" is permitted in the list of origins, and means "any Origin".
</dd>
    ...
    <dd>The list of HTTP headers other than the [simple response headers](https://www.w3.org/TR/cors/#simple-response-header) to give permission for the user-agent to share across domains.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The Lifecycle Rule's action configuration. A single block of this type is supported. Structure is documented below.
</dd>
    ...
    <dd>The Lifecycle Rule's condition configuration. A single block of this type is supported. Structure is documented below.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The type of the action of this Lifecycle Rule. Supported values include: `Delete` and `SetStorageClass`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Minimum age of an object in days to satisfy this condition.
</dd>
    ...
    <dd>Creation date of an object in RFC 3339 (e.g. `2017-06-13`) to satisfy this condition.
</dd>
    ...
    <dd>[Storage Class](https://cloud.google.com/storage/docs/storage-classes) of objects to satisfy this condition. Supported values include: `MULTI_REGIONAL`, `REGIONAL`, `NEARLINE`, `COLDLINE`, `STANDARD`, `DURABLE_REDUCED_AVAILABILITY`.
</dd>
    ...
    <dd>Relevant only for versioned objects. The number of newer versions of an object to satisfy this condition.
</dd>
    ...
    <dd>Match to live and/or archived objects. Unversioned buckets have only live objects. Supported values include: `"LIVE"`, `"ARCHIVED"`, `"ANY"`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The bucket that will receive log objects.
</dd>
    ...
    <dd>The object prefix for log objects. If it's not provided,
...
<dl class="resources-properties">
    ...
    <dd>The period of time, in seconds, that objects in the bucket must be retained and cannot be deleted, overwritten, or archived. The value must be less than 3,155,760,000 seconds.
</dd>
    ...
    <dd>If set to `true`, the bucket will be [locked](https://cloud.google.com/storage/docs/using-bucket-lock#lock-bucket) and permanently restrict edits to the bucket's retention policy.  Caution: Locking a bucket is an irreversible action.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>While set to `true`, versioning is fully enabled for this bucket.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Behaves as the bucket's directory index where
missing objects are treated as potential directories.
    ...
    <dd>The custom object to return when a requested
