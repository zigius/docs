...
<dl class="resources-properties">
    ...
    <dd>The email address of the key's associated service account.
</dd>
...
If it is not provided, the provider project is used.
    ...
    <dd>The state of the key. Can be set to one of ACTIVE, INACTIVE.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The access ID of the HMAC Key.
</dd>
    ...
    <dd>'The creation time of the HMAC key in RFC 3339 format. '
</dd>
    ...
    <dd>'The last modification time of the HMAC key metadata in RFC 3339 format.'
</dd>
