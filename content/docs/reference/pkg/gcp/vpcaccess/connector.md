...
<dl class="resources-properties">
    ...
    <dd>The range of internal addresses that follows RFC 4632 notation. Example: '10.132.0.0/28'.
</dd>
    ...
    <dd>Region where the VPC Access connector resides
</dd>
    ...
    <dd>Maximum throughput of the connector in Mbps, must be greater than 'min_throughput'. Default is 1000.
</dd>
    ...
    <dd>Minimum throughput of the connector in Mbps. Default and min is 200.
</dd>
    ...
    <dd>The name of the resource (Max 25 characters).
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The fully qualified name of this VPC connector
</dd>
    ...
    <dd>State of the VPC access connector.
</dd>
