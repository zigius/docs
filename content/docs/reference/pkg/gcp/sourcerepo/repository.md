...
<dl class="resources-properties">
    ...
    <dd>Resource name of the repository, of the form '{{repo}}'. The repo name may contain slashes. eg, 'name/with/slash'
</dd>
...
If it is not provided, the provider project is used.
    ...
    <dd>How this repository publishes a change in the repository through Cloud Pub/Sub. Keyed by the topic names.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The disk usage of the repo, in bytes.
</dd>
    ...
    <dd>URL to clone the repository from Google Cloud Source Repositories.
</dd>
