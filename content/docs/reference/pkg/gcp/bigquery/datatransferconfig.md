...
<dl class="resources-properties">
    ...
    <dd>The data source id. Cannot be changed once the transfer config is created.
</dd>
    ...
    <dd>The BigQuery target dataset id.
</dd>
    ...
    <dd>The user specified display name for the transfer config.
</dd>
    ...
    <dd>These parameters are specific to each data source.
</dd>
    ...
    <dd>The number of days to look back to automatically refresh the data. For example, if dataRefreshWindowDays = 10, then
...
the data source supports the feature. Set the value to 0 to use the default value.
    ...
    <dd>When set to true, no runs are scheduled for a given transfer.
</dd>
    ...
    <dd>The geographic location where the transfer config should reside. Examples: US, EU, asia-northeast1. The default value is
US.
</dd>
...
If it is not provided, the provider project is used.
    ...
    <dd>Data transfer schedule. If the data source does not support a custom schedule, this should be empty. If it is empty, the
...
<dl class="resources-properties">
    ...
    <dd>The resource name of the transfer config. Transfer config names have the form
