...
<dl class="resources-properties">
    ...
    <dd>The unique name of the app profile in the form '[_a-zA-Z0-9][-_.a-zA-Z0-9]*'.
</dd>
    ...
    <dd>Long form description of the use case for this app profile.
</dd>
    ...
    <dd>If true, ignore safety checks when deleting/updating the app profile.
</dd>
    ...
    <dd>The name of the instance to create the app profile within.
</dd>
    ...
    <dd>If true, read/write requests are routed to the nearest cluster in the instance, and will fail over to the nearest
...
If it is not provided, the provider project is used.
    ...
    <dd>Use a single-cluster routing policy.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The unique name of the requested app profile. Values are of the form
