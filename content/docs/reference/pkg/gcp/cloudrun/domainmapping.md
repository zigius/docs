...
<dl class="resources-properties">
    ...
    <dd>Metadata associated with this DomainMapping.
</dd>
    ...
    <dd>The spec for this DomainMapping.
</dd>
    ...
    <dd>Name should be a verified domain
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The current status of the DomainMapping.
</dd>
