...
<dl class="resources-properties">
    ...
    <dd>The policy id. The id must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). Cannot
begin or end with underscore or hyphen. Must consist of between 3 and 50 characters.
    ...
    <dd>Basic algorithm for autoscaling.
</dd>
    ...
    <dd>The location where the autoscaling poicy should reside. The default value is 'global'.
</dd>
...
If it is not provided, the provider project is used.
    ...
    <dd>Describes how the autoscaler will operate for secondary workers.
</dd>
    ...
    <dd>Describes how the autoscaler will operate for primary workers.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The "resource name" of the autoscaling policy.
</dd>
