...
forces a new resource to be created.
    ...
    <dd>The host the user can connect from. This is only supported
...
Can be an IP address. Changing this forces a new resource to be created.
    ...
    <dd>The name of the user. Changing this forces a new resource
to be created.
</dd>
    ...
    <dd>The password for the user. Can be updated. For Postgres
