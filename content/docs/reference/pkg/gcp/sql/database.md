...
<dl class="resources-properties">
    ...
    <dd>The name of the Cloud SQL instance. This does not include the project ID.
</dd>
    ...
    <dd>The charset value. See MySQL's [Supported Character Sets and
...
databases only support a value of 'UTF8' at creation time.
    ...
    <dd>The collation value. See MySQL's [Supported Character Sets and
...
databases only support a value of 'en_US.UTF8' at creation time.
    ...
    <dd>The name of the database in the Cloud SQL instance. This does not include the project ID or instance name.
</dd>
