...
<dl class="resources-properties">
    ...
    <dd>Name of VPC network connected with service producers using VPC peering.
</dd>
    ...
    <dd>Named IP address range(s) of PEERING type reserved for
...
is already established will not reallocate already provisioned service producer subnetworks.
    ...
    <dd>Provider peering service that is managing peering connectivity for a
