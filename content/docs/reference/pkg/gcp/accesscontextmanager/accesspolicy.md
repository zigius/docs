...
<dl class="resources-properties">
    ...
    <dd>The parent of this AccessPolicy in the Cloud Resource Hierarchy. Format: organizations/{organization_id}
</dd>
    ...
    <dd>Human readable title. Does not affect behavior.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Resource name of the AccessPolicy. Format: {policy_id}
</dd>
