...
<dl class="resources-properties">
    ...
    <dd>File system shares on the instance. For this version, only a single file share is supported.
</dd>
    ...
    <dd>VPC networks to which the instance is connected. For this version, only a single network is supported.
</dd>
    ...
    <dd>The service tier of the instance.
</dd>
    ...
    <dd>The name of the Filestore zone of the instance.
</dd>
    ...
    <dd>A description of the instance.
</dd>
    ...
    <dd>The resource name of the instance.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Server-specified ETag for the instance resource to prevent simultaneous updates from overwriting each other.
</dd>
