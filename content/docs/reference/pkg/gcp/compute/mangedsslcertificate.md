...
<dl class="resources-properties">
    ...
    <dd>Properties relevant to a managed certificate. These will be used if the certificate is managed (as indicated by a value
of 'MANAGED' in 'type').
</dd>
...
namespace as the managed SSL certificates.
    ...
    <dd>Enum field whose value is always 'MANAGED' - used to signal to the API which type this is.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Expire time of the certificate.
</dd>
    ...
    <dd>Domains associated with the certificate via Subject Alternative Name.
</dd>
