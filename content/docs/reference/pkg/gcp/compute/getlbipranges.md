...
<dl class="resources-properties">
    ...
    <dd>The IP ranges used for health checks when **HTTP(S), SSL proxy, TCP proxy, and Internal load balancing** is used
</dd>
    ...
    <dd>The IP ranges used for health checks when **Network load balancing** is used
</dd>
