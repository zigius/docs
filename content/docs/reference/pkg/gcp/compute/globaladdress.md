...
<dl class="resources-properties">
    ...
    <dd>The IP address or beginning of the address range represented by this resource. This can be supplied as an input to
reserve a specific address or omitted to allow GCP to choose a valid one for you.
    ...
    <dd>The type of the address to reserve, default is EXTERNAL. * EXTERNAL indicates public/external single IP address. *
INTERNAL indicates internal IP ranges belonging to some network.
    ...
    <dd>The IP Version that will be used by this address. Valid options are 'IPV4' or 'IPV6'. The default value is 'IPV4'.
</dd>
...
must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
    ...
    <dd>The URL of the network in which to reserve the IP range. The IP range must be in RFC1918 space. The network cannot be
deleted if there are any reserved IP ranges referring to it. This should only be set when using an Internal address.
    ...
    <dd>The prefix length of the IP range. If not present, it means the address field is a single IP address. This field is not
...
If it is not provided, the provider project is used.
    ...
    <dd>The purpose of the resource. For global internal addresses it can be * VPC_PEERING - for peer networks This should only
