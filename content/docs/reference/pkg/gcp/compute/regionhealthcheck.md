...
<dl class="resources-properties">
    ...
    <dd>Configure logging on this health check.
</dd>
...
If it is not provided, the provider project is used.
    ...
    <dd>The Region in which the created health check should reside. If it is not provided, the provider region is used.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The type of the health check. One of HTTP, HTTP2, HTTPS, TCP, or SSL.
</dd>
