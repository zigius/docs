...
<dl class="resources-properties">
    ...
    <dd>The name of the resource, provided by the client when initially creating the resource. The resource name must be 1-63
...
If it is not provided, the provider project is used.
    ...
    <dd>Region where resource policy resides.
</dd>
    ...
    <dd>Policy for creating snapshots of persistent disks.
</dd>
