...
<dl class="resources-properties">
    ...
    <dd>The type of range for which to provide results.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Retrieve list of all CIDR blocks.
</dd>
    ...
    <dd>Retrieve list of the IPv4 CIDR blocks
</dd>
    ...
    <dd>Retrieve list of the IPv6 CIDR blocks, if available.
</dd>
