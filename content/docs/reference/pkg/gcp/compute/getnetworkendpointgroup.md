...
<dl class="resources-properties">
    ...
    <dd>The Network Endpoint Group name.
Provide either this or a `self_link`.
    ...
    <dd>The Network Endpoint Group self\_link.
</dd>
    ...
    <dd>The Network Endpoint Group availability zone.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The network to which all network endpoints in the NEG belong.
</dd>
    ...
    <dd>Type of network endpoints in this network endpoint group.
</dd>
    ...
    <dd>Number of network endpoints in the network endpoint group.
</dd>
    ...
    <dd>subnetwork to which all network endpoints in the NEG belong.
</dd>
