...
<dl class="resources-properties">
    ...
    <dd>The Forwarding Rule resource (of type load_balancing_scheme=INTERNAL) that will be used as collector for mirrored
traffic. The specified forwarding rule must have is_mirroring_collector set to true.
    ...
    <dd>A means of specifying which resources to mirror.
</dd>
    ...
    <dd>Specifies the mirrored VPC network. Only packets in this network will be mirrored. All mirrored VMs should have a NIC in
the given network. All mirrored subnetworks should belong to the given network.
    ...
    <dd>A human-readable description of the rule.
</dd>
    ...
    <dd>A filter for mirrored traffic. If unset, all traffic is mirrored.
</dd>
    ...
    <dd>The name of the packet mirroring rule
</dd>
    ...
    <dd>Since only one rule can be active at a time, priority is used to break ties in the case of two rules that apply to the
same instances.
</dd>
