...
<dl class="resources-properties">
    ...
    <dd>The base instance name to use for
...
name.
    ...
    <dd>The region where the managed instance group resides.
</dd>
    ...
    <dd>Application versions managed by this instance group. Each
...
Structure is documented below.
    ...
    <dd>The autohealing policies for this managed instance
...
group manager.
    ...
    <dd>The distribution policy for this managed instance
...
is not provided, the provider project is used.
    ...
    <dd>The full URL of all target pools to which new
...
not affect existing instances.
    ...
    <dd>- The number of instances calculated as a fixed number or a percentage depending on the settings. Structure is documented below.
</dd>
    ...
    <dd>Whether to wait for all instances to be created/updated before
...
<dl class="resources-properties">
    ...
    <dd>The fingerprint of the instance group manager.
</dd>
    ...
    <dd>The full URL of the instance group created by the manager.
</dd>
    ...
    <dd>The URL of the created resource.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The health check resource that signals autohealing.
</dd>
    ...
    <dd>The number of seconds that the managed instance group waits before
...
<dl class="resources-properties">
    ...
    <dd>- Minimal action to be taken on an instance. You can specify either `RESTART` to restart existing instances or `REPLACE` to delete and create new instances from the target template. If you specify a `RESTART`, the Updater will attempt to perform that action only. However, if the Updater determines that the minimal action you specify is not enough to perform the update, it might perform a more disruptive action.
</dd>
    ...
    <dd>- The instance redistribution policy for regional managed instance groups. Valid values are: `"PROACTIVE"`, `"NONE"`. If `PROACTIVE` (default), the group attempts to maintain an even distribution of VM instances across zones in the region. If `NONE`, proactive redistribution is disabled.
</dd>
    ...
    <dd>, The maximum number of instances that can be created above the specified targetSize during the update process. Conflicts with `max_surge_percent`. It has to be either 0 or at least equal to the number of zones.  If fixed values are used, at least one of `max_unavailable_fixed` or `max_surge_fixed` must be greater than 0.
</dd>
    ...
    <dd>, The maximum number of instances(calculated as percentage) that can be created above the specified targetSize during the update process. Conflicts with `max_surge_fixed`. Percent value is only allowed for regional managed instance groups with size at least 10.
</dd>
    ...
    <dd>, The maximum number of instances that can be unavailable during the update process. Conflicts with `max_unavailable_percent`. It has to be either 0 or at least equal to the number of zones. If fixed values are used, at least one of `max_unavailable_fixed` or `max_surge_fixed` must be greater than 0.
</dd>
    ...
    <dd>, The maximum number of instances(calculated as percentage) that can be unavailable during the update process. Conflicts with `max_unavailable_fixed`. Percent value is only allowed for regional managed instance groups with size at least 10.
</dd>
    ...
    <dd>, Minimum number of seconds to wait for after a newly created instance becomes available. This value must be from range [0, 3600]
- - -
</dd>
...
<dl class="resources-properties">
    ...
    <dd>- The full URL to an instance template from which all new instances of this version will be created.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>, The number of instances which are managed for this version. Conflicts with `percent`.
</dd>
    ...
    <dd>, The number of instances (calculated as percentage) which are managed for this version. Conflicts with `fixed`.
