...
<dl class="resources-properties">
    ...
    <dd>Whether to export the custom routes to the peer network.
</dd>
    ...
    <dd>Whether to import the custom routes to the peer network.
</dd>
    ...
    <dd>The name of the primary network for the peering.
</dd>
