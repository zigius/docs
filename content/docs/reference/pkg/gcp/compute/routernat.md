...
<dl class="resources-properties">
    ...
    <dd>How external IPs should be allocated for this NAT. Valid values are 'AUTO_ONLY' for only allowing NAT IPs allocated by
Google Cloud Platform, or 'MANUAL_ONLY' for only user-allocated NAT IP addresses.
    ...
    <dd>The name of the Cloud Router in which this NAT will be configured.
</dd>
    ...
    <dd>How NAT should be configured per Subnetwork. If 'ALL_SUBNETWORKS_ALL_IP_RANGES', all of the IP ranges in every
...
network in this region.
    ...
    <dd>A list of URLs of the IP resources to be drained. These IPs must be valid static external IPs that have been assigned to
the NAT.
</dd>
    ...
    <dd>Timeout (in seconds) for ICMP connections. Defaults to 30s if not set.
</dd>
    ...
    <dd>Configuration for logging on NAT
</dd>
    ...
    <dd>Minimum number of ports allocated to a VM from this NAT.
</dd>
    ...
    <dd>Name of the NAT service. The name must be 1-63 characters long and comply with RFC1035.
</dd>
    ...
    <dd>Self-links of NAT IPs. Only valid if natIpAllocateOption is set to MANUAL_ONLY.
</dd>
...
If it is not provided, the provider project is used.
    ...
    <dd>Region where the router and NAT reside.
</dd>
    ...
    <dd>One or more subnetwork NAT configurations. Only used if 'source_subnetwork_ip_ranges_to_nat' is set to
'LIST_OF_SUBNETWORKS'
</dd>
    ...
    <dd>Timeout (in seconds) for TCP established connections. Defaults to 1200s if not set.
</dd>
    ...
    <dd>Timeout (in seconds) for TCP transitory connections. Defaults to 30s if not set.
</dd>
    ...
    <dd>Timeout (in seconds) for UDP connections. Defaults to 30s if not set.
</dd>
