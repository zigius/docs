...
<dl class="resources-properties">
    ...
    <dd>A list of interfaces on this external VPN gateway.
</dd>
...
If it is not provided, the provider project is used.
    ...
    <dd>Indicates the redundancy type of this external VPN gateway
</dd>
...
<dl class="resources-properties">
    ...
    <dd>an identifier for the resource with format `projects/{{project}}/global/externalVpnGateways/{{name}}`
</dd>
