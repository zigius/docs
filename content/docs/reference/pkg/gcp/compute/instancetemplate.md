...
<dl class="resources-properties">
    ...
    <dd>Disks to attach to instances created from this template.
...
**Note**: `allow_stopping_for_update` must be set to true in order to update this field.
    ...
    <dd>A brief description to use for instances
created from this template.
    ...
    <dd>A set of key/value label pairs to assign to instances
created from this template,
</dd>
...
thus the two mechanisms are not allowed to be used simultaneously.
    ...
    <dd>Specifies a minimum CPU platform. Applicable values are the friendly names of CPU platforms, such as
`Intel Haswell` or `Intel Skylake`. See the complete list [here](https://cloud.google.com/compute/docs/instances/specify-min-cpu-platform).
    ...
    <dd>The name of the instance template. If you leave
...
prefix. Conflicts with `name`.
    ...
    <dd>Networks to attach to instances created from
...
is not provided, the provider project is used.
    ...
    <dd>An instance template is a global resource that is not
...
this configuration option are detailed below.
    ...
    <dd>Service account to attach to the instance. Structure is documented below.
</dd>
...
**Note**: `shielded_instance_config` can only be used with boot images with shielded vm support. See the complete list [here](https://cloud.google.com/compute/docs/images#shielded-images).
    ...
    <dd>Tags to attach to the instance.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Whether or not the disk should be auto-deleted.
This defaults to true.
    ...
    <dd>Indicates that this is a boot disk.
</dd>
    ...
    <dd>A unique device name that is reflected into the
...
specified, the server chooses a default device name to apply to this disk.
    ...
    <dd>Encrypts or decrypts a disk using a customer-supplied encryption key.
</dd>
    ...
    <dd>Name of the disk. When not provided, this defaults
to the name of the instance.
    ...
    <dd>The size of the image in gigabytes. If not
...
the size must be exactly 375GB.
    ...
    <dd>The GCE disk type. Can be either `"pd-ssd"`,
`"local-ssd"`, or `"pd-standard"`.
    ...
    <dd>Specifies the disk interface to use for attaching
this disk.
</dd>
...
created from this template,
    ...
    <dd>The mode in which to attach this disk, either READ_WRITE
...
<dl class="resources-properties">
    ...
    <dd>The self link of the encryption key that is stored in Google Cloud KMS
</dd>
...
empty, the address will be automatically assigned.
    ...
    <dd>the name of the subnetwork to attach this interface
...
created in. Either `network` or `subnetwork` must be provided.
    ...
    <dd>The ID of the project in which the subnetwork belongs.
...
network ip. If not given, one will be generated.
    ...
    <dd>The [networking tier][network-tier] used for configuring
...
<dl class="resources-properties">
    ...
    <dd>Specifies whether the instance should be
...
Structure documented below.
    ...
    <dd>Defines the maintenance behavior for this
instance.
</dd>
    ...
    <dd>Allows instance to be preempted. This defaults to
