...
<dl class="resources-properties">
    ...
    <dd>Reservation for instances with specific machine shapes.
</dd>
    ...
    <dd>The zone where the reservation is made.
</dd>
...
If it is not provided, the provider project is used.
    ...
    <dd>When set to true, only VMs that target this reservation by name can consume this reservation. Otherwise, it can be
...
<dl class="resources-properties">
    ...
    <dd>Full or partial URL to a parent commitment. This field displays for reservations that are tied to a commitment.
</dd>
    ...
    <dd>The status of the reservation.
</dd>
