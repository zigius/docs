...
<dl class="resources-properties">
    ...
    <dd>A reference to RegionBackendService resource if none of the hostRules match.
</dd>
...
If it is not provided, the provider project is used.
    ...
    <dd>The Region in which the url map should reside. If it is not provided, the provider region is used.
</dd>
    ...
    <dd>The list of expected URL mappings. Requests to update this UrlMap will succeed only if all of the test cases pass.
</dd>
