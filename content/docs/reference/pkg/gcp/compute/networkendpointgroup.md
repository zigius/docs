...
<dl class="resources-properties">
    ...
    <dd>The network to which all network endpoints in the NEG belong. Uses "default" project network if unspecified.
</dd>
    ...
    <dd>The default port used if the port number is not specified in the network endpoint.
</dd>
...
must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
    ...
    <dd>Type of network endpoints in this network endpoint group. The only supported value is GCE_VM_IP_PORT
</dd>
...
If it is not provided, the provider project is used.
    ...
    <dd>Optional subnetwork to which all network endpoints in the NEG belong.
</dd>
    ...
    <dd>Zone where the network endpoint group is located.
</dd>
