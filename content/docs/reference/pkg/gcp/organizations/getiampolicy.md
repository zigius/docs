...
<dl class="resources-properties">
    ...
    <dd>A nested configuration block that defines logging additional configuration for your project.
</dd>
    ...
    <dd>A nested configuration block (described below)
...
<dl class="resources-properties">
    ...
    <dd>The above bindings serialized in a format suitable for
...
<dl class="resources-properties">
    ...
    <dd>A nested block that defines the operations you'd like to log.
</dd>
    ...
    <dd>Defines a service that will be enabled for audit logging. For example, `storage.googleapis.com`, `cloudsql.googleapis.com`. `allServices` is a special value that covers all services.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Defines the logging level. `DATA_READ`, `DATA_WRITE` and `ADMIN_READ` capture different types of events. See [the audit configuration documentation](https://cloud.google.com/resource-manager/reference/rest/Shared.Types/AuditConfig) for more details.
</dd>
    ...
    <dd>Specifies the identities that are exempt from these types of logging operations. Follows the same format of the `members` array for `binding`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>An array of identities that will be granted the privilege in the `role`. For more details on format and restrictions see https://cloud.google.com/billing/reference/rest/v1/Policy#Binding
...
* **domain:{domain}**: A G Suite domain (primary, instead of alias) name that represents all the users of that domain. For example, google.com or example.com.
    ...
    <dd>The role/permission that will be granted to the members.
