...
<dl class="resources-properties">
    ...
    <dd>The numeric ID of the organization in which you want to manage the audit logging config.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Identities that do not cause logging for this type of permission.
