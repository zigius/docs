...
<dl class="resources-properties">
    ...
    <dd>The location (zone or region) this cluster has been
...
is not provided, the provider project is used.
    ...
    <dd>The region this cluster has been created in. Deprecated
in favour of `location`.
    ...
    <dd>The zone this cluster has been created in. Deprecated in
favour of `location`.
</dd>
