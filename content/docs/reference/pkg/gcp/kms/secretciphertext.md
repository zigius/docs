...
<dl class="resources-properties">
    ...
    <dd>The full name of the CryptoKey that will be used to encrypt the provided plaintext. Format:
''projects/{{project}}/locations/{{location}}/keyRings/{{keyRing}}/cryptoKeys/{{cryptoKey}}''
    ...
    <dd>The additional authenticated data used for integrity checks during encryption and decryption.
</dd>
