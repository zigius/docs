...
<dl class="resources-properties">
    ...
    <dd>The ciphertext to be decrypted, encoded in base64
</dd>
    ...
    <dd>The id of the CryptoKey that will be used to
...
`{projectId}/{location}/{keyRingName}/{cryptoKeyName}`.
    ...
    <dd>The [additional authenticated data](https://cloud.google.com/kms/docs/additional-authenticated-data) used for integrity checks during encryption and decryption.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Contains the result of decrypting the provided ciphertext.
</dd>
