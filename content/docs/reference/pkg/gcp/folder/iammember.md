...
<dl class="resources-properties">
    ...
    <dd>The resource name of the folder the policy is attached to. Its format is folders/{folder_id}.
</dd>
    ...
    <dd>The identity that will be granted the privilege in the `role`. For more details on format and restrictions see https://cloud.google.com/billing/reference/rest/v1/Policy#Binding
...
* **domain:{domain}**: A G Suite domain (primary, instead of alias) name that represents all the users of that domain. For example, google.com or example.com.
    ...
    <dd>The role that should be applied. Note that custom roles must be of the format
...
<dl class="resources-properties">
    ...
    <dd>(Computed) The etag of the folder's IAM policy.
</dd>
