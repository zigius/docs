...
<dl class="resources-properties">
    ...
    <dd>Secret Manager secret resource
</dd>
    ...
    <dd>The current state of the SecretVersion.
</dd>
    ...
    <dd>The secret data. Must be no larger than 64KiB.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The resource name of the SecretVersion. Format: 'projects/{{project}}/secrets/{{secret_id}}/versions/{{version}}'
</dd>
