...
<dl class="resources-properties">
    ...
    <dd>The DATABASE in which where this schema will be created. (Default: The database used by your `provider` configuration)
</dd>
    ...
    <dd>When true, will also drop all the objects that are contained in the schema. (Default: false)
</dd>
    ...
    <dd>When true, use the existing schema if it exists. (Default: true)
</dd>
    ...
    <dd>The name of the schema. Must be unique in the PostgreSQL
database instance where it is configured.
    ...
    <dd>The ROLE who owns the schema.
</dd>
    ...
    <dd>Can be specified multiple times for each policy.  Each
...
<dl class="resources-properties">
    ...
    <dd>Should the specified ROLE have CREATE privileges to the specified SCHEMA.
</dd>
    ...
    <dd>Should the specified ROLE have CREATE privileges to the specified SCHEMA and the ability to GRANT the CREATE privilege to other ROLEs.
</dd>
    ...
    <dd>The ROLE who is receiving the policy.  If this value is empty or not specified it implies the policy is referring to the [`PUBLIC` role](https://www.postgresql.org/docs/current/static/sql-grant.html).
</dd>
    ...
    <dd>Should the specified ROLE have USAGE privileges to the specified SCHEMA.
</dd>
    ...
    <dd>Should the specified ROLE have USAGE privileges to the specified SCHEMA and the ability to GRANT the USAGE privilege to other ROLEs.
</dd>
