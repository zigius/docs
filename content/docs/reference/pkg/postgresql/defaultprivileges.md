...
<dl class="resources-properties">
    ...
    <dd>The database to grant default privileges for this role.
</dd>
    ...
    <dd>The PostgreSQL object type to set the default privileges on (one of: table, sequence).
</dd>
    ...
    <dd>Role for which apply default privileges (You can change default privileges only for objects that will be created by yourself or by roles that you are a member of).
</dd>
    ...
    <dd>The list of privileges to apply as default privileges.
</dd>
    ...
    <dd>The name of the role to which grant default privileges on.
</dd>
    ...
    <dd>The database schema to set default privileges for this role.
</dd>
