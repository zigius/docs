...
<dl class="resources-properties">
    ...
    <dd>The database to grant privileges on for this role.
</dd>
    ...
    <dd>The PostgreSQL object type to grant the privileges on (one of: table, sequence).
</dd>
    ...
    <dd>The list of privileges to grant.
</dd>
    ...
    <dd>The name of the role to grant privileges on.
</dd>
    ...
    <dd>The database schema to grant privileges on for this role.
</dd>
