...
the host to look for disks on.
    ...
    <dd>A regular expression to filter the disks against. Only
disks with canonical names that match will be included.
    ...
    <dd>Whether or not to rescan storage adapters before
...
<dl class="resources-properties">
    ...
    <dd>A lexicographically sorted list of devices discovered by the
