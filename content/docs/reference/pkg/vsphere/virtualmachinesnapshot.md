...
<dl class="resources-properties">
    ...
    <dd>If set to `true`, a dump of the internal state of the
virtual machine is included in the snapshot.
    ...
    <dd>If set to `true`, and the virtual machine is powered
...
system in the virtual machine.
    ...
    <dd>If set to `true`, the delta disks involved in this
...
destroyed.
    ...
    <dd>If set to `true`, the entire snapshot subtree
