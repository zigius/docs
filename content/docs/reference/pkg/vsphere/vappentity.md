...
<dl class="resources-properties">
    ...
    <dd>[Managed object ID|docs-about-morefs] of the vApp
container the entity is a member of.
    ...
    <dd>[Managed object ID|docs-about-morefs] of the entity
to power on or power off. This can be a virtual machine or a vApp.
    ...
    <dd>How to start the entity. Valid settings are none
...
Default: powerOn
    ...
    <dd>Delay in seconds before continuing with the next
entity in the order of entities to be started. Default: 120
    ...
    <dd>Order to start and stop target in vApp. Default: 1
</dd>
    ...
    <dd>Defines the stop action for the entity. Can be set
...
guestShutdown. Default: 120
    ...
    <dd>Determines if the VM should be marked as being
