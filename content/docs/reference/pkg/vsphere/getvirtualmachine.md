...
<dl class="resources-properties">
    ...
    <dd>The name of the virtual machine. This can be a name or
path.
</dd>
...
`vsphere..Datacenter` data source.
    ...
    <dd>The number of SCSI controllers to
...
<dl class="resources-properties">
    ...
    <dd>The alternate guest name of the virtual machine when
guest_id is a non-specific operating system, like `otherGuest`.
    ...
    <dd>Information about each of the disks on this virtual machine or
...
are scanned for disks. The sub-attributes are:
    ...
    <dd>The firmware type for this virtual machine. Can be `bios` or `efi`.
</dd>
    ...
    <dd>The guest ID of the virtual machine or template.
</dd>
    ...
    <dd>A list of IP addresses as reported by VMWare tools.
</dd>
    ...
    <dd>The network interface types for each network
...
controllers defined by `scsi_controller_scan_count` are scanned.
    ...
    <dd>The common type of all SCSI controllers on this virtual machine.
...
<dl class="resources-properties">
    ...
    <dd>Set to `true` if the disk has been eager zeroed.
</dd>
    ...
    <dd>The size of the disk, in GIB.
</dd>
    ...
    <dd>Set to `true` if the disk has been thin provisioned.
</dd>
