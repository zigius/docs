...
<dl class="resources-properties">
    ...
    <dd>The DNS zone name which will be added.
</dd>
    ...
    <dd>Boolean of whether to scan for DNS records on creation. Ignored after zone is created. Default: false.
</dd>
    ...
    <dd>Boolean of whether this zone is paused (traffic bypasses Cloudflare). Default: false.
</dd>
    ...
    <dd>The name of the commercial plan to apply to the zone, can be updated once the one is created; one of `free`, `pro`, `business`, `enterprise`.
</dd>
    ...
    <dd>A full zone implies that DNS is hosted with Cloudflare. A partial zone is typically a partner-hosted zone or a CNAME setup. Valid values: `full`, `partial`. Default is `full`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Cloudflare-assigned name servers. This is only populated for zones that use Cloudflare DNS.
</dd>
    ...
    <dd>Status of the zone. Valid values: `active`, `pending`, `initializing`, `moved`, `deleted`, `deactivated`.
</dd>
    ...
    <dd>List of Vanity Nameservers (if set).
...
* `meta.phishing_detected` - Indicates if URLs on the zone have been identified as hosting phishing content.
    ...
    <dd>Contains the TXT record value to validate domain ownership. This is only populated for zones of type `partial`. 
</dd>
