...
<dl class="resources-properties">
    ...
    <dd>Rule configuration to apply to a matched request. It's a complex value. See description below.
</dd>
    ...
    <dd>The action to apply to a matched request. Allowed values: "block", "challenge", "whitelist", "js_challenge"
</dd>
    ...
    <dd>A personal note about the rule. Typically used as a reminder or explanation for the rule.
</dd>
    ...
    <dd>The DNS zone to which the access rule should be added.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The request property to target. Allowed values: "ip", "ip6", "ip_range", "asn", "country"
</dd>
    ...
    <dd>The value to target. Depends on target's type.
</dd>
