...
<dl class="resources-properties">
    ...
    <dd>The ID of the application the policy is
associated with.
</dd>
    ...
    <dd>Defines the action Access will take if the policy matches the user.
Allowed values: `allow`, `deny`, `non_identity`, `bypass`
    ...
    <dd>A series of access conditions, see [Access Groups](https://www.terraform.io/docs/providers/cloudflare/r/access_group.html#conditions).
</dd>
    ...
    <dd>Friendly name of the Access Application.
</dd>
    ...
    <dd>The DNS zone to which the access rule should be
added.
</dd>
    ...
    <dd>The unique precedence for policies on a single application. Integer.
</dd>
