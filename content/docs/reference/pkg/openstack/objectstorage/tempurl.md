...
<dl class="resources-properties">
    ...
    <dd>The container name the object belongs to.
</dd>
    ...
    <dd>The object name the tempurl is for.
</dd>
    ...
    <dd>The TTL, in seconds, for the URL. For how long it should
be valid.
</dd>
    ...
    <dd>The method allowed when accessing this URL.
Valid values are `GET`, and `POST`. Default is `GET`.
    ...
    <dd>Whether to automatically regenerate the URL when
...
ID and new URL. Defaults to false.
    ...
    <dd>The region the tempurl is located in.
</dd>
