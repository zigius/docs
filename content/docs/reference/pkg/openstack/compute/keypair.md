...
<dl class="resources-properties">
    ...
    <dd>A unique name for the keypair. Changing this creates a new
keypair.
</dd>
    ...
    <dd>A pregenerated OpenSSH-formatted public key.
...
<dl class="resources-properties">
    ...
    <dd>The fingerprint of the public key.
</dd>
    ...
    <dd>The generated private key when no public key is specified.
</dd>
