...
<dl class="resources-properties">
    ...
    <dd>ID of the project to manage quotas.
...
Changing this updates the existing quotaset.
    ...
    <dd>Quota value for floating IPs.
Changing this updates the existing quotaset.
</dd>
    ...
    <dd>Quota value for content bytes
of injected files. Changing this updates the existing quotaset.
    ...
    <dd>Quota value for path bytes of
injected files. Changing this updates the existing quotaset.
    ...
    <dd>Quota value for injected files.
Changing this updates the existing quotaset.
</dd>
...
Changing this updates the existing quotaset.
    ...
    <dd>Quota value for metadata items.
Changing this updates the existing quotaset.
</dd>
...
Changing this updates the existing quotaset.
    ...
    <dd>Quota value for security groups.
Changing this updates the existing quotaset.
</dd>
    ...
    <dd>Quota value for server groups members.
Changing this updates the existing quotaset.
</dd>
    ...
    <dd>Quota value for server groups.
Changing this updates the existing quotaset.
</dd>
