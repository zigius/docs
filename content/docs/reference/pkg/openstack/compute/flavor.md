...
<dl class="resources-properties">
    ...
    <dd>The amount of disk space in gigabytes to use for the root
(/) partition. Changing this creates a new flavor.
    ...
    <dd>The amount of RAM to use, in megabytes. Changing this
creates a new flavor.
    ...
    <dd>The number of virtual CPUs to use. Changing this creates
a new flavor.
</dd>
    ...
    <dd>Whether the flavor is public. Changing this creates
a new flavor.
</dd>
    ...
    <dd>A unique name for the flavor. Changing this creates a new
flavor.
</dd>
...
Changing this creates a new flavor.
    ...
    <dd>RX/TX bandwith factor. The default is 1. Changing
this creates a new flavor.
    ...
    <dd>The amount of disk space in megabytes to use. If
