...
<dl class="resources-properties">
    ...
    <dd>The ID of the Instance to attach the Volume to.
</dd>
    ...
    <dd>See Argument Reference above. _NOTE_: The correctness of this
...
should not be used as an authoritative piece of information.
    ...
    <dd>Enable attachment of multiattach-capable volumes.
</dd>
