...
<dl class="resources-properties">
    ...
    <dd>Action to be taken ( must be "allow" or "deny") when the
...
firewall rule.
    ...
    <dd>The protocol type on which the firewall rule operates.
...
`protocol` of an existing firewall rule.
    ...
    <dd>A description for the firewall rule. Changing this
updates the `description` of an existing firewall rule.
    ...
    <dd>The destination IP address on which the
...
of an existing firewall rule.
    ...
    <dd>The destination port on which the firewall
...
firewall rule.
    ...
    <dd>Enabled status for the firewall rule (must be "true"
...
`enabled` status of an existing firewall rule.
    ...
    <dd>IP version, either 4 (default) or 6. Changing this
updates the `ip_version` of an existing firewall rule.
    ...
    <dd>A unique name for the firewall rule. Changing this
updates the `name` of an existing firewall rule.
    ...
    <dd>The region in which to obtain the v1 Compute client.
...
firewall rule.
    ...
    <dd>The source IP address on which the firewall
...
firewall rule.
    ...
    <dd>The source port on which the firewall
...
firewall rule.
    ...
    <dd>The owner of the firewall rule. Required if admin
