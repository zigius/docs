...
<dl class="resources-properties">
    ...
    <dd>Audit status of the firewall policy
...
firewall policy.
    ...
    <dd>A description for the firewall policy. Changing
this updates the `description` of an existing firewall policy.
    ...
    <dd>A name for the firewall policy. Changing this
...
firewall policy.
    ...
    <dd>An array of one or more firewall rules that comprise
...
existing firewall policy.
    ...
    <dd>Sharing status of the firewall policy (must be "true"
