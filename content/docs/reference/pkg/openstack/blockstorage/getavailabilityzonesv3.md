...
<dl class="resources-properties">
    ...
    <dd>The region in which to obtain the Block Storage client.
If omitted, the `region` argument of the provider is used.
    ...
    <dd>The `state` of the availability zones to match. Can
...
<dl class="resources-properties">
    ...
    <dd>The names of the availability zones, ordered alphanumerically, that
