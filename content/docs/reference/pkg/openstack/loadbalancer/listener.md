...
Listener. Changing this creates a new Listener.
    ...
    <dd>The protocol - can either be TCP, HTTP, HTTPS,
...
new Listener.
    ...
    <dd>The port on which to listen for client traffic.
Changing this creates a new Listener.
    ...
    <dd>The administrative state of the Listener.
A valid value is true (UP) or false (DOWN).
    ...
    <dd>The maximum number of connections allowed
for the Listener.
</dd>
    ...
    <dd>The ID of the default pool with which the
Listener is associated.
    ...
    <dd>A reference to a Barbican Secrets
...
for more information.
    ...
    <dd>Human-readable description for the Listener.
</dd>
    ...
    <dd>The list of key value pairs representing headers to insert
...
existing listener.
    ...
    <dd>Human-readable name for the Listener. Does not have
to be unique.
</dd>
...
Listener.
    ...
    <dd>A list of references to Barbican Secrets
...
other than their own. Changing this creates a new Listener.
    ...
    <dd>The client inactivity timeout in milliseconds.
</dd>
    ...
    <dd>The member connection timeout in milliseconds.
</dd>
    ...
    <dd>The member inactivity timeout in milliseconds.
</dd>
    ...
    <dd>The time in milliseconds, to wait for additional
