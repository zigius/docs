...
<dl class="resources-properties">
    ...
    <dd>The IP address of the member to receive traffic from
the load balancer. Changing this creates a new member.
    ...
    <dd>The id of the pool that this member will be
assigned to.
</dd>
...
Changing this creates a new member.
    ...
    <dd>The administrative state of the member.
A valid value is true (UP) or false (DOWN).
    ...
    <dd>Human-readable name for the member.
</dd>
...
member.
    ...
    <dd>The subnet in which to access the member
</dd>
...
other than their own. Changing this creates a new member.
    ...
    <dd>A positive integer value that indicates the relative
