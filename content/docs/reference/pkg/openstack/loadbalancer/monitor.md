...
<dl class="resources-properties">
    ...
    <dd>The time, in seconds, between sending probes to members.
</dd>
    ...
    <dd>Number of permissible ping failures before
...
and 10.
    ...
    <dd>The id of the pool that this monitor will be assigned to.
</dd>
    ...
    <dd>Maximum number of seconds for a monitor to wait for a
...
value.
    ...
    <dd>The type of probe, which is PING, TCP, HTTP, HTTPS,
...
balancer to verify the member state. Changing this creates a new monitor.
    ...
    <dd>The administrative state of the monitor.
A valid value is true (UP) or false (DOWN).
    ...
    <dd>Required for HTTP(S) types. Expected HTTP codes
...
"200", or a range like "200-202".
    ...
    <dd>Required for HTTP(S) types. The HTTP method used
...
defaults to "GET".
    ...
    <dd>Number of permissible ping failures befor changing the member's
...
other than their own. Changing this creates a new monitor.
    ...
    <dd>Required for HTTP(S) types. URI path that will be
