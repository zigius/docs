...
Changing this creates a new monitor.
    ...
    <dd>Number of permissible ping failures before changing
...
Changing this updates the timeout of the existing monitor.
    ...
    <dd>The type of probe, which is PING, TCP, HTTP, or HTTPS,
...
LB monitor.
    ...
    <dd>The owner of the monitor. Required if admin wants to
