...
<dl class="resources-properties">
    ...
    <dd>The membership proposal status. Can either be
`accepted`, `rejected` or `pending`.
    ...
    <dd>The member ID, e.g. the target project ID. Optional
...
<dl class="resources-properties">
    ...
    <dd>The date the image membership was created.
</dd>
    ...
    <dd>The date the image membership was last updated.
</dd>
