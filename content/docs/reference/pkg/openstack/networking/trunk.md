...
<dl class="resources-properties">
    ...
    <dd>The ID of the port to be made a subport of the trunk.
</dd>
    ...
    <dd>Administrative up/down status for the trunk
...
`admin_state_up` of an existing trunk.
    ...
    <dd>Human-readable description of the trunk. Changing this
updates the name of the existing trunk.
    ...
    <dd>A unique name for the trunk. Changing this
...
trunk.
    ...
    <dd>The set of ports that will be made subports of the trunk.
The structure of each subport is described below.
    ...
    <dd>The owner of the Trunk. Required if admin wants
...
<dl class="resources-properties">
    ...
    <dd>The collection of tags assigned on the trunk, which have been
...
<dl class="resources-properties">
    ...
    <dd>The segmentation technology to use, e.g., "vlan".
</dd>
