...
<dl class="resources-properties">
    ...
    <dd>The value of DSCP mark. Changing this updates the DSCP mark value existing
QoS DSCP marking rule.
    ...
    <dd>The QoS policy reference. Changing this creates a new QoS DSCP marking rule.
</dd>
