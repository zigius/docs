...
<dl class="resources-properties">
    ...
    <dd>Action for the RBAC policy. Can either be
`access_as_external` or `access_as_shared`.
    ...
    <dd>The ID of the `object_type` resource. An
...
`qos_policy` returns a QoS ID.
    ...
    <dd>The type of the object that the RBAC policy
affects. Can either be `qos-policy` or `network`.
    ...
    <dd>The ID of the tenant to which the RBAC policy
will be enforced.
</dd>
