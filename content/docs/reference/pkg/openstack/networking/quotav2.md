...
<dl class="resources-properties">
    ...
    <dd>ID of the project to manage quota. Changing this
creates new quota.
</dd>
    ...
    <dd>Quota value for floating IPs. Changing this updates the
existing quota.
</dd>
    ...
    <dd>Quota value for networks. Changing this updates the
existing quota.
</dd>
    ...
    <dd>Quota value for ports. Changing this updates the
existing quota.
</dd>
    ...
    <dd>Quota value for RBAC policies.
Changing this updates the existing quota.
    ...
    <dd>The region in which to create the quota. If
...
creates new quota.
    ...
    <dd>Quota value for routers. Changing this updates the
existing quota.
</dd>
    ...
    <dd>Quota value for security groups. Changing
this updates the existing quota.
    ...
    <dd>Quota value for security group rules.
Changing this updates the existing quota.
</dd>
    ...
    <dd>Quota value for subnets. Changing
this updates the existing quota.
</dd>
    ...
    <dd>Quota value for subnetpools.
Changing this updates the existing quota.
</dd>
