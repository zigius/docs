...
<dl class="resources-properties">
    ...
    <dd>The package version of the market product.
</dd>
    ...
    <dd>The purchase cycle of the product, valid values are `Day`, `Month` and `Year`.
</dd>
    ...
    <dd>The product_code of market place product.
</dd>
    ...
    <dd>Service providers customize additional components.
</dd>
    ...
    <dd>The coupon id of the market product.
</dd>
    ...
    <dd>The number of purchase cycles.
</dd>
    ...
    <dd>The quantity of the market product will be purchased.
</dd>
