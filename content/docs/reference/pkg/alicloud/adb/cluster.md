...
<dl class="resources-properties">
    ...
    <dd>Cluster category. Value options: `Basic`, `Cluster`.
</dd>
    ...
    <dd>The db_node_count of cluster node.
</dd>
    ...
    <dd>The db_node_storage of cluster node.
</dd>
    ...
    <dd>Cluster version. Value options: `3.0`, Default to `3.0`.
</dd>
...
- Value: It can be up to 128 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It can be a null string.
    ...
    <dd>The Zone to launch the DB cluster.
</dd>
