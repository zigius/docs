...
<dl class="resources-properties">
    ...
    <dd>A regex string to filter results by FC trigger name.
...
<dl class="resources-properties">
    ...
    <dd>A list of FC triggers names.
</dd>
    ...
    <dd>A list of FC triggers. Each element contains the following attributes:
</dd>
...
<dl class="resources-properties">
    ...
    <dd>JSON-encoded trigger configuration. See [Configure triggers and events](https://www.alibabacloud.com/help/doc-detail/70140.htm) for more details.
</dd>
    ...
    <dd>FC trigger last modification time.
</dd>
    ...
    <dd>Type of the trigger. Valid values: `oss`, `log`, `timer`, `http` and `mns_topic`.
</dd>
