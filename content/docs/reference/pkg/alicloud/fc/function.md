...
<dl class="resources-properties">
    ...
    <dd>The function [entry point](https://www.alibabacloud.com/help/doc-detail/62213.htm) in your code.
</dd>
    ...
    <dd>See [Runtimes][https://www.alibabacloud.com/help/doc-detail/52077.htm] for valid values.
</dd>
    ...
    <dd>The Function Compute service name.
</dd>
    ...
    <dd>The checksum (crc64) of the function code.
</dd>
    ...
    <dd>The Function Compute function description.
</dd>
    ...
    <dd>The path to the function's deployment package within the local filesystem. It is conflict with the `oss_`-prefixed options.
</dd>
    ...
    <dd>Amount of memory in MB your Function can use at runtime. Defaults to `128`. Limits to [128, 3072].
</dd>
    ...
    <dd>The Function Compute function name. It is the only in one service and is conflict with "name_prefix".
</dd>
    ...
    <dd>Setting a prefix to get a only function name. It is conflict with "name".
</dd>
    ...
    <dd>The OSS bucket location containing the function's deployment package. Conflicts with `filename`. This bucket must reside in the same Alibaba Cloud region where you are creating the function.
</dd>
    ...
    <dd>The OSS key of an object containing the function's deployment package. Conflicts with `filename`.
</dd>
    ...
    <dd>The amount of time your Function has to run in seconds.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The Function Compute service ID.
</dd>
