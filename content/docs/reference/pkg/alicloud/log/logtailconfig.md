...
<dl class="resources-properties">
    ...
    <dd>The logtail configure the required JSON files. ([Refer to details](https://www.alibabacloud.com/help/doc-detail/29058.htm))
</dd>
    ...
    <dd>The input type. Currently only two types of files and plugin are supported.
</dd>
    ...
    <dd>The output type. Currently, only LogService is supported.
</dd>
    ...
    <dd>（Optional）The log sample of the Logtail configuration. The log size cannot exceed 1,000 bytes.
</dd>
    ...
    <dd>The Logtail configuration name, which is unique in the same project.
</dd>
