...
<dl class="resources-properties">
    ...
    <dd>Determines whether to append log meta automatically. The meta includes log receive time and client IP address. Default to true.
</dd>
    ...
    <dd>Determines whether to automatically split a shard. Default to true.
</dd>
    ...
    <dd>Determines whether to enable Web Tracking. Default false.
</dd>
    ...
    <dd>The maximum number of shards for automatic split, which is in the range of 1 to 64. You must specify this parameter when autoSplit is true.
</dd>
    ...
    <dd>The log store, which is unique in the same project.
</dd>
    ...
    <dd>The data retention time (in days). Valid values: [1-3650]. Default to 30. Log store data will be stored permanently when the value is "3650".
</dd>
    ...
    <dd>The number of shards in this log store. Default to 2. You can modify it by "Split" or "Merge" operations. [Refer to details](https://www.alibabacloud.com/help/doc-detail/28976.htm)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ID of the log project. It formats of `<project>:<name>`.
</dd>
