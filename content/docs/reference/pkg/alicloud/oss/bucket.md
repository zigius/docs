...
<dl class="resources-properties">
    ...
    <dd>The [canned ACL](https://www.alibabacloud.com/help/doc-detail/31898.htm) to apply. Defaults to "private".
</dd>
    ...
    <dd>A rule of [Cross-Origin Resource Sharing](https://www.alibabacloud.com/help/doc-detail/31903.htm) (documented below). The items of core rule are no more than 10 for every OSS bucket.
</dd>
    ...
    <dd>A boolean that indicates all objects should be deleted from the bucket so that the bucket can be destroyed without error. These objects are not recoverable. Defaults to "false".
</dd>
    ...
    <dd>A configuration of [object lifecycle management](https://www.alibabacloud.com/help/doc-detail/31904.htm) (documented below).
</dd>
    ...
    <dd>A Settings of [bucket logging](https://www.alibabacloud.com/help/doc-detail/31900.htm) (documented below).
</dd>
    ...
    <dd>The flag of using logging enable container. Defaults true.
<p class="property-message">Deprecated: Deprecated from 1.37.0. When `logging` is set, the bucket logging will be able.</p></dd>
    ...
    <dd>Json format text of bucket policy [bucket policy management](https://www.alibabacloud.com/help/doc-detail/100680.htm) (documented below).
</dd>
    ...
    <dd>The configuration of [referer](https://www.alibabacloud.com/help/doc-detail/31901.htm) (documented below).
</dd>
    ...
    <dd>A configuration of server-side encryption (documented below).
</dd>
    ...
    <dd>Specifies the storage class that objects that conform to the rule are converted into. The storage class of the objects in a bucket of the IA storage class can be converted into Archive but cannot be converted into Standard. Values: `IA`, `Archive`, `Standard`. 
</dd>
    ...
    <dd>A mapping of tags to assign to the bucket. The items are no more than 10 for a bucket.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The creation date of the bucket.
</dd>
    ...
    <dd>The extranet access endpoint of the bucket.
</dd>
    ...
    <dd>The intranet access endpoint of the bucket.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Unique identifier for the rule. If omitted, OSS bucket will assign a unique name.
</dd>
    ...
    <dd>Specifies the time when an object is converted to the IA or archive storage class during a valid life cycle. (documented below).
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the date after which you want the corresponding action to take effect. The value obeys ISO8601 format like `2017-03-09`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the time before which the rules take effect. The date must conform to the ISO8601 format and always be UTC 00:00. For example: 2002-10-11T00:00:00.000Z indicates that objects updated before 2002-10-11T00:00:00.000Z are deleted or converted to another storage class, and objects updated after this time (including this time) are not deleted or converted.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Allows referer to be empty. Defaults true.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The server-side encryption algorithm to use. Possible values: `AES256` and `KMS`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the versioning state of a bucket. Valid values: `Enabled` and `Suspended`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Alicloud OSS returns this index document when requests are made to the root domain or any of the subfolders.
</dd>
