...
<dl class="resources-properties">
    ...
    <dd>A regex string to filter results by vpc name.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of instance attachments. Each element contains the following attributes:
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The domain of the instance attachment.
</dd>
    ...
    <dd>The access endpoint of the instance attachment.
</dd>
    ...
    <dd>The resource ID, the value is same as "instance_name".
</dd>
    ...
    <dd>The region of the instance attachment.
</dd>
    ...
    <dd>The name of attaching VPC to instance.
</dd>
