...
<dl class="resources-properties">
    ...
    <dd>A string to filter resulting topics by their name prefixs.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The id of the topic. The value is set to `name`.
</dd>
    ...
    <dd>This indicates the maximum length, in bytes, of any message body sent to the topic.
</dd>
