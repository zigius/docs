...
<dl class="resources-properties">
    ...
    <dd>A list of line display names.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of cloud resolution line. Each element contains the following attributes:
</dd>
