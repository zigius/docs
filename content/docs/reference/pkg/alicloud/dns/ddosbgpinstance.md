...
<dl class="resources-properties">
    ...
    <dd>Elastic defend bandwidth of the instance. This value must be larger than the base defend bandwidth. Valid values: 51,91,101,201,301. The unit is Gbps.
</dd>
    ...
    <dd>IP count of the instance. Valid values: 100.
</dd>
    ...
    <dd>IP version of the instance. Valid values: IPv4,IPv6.
</dd>
    ...
    <dd>Base defend bandwidth of the instance. Valid values: 20. The unit is Gbps. Default to `20`.
</dd>
    ...
    <dd>The duration that you will buy Ddosbgp instance (in month). Valid values: [1~9], 12, 24, 36. Default to 12. At present, the provider does not support modify "period".
</dd>
    ...
    <dd>Type of the instance. Valid values: Enterprise,Professional. Default to `Enterprise`  
</dd>
