...
<dl class="resources-properties">
    ...
    <dd>The frontend port used by the HTTPS listener of the SLB instance. Valid values: 1–65535.
</dd>
    ...
    <dd>The ID of the certificate used by the domain name.
</dd>
