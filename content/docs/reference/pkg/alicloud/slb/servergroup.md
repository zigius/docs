...
<dl class="resources-properties">
    ...
    <dd>The Load Balancer ID which is used to launch a new virtual server group.
</dd>
    ...
    <dd>Name of the virtual server group. Our plugin provides a default name: "tf-server-group".
</dd>
    ...
    <dd>A list of ECS instances to be added. At most 20 ECS instances can be supported in one resource. It contains three sub-fields as `Block server` follows.
</dd>
