...
<dl class="resources-properties">
    ...
    <dd>A list of master slave server group IDs to filter results.
</dd>
    ...
    <dd>A regex string to filter results by master slave server group name.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of SLB master slave server groups. Each element contains the following attributes:
</dd>
    ...
    <dd>A list of SLB master slave server groups IDs.
</dd>
    ...
    <dd>A list of SLB master slave server groups names.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>master slave server group ID.
</dd>
    ...
    <dd>master slave server group name.
</dd>
    ...
    <dd>ECS instances associated to the group. Each element contains the following attributes:
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The port used by the master slave server group.
</dd>
    ...
    <dd>The server type of the attached ECS instance.
</dd>
