...
<dl class="resources-properties">
    ...
    <dd>A list of instance ids to added backend server in the SLB.
</dd>
    ...
    <dd>The backend servers of the load balancer.
</dd>
    ...
    <dd>Type of the instances. Valid value ecs, eni. Default to ecs.
</dd>
    ...
    <dd>Weight of the instances. Valid value range: [0-100]. Default to 100.
</dd>
