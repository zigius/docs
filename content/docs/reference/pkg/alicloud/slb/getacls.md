...
<dl class="resources-properties">
    ...
    <dd>A list of acls IDs to filter results.
</dd>
    ...
    <dd>A regex string to filter results by acl name.
</dd>
    ...
    <dd>The Id of resource group which acl belongs.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of SLB  acls. Each element contains the following attributes:
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of entry (IP addresses or CIDR blocks).  Each entry contains two sub-fields as `Entry Block` follows.
</dd>
    ...
    <dd>A list of listener are attached by the acl.  Each listener contains four sub-fields as `Listener Block` follows.
</dd>
