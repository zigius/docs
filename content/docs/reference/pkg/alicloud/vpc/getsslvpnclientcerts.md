...
<dl class="resources-properties">
    ...
    <dd>IDs of the SSL-VPN client certificates.
</dd>
    ...
    <dd>A regex string of SSL-VPN client certificate name.
</dd>
    ...
    <dd>Use the SSL-VPN server ID as the search key.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of SSL-VPN client cert IDs.
</dd>
    ...
    <dd>A list of SSL-VPN client cert names.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The expiration time of the client certificate.
</dd>
    ...
    <dd>ID of the SSL-VPN client certificate.
</dd>
    ...
    <dd>The name of the SSL-VPN client certificate.
</dd>
    ...
    <dd>The status of the client certificate. valid value:expiring-soon, normal, expired.
</dd>
