...
<dl class="resources-properties">
    ...
    <dd>A regex string to filter nat gateways by name.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of Nat gateways. Each element contains the following attributes:
</dd>
    ...
    <dd>(Optional) A list of Nat gateways IDs.
</dd>
    ...
    <dd>A list of Nat gateways names.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The description of the NAT gateway.
</dd>
    ...
    <dd>The specification of the NAT gateway.
</dd>
    ...
    <dd>The status of the NAT gateway.
</dd>
