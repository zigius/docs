...
<dl class="resources-properties">
    ...
    <dd>The public IP of the Snat Entry.
</dd>
    ...
    <dd>The source CIDR block of the Snat Entry.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of Snat Entries. Each element contains the following attributes:
</dd>
    ...
    <dd>(Optional) A list of Snat Entries IDs.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The status of the Snat Entry.
</dd>
