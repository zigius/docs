...
<dl class="resources-properties">
    ...
    <dd>List of the resources associated with the network acl. The details see Block Resources.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The resource id that the network acl will associate with.
</dd>
    ...
    <dd>The resource id that the network acl will associate with. Only support `VSwitch` now.
</dd>
