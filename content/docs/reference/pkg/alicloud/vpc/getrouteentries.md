...
<dl class="resources-properties">
    ...
    <dd>The ID of the router table to which the route entry belongs.
</dd>
    ...
    <dd>The destination CIDR block of the route entry.
</dd>
    ...
    <dd>The instance ID of the next hop.
</dd>
    ...
    <dd>The type of the route entry.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of Route Entries. Each element contains the following attributes:
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The status of the route entry.
</dd>
