...
<dl class="resources-properties">
    ...
    <dd>A list of Common Bandwidth Packages IDs.
</dd>
    ...
    <dd>A regex string to filter results by name.
</dd>
    ...
    <dd>The Id of resource group which the common bandwidth package belongs.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>(Optional) A list of Common Bandwidth Packages IDs.
</dd>
    ...
    <dd>A list of Common Bandwidth Packages names.
</dd>
    ...
    <dd>A list of Common Bandwidth Packages. Each element contains the following attributes:
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The peak bandwidth of the Internet Shared Bandwidth instance.
</dd>
    ...
    <dd>The business status of the Common Bandwidth Package instance.
</dd>
    ...
    <dd>The description of the Common Bandwidth Package instance.
</dd>
    ...
    <dd>ID of the Common Bandwidth Package.
</dd>
    ...
    <dd>ISP of the Common Bandwidth Package.
</dd>
    ...
    <dd>Name of the Common Bandwidth Package.
</dd>
    ...
    <dd>Public ip addresses that in the Common Bandwidth Pakcage.
</dd>
    ...
    <dd>Status of the Common Bandwidth Package.
</dd>
