...
<dl class="resources-properties">
    ...
    <dd>The external ip address, the ip must along bandwidth package public ip which `alicloud.vpc.NatGateway` argument `bandwidth_packages`.
</dd>
    ...
    <dd>The external port, valid value is 1~65535|any.
</dd>
    ...
    <dd>The value can get from `alicloud.vpc.NatGateway` Attributes "forward_table_ids".
</dd>
    ...
    <dd>The internal ip, must a private ip.
</dd>
    ...
    <dd>The internal port, valid value is 1~65535|any.
</dd>
    ...
    <dd>The ip protocal, valid value is tcp|udp|any.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The id of the forward entry on the server.
</dd>
