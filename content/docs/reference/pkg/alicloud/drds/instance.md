...
<dl class="resources-properties">
    ...
    <dd>Description of the DRDS instance, This description can have a string of 2 to 256 characters.
</dd>
    ...
    <dd>User-defined DRDS instance node spec. Value range:
...
- `drds.sn1.32c64g` for DRDS instance Extreme Edition;
    ...
    <dd>User-defined DRDS instance specification. Value range:
- `drds.sn1.4c8g` for DRDS instance Starter version;
...
- value range : `drds.sn1.32c64g.128c256g`
    ...
    <dd>The VSwitch ID to launch in.
</dd>
    ...
    <dd>The Zone to launch the DRDS instance.
</dd>
