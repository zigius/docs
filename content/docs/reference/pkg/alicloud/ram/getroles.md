...
<dl class="resources-properties">
    ...
    <dd>A regex string to filter results by the role name.
* `ids` (Optional, Available 1.53.0+) - A list of ram role IDs.
    ...
    <dd>Filter results by a specific policy name. If you set this parameter without setting `policy_type`, the later will be automatically set to `System`. The resulting roles will be attached to the specified policy.
</dd>
    ...
    <dd>Filter results by a specific policy type. Valid values are `Custom` and `System`. If you set this parameter, you must set `policy_name` as well.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of roles. Each element contains the following attributes:
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Resource descriptor of the role.
</dd>
    ...
    <dd>Authorization strategy of the role. This parameter is deprecated and replaced by `document`.
</dd>
    ...
    <dd>Authorization strategy of the role.
</dd>
