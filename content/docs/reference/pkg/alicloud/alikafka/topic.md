...
<dl class="resources-properties">
    ...
    <dd>InstanceId of your Kafka resource, the topic will create in this instance.
</dd>
    ...
    <dd>This attribute is a concise description of topic. The length cannot exceed 64.
</dd>
    ...
    <dd>Name of the topic. Two topics on a single instance cannot have the same name. The length cannot exceed 64 characters.
</dd>
    ...
    <dd>Whether the topic is compactTopic or not. Compact topic must be a localTopic.
</dd>
    ...
    <dd>Whether the topic is localTopic or not.
</dd>
    ...
    <dd>The number of partitions of the topic. The number should between 1 and 48.
</dd>
