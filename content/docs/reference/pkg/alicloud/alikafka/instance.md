...
<dl class="resources-properties">
    ...
    <dd>The deploy type of the instance. Currently only support two deploy type, 4: eip/vpc instance, 5: vpc instance.
</dd>
    ...
    <dd>The disk size of the instance. When modify this value, it only support adjust to a greater value.
</dd>
    ...
    <dd>The disk type of the instance. 0: efficient cloud disk , 1: SSD.
</dd>
    ...
    <dd>The max value of io of the instance. When modify this value, it only support adjust to a greater value.
</dd>
    ...
    <dd>The max num of topic can be create of the instance. When modify this value, it only adjust to a greater value.
</dd>
    ...
    <dd>The ID of attaching vswitch to instance.
</dd>
    ...
    <dd>The max bandwidth of the instance. When modify this value, it only support adjust to a greater value.
</dd>
    ...
    <dd>Name of your Kafka instance. The length should between 3 and 64 characters. If not set, will use instance id as instance name.
</dd>
    ...
    <dd>The paid type of the instance. Support two type, "PrePaid": pre paid type instance, "PostPaid": post paid type instance. Default is PostPaid. When modify this value, it only support adjust from post pay to pre pay. 
</dd>
    ...
    <dd>The spec type of the instance. Support two type, "normal": normal version instance, "professional": professional version instance. Default is normal. When modify this value, it only support adjust from normal to professional. Note only pre paid type instance support professional specific type.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ID of attaching VPC to instance.
</dd>
    ...
    <dd>The Zone to launch the kafka instance.
</dd>
