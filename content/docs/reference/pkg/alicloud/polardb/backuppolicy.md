...
<dl class="resources-properties">
    ...
    <dd>PolarDB Cluster backup period. Valid values: [Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday]. Default to ["Tuesday", "Thursday", "Saturday"].
</dd>
    ...
    <dd>PolarDB Cluster backup time, in the format of HH:mmZ- HH:mmZ. Time setting interval is one hour. Default to "02:00Z-03:00Z". China time is 8 hours behind it.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Cluster backup retention days, Fixed for 7 days, not modified.
</dd>
