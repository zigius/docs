...
<dl class="resources-properties">
    ...
    <dd>A regex string to filter api gateway groups by name.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of api groups. Each element contains the following attributes:
</dd>
...
- LOCKED: Locked due to outstanding payment.
    ...
    <dd>Creation time (Greenwich mean time).
</dd>
    ...
    <dd>API group ID, which is generated by the system and globally unique.
</dd>
...
- LOCKED: Locked due to illegality.
    ...
    <dd>Last modification time (Greenwich mean time).
</dd>
    ...
    <dd>The ID of the region where the API group is located.
</dd>
    ...
    <dd>Second-level domain name automatically assigned to the API group.
</dd>
    ...
    <dd>Upper QPS limit of the API group; default value: 500, which can be increased by submitting an application.
</dd>
