...
<dl class="resources-properties">
    ...
    <dd>security group IDs configured to bastionhost
</dd>
    ...
    <dd>vSwtich ID configured to bastionhost
</dd>
    ...
    <dd>Duration for initially producing the instance. Valid values: [1~9], 12, 24, 36. Default to 1. At present, the provider does not support modify "period".
</dd>
