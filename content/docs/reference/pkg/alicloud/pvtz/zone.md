...
<dl class="resources-properties">
    ...
    <dd>The language. Valid values: "zh", "en", "jp".
</dd>
    ...
    <dd>The name of the Private Zone.
</dd>
    ...
    <dd>The recursive DNS proxy. Valid values:
...
- RECORD: indicates that the recursive DNS proxy is enabled.
    ...
    <dd>The remark of the Private Zone.
</dd>
    ...
    <dd>The IP address of the client.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The count of the Private Zone Record.
</dd>
