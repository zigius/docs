...
<dl class="resources-properties">
    ...
    <dd>ID of the ONS Instance that owns the topics.
</dd>
    ...
    <dd>A regex string to filter results by the topic name. 
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of topics. Each element contains the following attributes:
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Indicates whether namespaces are available. Read [Fields in PublishInfoDo](https://www.alibabacloud.com/help/doc-detail/29590.html) for further details.
</dd>
    ...
    <dd>The type of the message. Read [Fields in PublishInfoDo](https://www.alibabacloud.com/help/doc-detail/29590.html) for further details.
</dd>
    ...
    <dd>The ID of the topic owner, which is the Alibaba Cloud UID.
</dd>
    ...
    <dd>The relation ID. Read [Fields in PublishInfoDo](https://www.alibabacloud.com/help/doc-detail/29590.html) for further details.
</dd>
    ...
    <dd>The name of the relation, for example, owner, publishable, subscribable, and publishable and subscribable.
</dd>
