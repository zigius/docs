...
<dl class="resources-properties">
    ...
    <dd>Name of the group. Two groups on a single instance cannot have the same name. A `group_id` starts with "GID_" or "GID-", and contains letters, numbers, hyphens (-), and underscores (_).
</dd>
    ...
    <dd>ID of the ONS Instance that owns the groups.
</dd>
    ...
    <dd>This attribute is used to set the message reading enabled or disabled. It can only be set after the group is used by the client.
</dd>
    ...
    <dd>This attribute is a concise description of group. The length cannot exceed 256.
</dd>
