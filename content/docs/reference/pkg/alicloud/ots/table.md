...
<dl class="resources-properties">
    ...
    <dd>The name of the OTS instance in which table will located.
</dd>
    ...
    <dd>The maximum number of versions stored in this table. The valid value is 1-2147483647.
</dd>
    ...
    <dd>The property of `TableMeta` which indicates the structure information of a table. It describes the attribute value of primary key. The number of `primary_key` should not be less than one and not be more than four.
</dd>
    ...
    <dd>The table name of the OTS instance. If changed, a new table would be created.
</dd>
    ...
    <dd>The retention time of data stored in this table (unit: second). The value maximum is 2147483647 and -1 means never expired.
</dd>
    ...
    <dd>The max version offset of the table. The valid value is 1-9223372036854775807. Defaults to 86400.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Type for primary key. Only `Integer`, `String` or `Binary` is allowed.
</dd>
