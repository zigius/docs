...
<dl class="resources-properties">
    ...
    <dd>The name of the log store which is in the  `project_name` SLS project.
</dd>
    ...
    <dd>A regex string to filter CEN flow logs by name.
</dd>
    ...
    <dd>The name of the SLS project.
</dd>
    ...
    <dd>The status of flowlog. Valid values: ["Active", "Inactive"]. Default to "Active".
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of CEN flow log names. 
</dd>
