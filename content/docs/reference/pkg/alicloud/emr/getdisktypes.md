...
<dl class="resources-properties">
    ...
    <dd>The ecs instance type of create emr cluster instance.
</dd>
    ...
    <dd>The Zone to create emr cluster instance.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of data disk and system disk type IDs. 
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The maximum value of the data disk to supported the specific instance type
</dd>
    ...
    <dd>The mininum value of the data disk to supported the specific instance type
</dd>
    ...
    <dd>The value of the data disk or system disk
</dd>
