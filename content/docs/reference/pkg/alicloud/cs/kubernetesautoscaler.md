...
<dl class="resources-properties">
    ...
    <dd>The id of kubernetes cluster.
</dd>
    ...
    <dd>The cool_down_duration option of cluster-autoscaler.  
</dd>
    ...
    <dd>The defer_scale_in_duration option of cluster-autoscaler.
</dd>
    ...
    <dd>The utilization option of cluster-autoscaler.
</dd>
