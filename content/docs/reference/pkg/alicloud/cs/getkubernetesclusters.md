...
<dl class="resources-properties">
    ...
    <dd>A regex string to filter results by cluster name.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of matched Kubernetes clusters. Each element contains the following attributes:
</dd>
    ...
    <dd>A list of matched Kubernetes clusters' ids.
</dd>
    ...
    <dd>A list of matched Kubernetes clusters' names.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ID of availability zone.
</dd>
    ...
    <dd>The keypair of ssh login cluster node, you have to create it first.
</dd>
    ...
    <dd>A list of one element containing information about the associated log store. It contains the following attributes:
</dd>
    ...
    <dd>The system disk category of master node.
</dd>
    ...
    <dd>The system disk size of master node.
</dd>
    ...
    <dd>The instance type of master node.
</dd>
    ...
    <dd>The network mask used on pods for each node.
</dd>
    ...
    <dd>Whether internet load balancer for API Server is created
</dd>
    ...
    <dd>The ID of VSwitches where the current cluster is located.
</dd>
    ...
    <dd>The data disk size of worker node.
</dd>
    ...
    <dd>The data disk category of worker node.
</dd>
    ...
    <dd>The system disk category of worker node.
</dd>
    ...
    <dd>The system disk size of worker node.
</dd>
    ...
    <dd>The instance type of worker node.
</dd>
    ...
    <dd>The ECS instance node number in the current container cluster.
</dd>
