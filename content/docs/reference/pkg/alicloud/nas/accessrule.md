...
<dl class="resources-properties">
    ...
    <dd>Priority level. Range: 1-100. Default value: 1.
</dd>
    ...
    <dd>Read-write permission type: RDWR (default), RDONLY.
</dd>
    ...
    <dd>User permission type: no_squash (default), root_squash, all_squash.
</dd>
