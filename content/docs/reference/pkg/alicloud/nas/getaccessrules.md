...
<dl class="resources-properties">
    ...
    <dd>Filter results by a specific RWAccess. 
</dd>
    ...
    <dd>Filter results by a specific SourceCidrIp. 
</dd>
    ...
    <dd>Filter results by a specific UserAccess. 
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of rule IDs, Each element set to `access_rule_id` (Each element formats as `<access_group_name>:<access rule id>` before 1.53.0).
</dd>
    ...
    <dd>A list of AccessRules. Each element contains the following attributes:
</dd>
    ...
    <dd>SourceCidrIp of the AccessRule.
</dd>
    ...
    <dd>UserAccess of the AccessRule
</dd>
...
<dl class="resources-properties">
    ...
    <dd>AccessRuleId of the AccessRule.
</dd>
