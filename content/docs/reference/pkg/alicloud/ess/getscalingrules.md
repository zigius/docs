...
<dl class="resources-properties">
    ...
    <dd>A regex string to filter resulting scaling rules by name.
</dd>
    ...
    <dd>Scaling group id the scaling rules belong to.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of scaling rule names.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Adjustment type of the scaling rule.
</dd>
    ...
    <dd>Adjustment value of the scaling rule.
</dd>
    ...
    <dd>Cooldown time of the scaling rule.
</dd>
    ...
    <dd>Min adjustment magnitude of scaling rule.
</dd>
