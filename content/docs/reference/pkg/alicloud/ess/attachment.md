...
<dl class="resources-properties">
    ...
    <dd>ID of the ECS instance to be attached to the scaling group. You can input up to 20 IDs.
</dd>
    ...
    <dd>Whether to remove forcibly "AutoCreated" ECS instances in order to release scaling group capacity "MaxSize" for attaching ECS instances. Default to false.
</dd>
