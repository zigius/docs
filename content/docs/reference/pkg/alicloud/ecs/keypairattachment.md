...
<dl class="resources-properties">
    ...
    <dd>The name of key pair used to bind.
</dd>
    ...
    <dd>Set it to true and it will reboot instances which attached with the key pair to make key pair affect immediately.
</dd>
