...
<dl class="resources-properties">
    ...
    <dd>Instance auto release time. The time is presented using the ISO8601 standard and in UTC time. The format is  YYYY-MM-DDTHH:MM:SSZ.
</dd>
    ...
    <dd>Instance host name.It cannot start or end with a period (.) or a hyphen (-) and it cannot have two or more consecutive periods (.) or hyphens (-).For Windows: The host name can be [2, 15] characters in length. It can contain A-Z, a-z, numbers, periods (.), and hyphens (-). It cannot only contain numbers. For other operating systems: The host name can be [2, 64] characters in length. It can be segments separated by periods (.). It can contain A-Z, a-z, numbers, and hyphens (-).
</dd>
    ...
    <dd>Billing methods. Optional values:
...
- PostPaid: Pay-As-You-Go.
    ...
    <dd>The name of the instance. The name is a string of 2 to 128 characters. It must begin with an English or a Chinese character. It can contain A-Z, a-z, Chinese characters, numbers, periods (.), colons (:), underscores (_), and hyphens (-).
</dd>
    ...
    <dd>Instance type. For more information, call resource_alicloud_instances to obtain the latest instance type list.
</dd>
    ...
    <dd>Internet bandwidth billing method. Optional values: PayByTraffic.
</dd>
    ...
    <dd>The maximum inbound bandwidth from the Internet network, measured in Mbit/s. Value range: [1, 200].
</dd>
    ...
    <dd>Maximum outbound bandwidth from the Internet, its unit of measurement is Mbit/s. Value range: [0, 100].
</dd>
    ...
    <dd>Whether it is an I/O-optimized instance or not. Optional values:
- none
- optimized
</dd>
...
- The password logon method for Linux instances is set to forbidden upon initialization.
    ...
    <dd>The list of network interfaces created with instance.
</dd>
    ...
    <dd>Network type of the instance. Value options: Classic | VPC.
</dd>
    ...
    <dd>The RAM role name of the instance. You can use the RAM API ListRoles to query instance RAM role names.
</dd>
    ...
    <dd>Whether or not to activate the security enhancement feature and install network security software free of charge. Optional values: Active | Deactive.
</dd>
    ...
    <dd>The security group ID must be one in the same VPC.
</dd>
    ...
    <dd>The spot strategy for a Pay-As-You-Go instance. This parameter is valid and required only when InstanceChargeType is set to PostPaid. Value range:
...
- SpotAsPriceGo: The system automatically calculates the price. The maximum value is the Pay-As-You-Go price.
    ...
    <dd>The category of the system disk. System disk type. Optional values:
...
- cloud_essd: ESSD cloud Disks.
    ...
    <dd>System disk description. It cannot begin with http:// or https://.
</dd>
    ...
    <dd>System disk name. The name is a string of 2 to 128 characters. It must begin with an English or a Chinese character. It can contain A-Z, a-z, Chinese characters, numbers, periods (.), colons (:), underscores (_), and hyphens (-).
</dd>
    ...
    <dd>Size of the system disk, measured in GB. Value range: [20, 500].
</dd>
...
- Value: It can be up to 128 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It can be a null string.
    ...
    <dd>User data of the instance, which is Base64-encoded. Size of the raw data cannot exceed 16 KB.
</dd>
    ...
    <dd>The VSwitch ID for ENI. The instance must be in the same zone of the same VPC network as the ENI, but they may belong to different VSwitches.
</dd>
    ...
    <dd>The zone ID of the instance.
</dd>
...
- cloud_essd: ESSD cloud Disks.
    ...
    <dd>Delete this data disk when the instance is destroyed. It only works on cloud, cloud_efficiency, cloud_ssd and cloud_essd disk. If the category of this data disk was ephemeral_ssd, please don't set this param.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The primary private IP address of the ENI.
</dd>
