...
<dl class="resources-properties">
    ...
    <dd>The ID of the region to which the source custom image belongs. You can call [DescribeRegions](https://www.alibabacloud.com/help/doc-detail/25609.htm) to view the latest regions of Alibaba Cloud.
</dd>
    ...
    <dd>Indicates whether to encrypt the image.
</dd>
...
- false：Verifies that the image is not currently in use by any other instances before deleting the image.
    ...
    <dd>Key ID used to encrypt the image.
</dd>
