...
<dl class="resources-properties">
    ...
    <dd>The ids list of AnalyticDB for PostgreSQL instances.
</dd>
    ...
    <dd>A list of AnalyticDB for PostgreSQL instances. Its every element contains the following attributes:
</dd>
    ...
    <dd>The names list of AnalyticDB for PostgreSQL instance.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The time when you create an instance. The format is YYYY-MM-DDThh:mm:ssZ, such as 2011-05-30T12:11:4Z.
</dd>
    ...
    <dd>The description of an instance.
</dd>
    ...
    <dd>Database engine type. Supported option is `gpdb`.
</dd>
