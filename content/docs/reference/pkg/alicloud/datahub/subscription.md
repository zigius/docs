...
<dl class="resources-properties">
    ...
    <dd>The name of the datahub project that the subscription belongs to. Its length is limited to 3-32 and only characters such as letters, digits and '_' are allowed. It is case-insensitive.
</dd>
    ...
    <dd>The name of the datahub topic that the subscription belongs to. Its length is limited to 1-128 and only characters such as letters, digits and '_' are allowed. It is case-insensitive.
</dd>
    ...
    <dd>Comment of the datahub subscription. It cannot be longer than 255 characters.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Create time of the datahub subscription. It is a human-readable string rather than 64-bits UTC.
</dd>
    ...
    <dd>Last modify time of the datahub subscription. It is the same as *create_time* at the beginning. It is also a human-readable string rather than 64-bits UTC.
</dd>
    ...
    <dd>The identidy of the subscritpion, generate from server side.
</dd>
