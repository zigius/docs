...
<dl class="resources-properties">
    ...
    <dd>Name of container registry namespace where repository is located.
</dd>
    ...
    <dd>`PUBLIC` or `PRIVATE`, repo's visibility.
</dd>
    ...
    <dd>The repository general information. It can contain 1 to 80 characters.
</dd>
    ...
    <dd>The repository specific information. MarkDown format is supported, and the length limit is 2000.
</dd>
    ...
    <dd>Name of container registry repository.
</dd>
