...
<dl class="resources-properties">
    ...
    <dd>A regex string to filter results by namespace name.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A list of matched Container Registry namespaces. Its element is a namespace name.
</dd>
