...
<dl class="resources-properties">
    ...
    <dd>Boolean, when it set to true, repositories are automatically created when pushing new images. If it set to false, you create repository for images before pushing.
</dd>
    ...
    <dd>`PUBLIC` or `PRIVATE`, default repository visibility in this namespace.
</dd>
