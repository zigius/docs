...
after destruction of the resource, must be between 7 and 30 days. Defaults to 30 days.
    ...
    <dd>Specifies the usage of CMK. Currently, default to 'ENCRYPT/DECRYPT', indicating that CMK is used for encryption and decryption.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The Alicloud Resource Name (ARN) of the key.
</dd>
