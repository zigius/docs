...
<dl class="resources-properties">
    ...
    <dd>whether the current topic is kafka compact topic or not.
</dd>
    ...
    <dd>whether the current topic is kafka local topic or not.
</dd>
    ...
    <dd>Partition number of the topic.
</dd>
    ...
    <dd>The current status code of the topic. There are three values to describe the topic status: 0 stands for the topic is in service, 1 stands for freezing and 2 stands for pause. 
</dd>
