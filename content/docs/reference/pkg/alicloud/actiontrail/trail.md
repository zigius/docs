...
<dl class="resources-properties">
    ...
    <dd>The OSS bucket to which the trail delivers logs. Ensure that this is an existing OSS bucket.
</dd>
    ...
    <dd>The RAM role in ActionTrail permitted by the user.
</dd>
    ...
    <dd>Indicates whether the event is a read or a write event. Valid values: Read, Write, and All. Default value: Write.
</dd>
    ...
    <dd>The name of the trail to be created, which must be unique for an account.
</dd>
    ...
    <dd>The prefix of the specified OSS bucket name. This parameter can be left empty.
</dd>
    ...
    <dd>The unique ARN of the Log Service project.
</dd>
    ...
    <dd>The unique ARN of the Log Service role.
</dd>
