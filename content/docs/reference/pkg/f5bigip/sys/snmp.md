...
<dl class="resources-properties">
    ...
    <dd>Configures hosts or networks from which snmpd can accept traffic. Entries go directly into hosts.allow.
</dd>
    ...
    <dd>Specifies the contact information for the system administrator.
</dd>
    ...
    <dd>Describes the system's physical location.
</dd>
