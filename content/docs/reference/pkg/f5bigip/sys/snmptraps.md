...
<dl class="resources-properties">
    ...
    <dd>Specifies the protocol used to authenticate the user.
</dd>
    ...
    <dd>Specifies the community string used for this trap.
</dd>
    ...
    <dd>The port that the trap will be sent to.
</dd>
    ...
    <dd>Specifies the authoritative security engine for SNMPv3.
</dd>
    ...
    <dd>The host the trap will be sent to.
</dd>
    ...
    <dd>Specifies the clear text password used to encrypt traffic. This field will not be displayed.
</dd>
    ...
    <dd>Specifies the encrypted password used to encrypt traffic.
</dd>
    ...
    <dd>Specifies the protocol used to encrypt traffic.
</dd>
    ...
    <dd>Specifies whether or not traffic is encrypted and whether or not authentication is required.
</dd>
    ...
    <dd>Security name used in conjunction with SNMPv3.
</dd>
    ...
    <dd>SNMP version used for sending the trap.
</dd>
