...
<dl class="resources-properties">
    ...
    <dd>Server authentication once / always (default is once).
</dd>
    ...
    <dd>Client certificate chain traversal depth. Default 9.
</dd>
    ...
    <dd>Specifies the name of the certificate that the system uses for server-side SSL processing.
</dd>
    ...
    <dd>Specifies the certificates-key chain to associate with the SSL profile
</dd>
    ...
    <dd>The parent template of this monitor template. Once this value has been set, it cannot be changed. By default, this value is `/Common/serverssl`.
</dd>
    ...
    <dd>Response if the cert is expired (drop / ignore).
</dd>
    ...
    <dd>Specifies the file name of the SSL key.
</dd>
...
There can be only one SSL profile with this setting enabled.
    ...
    <dd>Unclean Shutdown (drop / ignore)
</dd>
