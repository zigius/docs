...
<dl class="resources-properties">
    ...
    <dd>Name of the virtual address
</dd>
    ...
    <dd>Enabled dynamic routing of the address
</dd>
    ...
    <dd>Enable or disable ARP for the virtual address
</dd>
    ...
    <dd>Automatically delete the virtual address with the virtual server
</dd>
    ...
    <dd>Max number of connections for virtual address
</dd>
    ...
    <dd>Enable or disable the virtual address
</dd>
    ...
    <dd>Enable/Disable ICMP response to the virtual address
</dd>
    ...
    <dd>Specify the partition and traffic group
</dd>
