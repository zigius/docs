...
<dl class="resources-properties">
    ...
    <dd>Userdefined value to describe the pool 
</dd>
    ...
    <dd>Possible values: round-robin, ...
</dd>
    ...
    <dd>List of monitor names to associate with the pool
</dd>
    ...
    <dd>Number of times the system tries to select a new pool member after a failure.
</dd>
    ...
    <dd>Possible values: none, reset, reselect, drop
</dd>
    ...
    <dd>Slow ramp time for pool members
</dd>
