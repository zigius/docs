...
<dl class="resources-properties">
    ...
    <dd>IP address used for config sync
</dd>
    ...
    <dd>Address of the Device which needs to be Deviceensed
</dd>
    ...
    <dd>IP address used for state mirroring
</dd>
    ...
    <dd>Secondary IP address used for state mirroring
</dd>
