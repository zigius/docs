...
<dl class="resources-properties">
    ...
    <dd>Domain name/IP of the BigIP
</dd>
    ...
    <dd>Username with API access to the BigIP
</dd>
    ...
    <dd>Login reference for token authentication (see BIG-IP REST docs for details)
</dd>
    ...
    <dd>Management Port to connect to Bigip
</dd>
    ...
    <dd>Enable to use an external authentication source (LDAP, TACACS, etc)
</dd>
