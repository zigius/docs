...
<dl class="resources-properties">
    ...
    <dd>The name of the resource group in which the EventGrid Topic exists. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>Specifies the name of the EventGrid Topic resource. Changing this forces a new resource to be created.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The Endpoint associated with the EventGrid Topic.
</dd>
    ...
    <dd>The Primary Shared Access Key associated with the EventGrid Topic.
</dd>
    ...
    <dd>The Secondary Shared Access Key associated with the EventGrid Topic.
</dd>
