...
<dl class="resources-properties">
    ...
    <dd>One or more `record` blocks as defined below.
</dd>
    ...
    <dd>The name of the DNS SRV Record. Changing this forces a new resource to be created.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The Port the service is listening on.
</dd>
    ...
    <dd>The priority of the SRV record.
</dd>
    ...
    <dd>The Weight of the SRV record.
</dd>
