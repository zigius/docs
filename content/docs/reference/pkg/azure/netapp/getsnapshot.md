...
<dl class="resources-properties">
    ...
    <dd>The name of the NetApp Snapshot.
</dd>
    ...
    <dd>The Name of the Resource Group where the NetApp Snapshot exists.
</dd>
    ...
    <dd>The name of the NetApp Volume where the NetApp Snapshot exists.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The Azure Region where the NetApp Snapshot exists.
</dd>
