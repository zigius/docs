...
<dl class="resources-properties">
    ...
    <dd>Specifies the managed application definition display name.
</dd>
    ...
    <dd>Specifies the managed application lock level. Valid values include `CanNotDelete`, `None`, `ReadOnly`. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>The name of the Resource Group where the Managed Application Definition should exist. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>One or more `authorization` block defined below.
</dd>
    ...
    <dd>Specifies the `createUiDefinition` json for the backing template with `Microsoft.Solutions/applications` resource.
</dd>
    ...
    <dd>Specifies the managed application definition description.
</dd>
    ...
    <dd>Specifies the inline main template json which has resources to be provisioned.
</dd>
    ...
    <dd>Specifies the name of the Managed Application Definition. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>Is the package enabled? Defaults to `true`.
</dd>
    ...
    <dd>Specifies the managed application definition package file Uri.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies a role definition identifier for the provider. This role will define all the permissions that the provider must have on the managed application's container resource group. This role definition cannot have permission to delete the resource group.
</dd>
    ...
    <dd>Specifies a service principal identifier for the provider. This is the identity that the provider will use to call ARM to manage the managed application resources.
</dd>
