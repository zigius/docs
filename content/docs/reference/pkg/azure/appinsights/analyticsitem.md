...
<dl class="resources-properties">
    ...
    <dd>The ID of the Application Insights component on which the Analytics Item exists. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>The content for the Analytics Item, for example the query text if `type` is `query`.
</dd>
    ...
    <dd>The scope for the Analytics Item. Can be `shared` or `user`. Changing this forces a new resource to be created. Must be `shared` for functions.
</dd>
    ...
    <dd>The type of Analytics Item to create. Can be one of `query`, `function`, `folder`, `recent`. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>The alias to use for the function. Required when `type` is `function`.
</dd>
    ...
    <dd>Specifies the name of the Application Insights Analytics Item. Changing this forces a new resource to be created.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A string containing the time the Analytics Item was created.
</dd>
    ...
    <dd>A string containing the time the Analytics Item was last modified.
</dd>
    ...
    <dd>A string indicating the version of the query format
</dd>
