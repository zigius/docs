...
<dl class="resources-properties">
    ...
    <dd>The ID of the Application Insights component on which the WebTest operates. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>An XML configuration specification for a WebTest.
</dd>
    ...
    <dd>A list of where to physically run the tests from to give global coverage for accessibility of your application.
</dd>
    ...
    <dd>Purpose/user defined descriptive test for this WebTest.
</dd>
    ...
    <dd>Is the test actively being monitored.
</dd>
    ...
    <dd>Interval in seconds between test runs for this WebTest. Default is `300`.
</dd>
    ...
    <dd>Specifies the name of the Application Insights WebTest. Changing this forces a
new resource to be created.
    ...
    <dd>Allow for retries should this WebTest fail.
</dd>
    ...
    <dd>Seconds until this WebTest will timeout and fail. Default is `30`.
</dd>
