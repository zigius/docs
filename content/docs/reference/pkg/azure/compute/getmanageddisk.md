...
<dl class="resources-properties">
    ...
    <dd>Specifies the name of the Managed Disk.
</dd>
    ...
    <dd>Specifies the name of the Resource Group where this Managed Disk exists.
</dd>
    ...
    <dd>A list of Availability Zones where the Managed Disk exists.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ID of the Disk Encryption Set used to encrypt this Managed Disk.
</dd>
    ...
    <dd>The number of IOPS allowed for this disk, where one operation can transfer between 4k and 256k bytes.
</dd>
    ...
    <dd>The bandwidth allowed for this disk.
</dd>
    ...
    <dd>The size of the Managed Disk in gigabytes.
</dd>
    ...
    <dd>The operating system used for this Managed Disk.
</dd>
    ...
    <dd>The ID of an existing Managed Disk which this Disk was created from.
</dd>
    ...
    <dd>The Source URI for this Managed Disk.
</dd>
    ...
    <dd>The ID of the Storage Account where the `source_uri` is located.
</dd>
    ...
    <dd>The storage account type for the Managed Disk.
</dd>
