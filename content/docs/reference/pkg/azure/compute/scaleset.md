...
<dl class="resources-properties">
    ...
    <dd>A collection of network profile block as documented below.
</dd>
    ...
    <dd>A Virtual Machine OS Profile block as documented below.
</dd>
    ...
    <dd>The name of the resource group in which to create the virtual machine scale set. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>A storage profile os disk block as documented below
</dd>
    ...
    <dd>Specifies the mode of an upgrade to virtual machines in the scale set. Possible values, `Rolling`, `Manual`, or `Automatic`. When choosing `Rolling`, you will need to set a health probe.
</dd>
    ...
    <dd>Automatic OS patches can be applied by Azure to your scaleset. This is particularly useful when `upgrade_policy_mode` is set to `Rolling`. Defaults to `false`.
</dd>
    ...
    <dd>A boot diagnostics profile block as referenced below.
</dd>
    ...
    <dd>Specifies the eviction policy for Virtual Machines in this Scale Set. Possible values are `Deallocate` and `Delete`.
</dd>
    ...
    <dd>Can be specified multiple times to add extension profiles to the scale set. Each `extension` block supports the fields documented below.
</dd>
    ...
    <dd>Specifies the identifier for the load balancer health probe. Required when using `Rolling` as your `upgrade_policy_mode`.
</dd>
    ...
    <dd>Specifies the Windows OS license type. If supplied, the only allowed values are `Windows_Client` and `Windows_Server`.
</dd>
    ...
    <dd>Specifies the name of the virtual machine scale set resource. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>A Linux config block as documented below.
</dd>
    ...
    <dd>A collection of Secret blocks as documented below.
</dd>
    ...
    <dd>A Windows config block as documented below.
</dd>
    ...
    <dd>Specifies whether the virtual machine scale set should be overprovisioned.
</dd>
    ...
    <dd>A plan block as documented below.
</dd>
    ...
    <dd>Specifies the priority for the Virtual Machines in the Scale Set. Defaults to `Regular`. Possible values are `Low` and `Regular`.
</dd>
    ...
    <dd>The ID of the Proximity Placement Group to which this Virtual Machine should be assigned. Changing this forces a new resource to be created
</dd>
    ...
    <dd>A `rolling_upgrade_policy` block as defined below. This is only applicable when the `upgrade_policy_mode` is `Rolling`.
</dd>
    ...
    <dd>Specifies whether the scale set is limited to a single placement group with a maximum size of 100 virtual machines. If set to false, managed disks must be used. Default is true. Changing this forces a new resource to be created. See [documentation](http://docs.microsoft.com/en-us/azure/virtual-machine-scale-sets/virtual-machine-scale-sets-placement-groups) for more information.
</dd>
    ...
    <dd>A storage profile data disk block as documented below
</dd>
    ...
    <dd>A storage profile image reference block as documented below.
</dd>
    ...
    <dd>A collection of availability zones to spread the Virtual Machines over.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the name of the extension.
</dd>
    ...
    <dd>The publisher of the extension, available publishers can be found by using the Azure CLI.
</dd>
    ...
    <dd>The type of extension, available types for a publisher can be found using the Azure CLI.
</dd>
    ...
    <dd>Specifies whether or not to use the latest minor version available.
</dd>
    ...
    <dd>The protected_settings passed to the extension, like settings, these are specified as a JSON object in a string.
</dd>
    ...
    <dd>Specifies a dependency array of extensions required to be executed before, the array stores the name of each extension.
</dd>
    ...
    <dd>The settings passed to the extension, these are specified as a JSON object in a string.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies a list of user managed identity ids to be assigned to the VMSS. Required if `type` is `UserAssigned`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>An ip_configuration block as documented below.
</dd>
    ...
    <dd>Specifies the name of the network interface configuration.
</dd>
    ...
    <dd>Indicates whether network interfaces created from the network interface configuration will be the primary NIC of the VM.
</dd>
    ...
    <dd>Specifies whether to enable accelerated networking or not. Defaults to `false`.
</dd>
    ...
    <dd>A dns_settings block as documented below.
</dd>
    ...
    <dd>Whether IP forwarding is enabled on this NIC. Defaults to `false`.
</dd>
    ...
    <dd>Specifies the identifier for the network security group.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies an array of dns servers.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies name of the IP configuration.
</dd>
    ...
    <dd>Specifies if this ip_configuration is the primary one.
</dd>
    ...
    <dd>Specifies the identifier of the subnet.
</dd>
    ...
    <dd>Specifies an array of references to backend address pools of application gateways. A scale set can reference backend address pools of multiple application gateways. Multiple scale sets can use the same application gateway.
</dd>
    ...
    <dd>Specifies up to `20` application security group IDs.
</dd>
    ...
    <dd>Specifies an array of references to backend address pools of load balancers. A scale set can reference backend address pools of one public and one internal load balancer. Multiple scale sets cannot use the same load balancer.
</dd>
    ...
    <dd>Specifies an array of references to inbound NAT pools for load balancers. A scale set can reference inbound nat pools of one public and one internal load balancer. Multiple scale sets cannot use the same load balancer.
</dd>
    ...
    <dd>Describes a virtual machines scale set IP Configuration's PublicIPAddress configuration. The public_ip_address_configuration is documented below.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The domain name label for the dns settings.
</dd>
    ...
    <dd>The idle timeout in minutes. This value must be between 4 and 30.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the administrator account name to use for all the instances of virtual machines in the scale set.
</dd>
    ...
    <dd>Specifies the computer name prefix for all of the virtual machines in the scale set. Computer name prefixes must be 1 to 9 characters long for windows images and 1 - 58 for linux. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>Specifies the administrator password to use for all the instances of virtual machines in a scale set.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies whether password authentication should be disabled. Defaults to `false`. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>Specifies a collection of `path` and `key_data` to be placed on the virtual machine.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the key vault to use.
</dd>
    ...
    <dd>A collection of Vault Certificates as documented below
</dd>
...
<dl class="resources-properties">
    ...
    <dd>It is the Base64 encoding of a JSON Object that which is encoded in UTF-8 of which the contents need to be `data`, `dataType` and `password`.
</dd>
    ...
    <dd>Specifies the certificate store on the Virtual Machine where the certificate should be added to.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>An Additional Unattended Config block as documented below.
</dd>
    ...
    <dd>Indicates whether virtual machines in the scale set are enabled for automatic updates.
</dd>
    ...
    <dd>Indicates whether virtual machine agent should be provisioned on the virtual machines in the scale set.
</dd>
    ...
    <dd>A collection of WinRM configuration blocks as documented below.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the name of the component to configure with the added content. The only allowable value is `Microsoft-Windows-Shell-Setup`.
</dd>
    ...
    <dd>Specifies the base-64 encoded XML formatted content that is added to the unattend.xml file for the specified path and component.
</dd>
    ...
    <dd>Specifies the name of the pass that the content applies to. The only allowable value is `oobeSystem`.
</dd>
    ...
    <dd>Specifies the name of the setting to which the content applies. Possible values are: `FirstLogonCommands` and `AutoLogon`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the protocol of listener
</dd>
    ...
    <dd>Specifies URL of the certificate with which new Virtual Machines is provisioned.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the name of the image from the marketplace.
</dd>
    ...
    <dd>Specifies the product of the image from the marketplace.
</dd>
    ...
    <dd>Specifies the publisher of the image.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The maximum percentage of upgraded virtual machine instances that can be found to be in an unhealthy state. This check will happen after each batch is upgraded. If this percentage is ever exceeded, the rolling update aborts. Defaults to `20`.
</dd>
    ...
    <dd>The wait time between completing the update for all virtual machines in one batch and starting the next batch. The time duration should be specified in ISO 8601 format for duration (https://en.wikipedia.org/wiki/ISO_8601#Durations). Defaults to `0` seconds represented as `PT0S`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the number of virtual machines in the scale set.
</dd>
    ...
    <dd>Specifies the size of virtual machines in a scale set.
</dd>
    ...
    <dd>Specifies the tier of virtual machines in a scale set. Possible values, `standard` or `basic`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies how the data disk should be created. The only possible options are `FromImage` and `Empty`.
</dd>
    ...
    <dd>Specifies the Logical Unit Number of the disk in each virtual machine in the scale set.
</dd>
    ...
    <dd>Specifies the caching requirements. Possible values include: `None` (default), `ReadOnly`, `ReadWrite`.
</dd>
    ...
    <dd>Specifies the size of the disk in GB. This element is required when creating an empty disk.
</dd>
    ...
    <dd>Specifies the type of managed disk to create. Value must be either `Standard_LRS`, `StandardSSD_LRS` or `Premium_LRS`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the ID of the (custom) image to use to create the virtual
machine scale set, as in the example below.
    ...
    <dd>Specifies the offer of the image used to create the virtual machines.
</dd>
    ...
    <dd>Specifies the publisher of the image used to create the virtual machines.
</dd>
    ...
    <dd>Specifies the SKU of the image used to create the virtual machines.
</dd>
    ...
    <dd>Specifies the version of the image used to create the virtual machines.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies how the virtual machine should be created. The only possible option is `FromImage`.
</dd>
    ...
    <dd>Specifies the blob uri for user image. A virtual machine scale set creates an os disk in the same container as the user image.
...
When setting this field `os_type` needs to be specified. Cannot be used when `vhd_containers`, `managed_disk_type` or `storage_profile_image_reference` are specified.
    ...
    <dd>Specifies the type of managed disk to create. Value you must be either `Standard_LRS`, `StandardSSD_LRS` or `Premium_LRS`. Cannot be used when `vhd_containers` or `image` is specified.
</dd>
    ...
    <dd>Specifies the disk name. Must be specified when using unmanaged disk ('managed_disk_type' property not set).
</dd>
    ...
    <dd>Specifies the operating system Type, valid values are windows, linux.
</dd>
    ...
    <dd>Specifies the vhd uri. Cannot be used when `image` or `managed_disk_type` is specified.
</dd>
