...
<dl class="resources-properties">
    ...
    <dd>The publisher of the extension, available publishers
can be found by using the Azure CLI.
    ...
    <dd>The type of extension, available types for a publisher can
be found using the Azure CLI.
    ...
    <dd>Specifies the version of the extension to
use, available versions can be found using the Azure CLI.
    ...
    <dd>Specifies if the platform deploys
the latest minor version update to the `type_handler_version` specified.
    ...
    <dd>The name of the virtual machine extension peering. Changing
this forces a new resource to be created.
    ...
    <dd>The protected_settings passed to the
extension, like settings, these are specified as a JSON object in a string.
    ...
    <dd>The settings passed to the extension, these are
