...
<dl class="resources-properties">
    ...
    <dd>The Name of the API Management Service where this backend should be created. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>The protocol used by the backend host. Possible values are `http` or `soap`.
</dd>
    ...
    <dd>The URL of the backend host.
</dd>
    ...
    <dd>A `credentials` block as documented below.
</dd>
    ...
    <dd>The description of the backend.
</dd>
    ...
    <dd>The name of the API Management backend. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>A `proxy` block as documented below.
</dd>
    ...
    <dd>The management URI of the backend host in an external system. This URI can be the ARM Resource ID of Logic Apps, Function Apps or API Apps, or the management endpoint of a Service Fabric cluster.
</dd>
    ...
    <dd>A `service_fabric_cluster` block as documented below.
</dd>
    ...
    <dd>A `tls` block as documented below.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>An `authorization` block as defined below.
</dd>
    ...
    <dd>A list of client certificate thumbprints to present to the backend host. The certificates must exist within the API Management Service.
</dd>
    ...
    <dd>A mapping of header parameters to pass to the backend host. The keys are the header names and the values are a comma separated string of header values. This is converted to a list before being passed to the API.
</dd>
    ...
    <dd>A mapping of query parameters to pass to the backend host. The keys are the query names and the values are a comma separated string of query values. This is converted to a list before being passed to the API.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The authentication Parameter value.
</dd>
    ...
    <dd>The authentication Scheme name.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The URL of the proxy server.
</dd>
    ...
    <dd>The username to connect to the proxy server.
</dd>
    ...
    <dd>The password to connect to the proxy server.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The client certificate thumbprint for the management endpoint.
</dd>
    ...
    <dd>A list of cluster management endpoints.
</dd>
    ...
    <dd>The maximum number of retries when attempting resolve the partition.
</dd>
    ...
    <dd>A list of thumbprints of the server certificates of the Service Fabric cluster.
</dd>
    ...
    <dd>One or more `server_x509_name` blocks as documented below.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The thumbprint for the issuer of the certificate.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Flag indicating whether SSL certificate chain validation should be done when using self-signed certificates for the backend host.
</dd>
    ...
    <dd>Flag indicating whether SSL certificate name validation should be done when using self-signed certificates for the backend host.
</dd>
