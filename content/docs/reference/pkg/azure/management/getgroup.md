...
<dl class="resources-properties">
    ...
    <dd>Specifies the name or UUID of this Management Group.
...
<dl class="resources-properties">
    ...
    <dd>A friendly name for the Management Group.
</dd>
    ...
    <dd><p class="property-message">Deprecated: Deprecated in favour of `name`</p></dd>
    ...
    <dd>The ID of any Parent Management Group.
</dd>
    ...
    <dd>A list of Subscription ID's which are assigned to the Management Group.
</dd>
