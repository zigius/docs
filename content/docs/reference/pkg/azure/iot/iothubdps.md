...
<dl class="resources-properties">
    ...
    <dd>The name of the resource group under which the Iot Device Provisioning Service resource has to be created. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>A `linked_hub` block as defined below.
</dd>
    ...
    <dd>Specifies the name of the Iot Device Provisioning Service resource. Changing this forces a new resource to be created.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The allocation policy of the IoT Device Provisioning Service.
</dd>
    ...
    <dd>The device endpoint of the IoT Device Provisioning Service.
</dd>
    ...
    <dd>The unique identifier of the IoT Device Provisioning Service.
</dd>
    ...
    <dd>The service endpoint of the IoT Device Provisioning Service.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The connection string to connect to the IoT Hub. Changing this forces a new resource.
</dd>
    ...
    <dd>The location of the IoT hub. Changing this forces a new resource.
</dd>
    ...
    <dd>The weight applied to the IoT Hub. Defaults to 0.
</dd>
    ...
    <dd>Determines whether to apply allocation policies to the IoT Hub. Defaults to false.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The number of provisioned IoT Device Provisioning Service units.
</dd>
