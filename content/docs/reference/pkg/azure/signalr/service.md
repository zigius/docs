...
<dl class="resources-properties">
    ...
    <dd>The name of the resource group in which to create the SignalR service. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>A `cors` block as documented below.
</dd>
    ...
    <dd>A `features` block as documented below.
</dd>
    ...
    <dd>Specifies the supported Azure location where the SignalR service exists. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>The name of the SignalR service. Changing this forces a new resource to be created.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The FQDN of the SignalR service.
</dd>
    ...
    <dd>The publicly accessible IP of the SignalR service.
</dd>
    ...
    <dd>The primary access key for the SignalR service.
</dd>
    ...
    <dd>The primary connection string for the SignalR service.
</dd>
    ...
    <dd>The publicly accessible port of the SignalR service which is designed for browser/client use.
</dd>
    ...
    <dd>The secondary access key for the SignalR service.
</dd>
    ...
    <dd>The secondary connection string for the SignalR service.
</dd>
    ...
    <dd>The publicly accessible port of the SignalR service which is designed for customer server side use.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The kind of Feature. Possible values are `EnableConnectivityLogs` and `ServiceMode`.
</dd>
    ...
    <dd>A value of a feature flag. Possible values are `Classic`, `Default` and `Serverless`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the number of units associated with this SignalR service. Valid values are `1`, `2`, `5`, `10`, `20`, `50` and `100`.
</dd>
    ...
    <dd>Specifies which tier to use. Valid values are `Free_F1` and `Standard_S1`.
</dd>
