...
<dl class="resources-properties">
    ...
    <dd>The bandwidth in Mbps of the circuit being created.
</dd>
    ...
    <dd>The name of the resource group in which to create the ExpressRoute circuit. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>Allow the circuit to interact with classic (RDFE) resources. The default value is `false`.
</dd>
    ...
    <dd>The name of the ExpressRoute circuit. Changing this forces a new resource to be created.
</dd>
