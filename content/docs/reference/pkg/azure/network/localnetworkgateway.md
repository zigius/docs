...
<dl class="resources-properties">
    ...
    <dd>The list of string CIDRs representing the
address spaces the gateway exposes.
    ...
    <dd>The IP address of the gateway to which to
connect.
</dd>
...
create the local network gateway.
    ...
    <dd>A `bgp_settings` block as defined below containing the
Local Network Gateway's BGP speaker settings.
    ...
    <dd>The location/region where the local network gateway is
created. Changing this forces a new resource to be created.
    ...
    <dd>The name of the local network gateway. Changing this
...
<dl class="resources-properties">
    ...
    <dd>The BGP peering address and BGP identifier
of this BGP speaker.
</dd>
    ...
    <dd>The weight added to routes learned from this
BGP speaker.
</dd>
