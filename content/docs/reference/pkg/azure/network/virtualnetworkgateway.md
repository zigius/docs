...
a new resource to be created.
    ...
    <dd>Configuration of the size and capacity of the virtual network
...
sku is only supported by an `ExpressRoute` gateway.
    ...
    <dd>The type of the Virtual Network Gateway. Valid options are
`Vpn` or `ExpressRoute`. Changing the type forces a new resource to be created.
    ...
    <dd>If `true`, an active-active Virtual Network Gateway
...
If not specified, forced tunnelling is disabled.
    ...
    <dd>If `true`, BGP (Border Gateway Protocol) will be enabled
for this Virtual Network Gateway. Defaults to `false`.
    ...
    <dd>The Generation of the Virtual Network gateway. Possible values include `Generation1`, `Generation2` or `None`.
</dd>
    ...
    <dd>The location/region where the Virtual Network Gateway is
located. Changing the location/region forces a new resource to be created.
    ...
    <dd>A user-defined name of the revoked certificate.
</dd>
    ...
    <dd>A `vpn_client_configuration` block which
...
to accept IPSec point-to-site connections.
    ...
    <dd>The routing type of the Virtual Network Gateway. Valid
...
`Dynamic`. Defaults to `Dynamic`.
    ...
    <dd>The ID of the public ip address to associate
...
<dl class="resources-properties">
    ...
    <dd>The SHA1 thumbprint of the certificate to be
revoked.
</dd>
