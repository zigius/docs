...
<dl class="resources-properties">
    ...
    <dd>The Name of the Resource Group in which this VPN Gateway should be created. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>The ID of the Virtual Hub within which this VPN Gateway should be created. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>A `bgp_settings` block as defined below.
</dd>
    ...
    <dd>The Azure location where this VPN Gateway should be created. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>The Name which should be used for this VPN Gateway. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>The Scale Unit for this VPN Gateway. Defaults to `1`.
</dd>
    ...
    <dd>A mapping of tags to assign to the VPN Gateway.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The ASN of the BGP Speaker. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>The weight added to Routes learned from this BGP Speaker. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>The Address which should be used for the BGP Peering.
</dd>
