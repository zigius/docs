...
<dl class="resources-properties">
    ...
    <dd>The Name of the Resource Group in which this VPN Server Configuration should be created. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>A list of one of more Authentication Types applicable for this VPN Server Configuration. Possible values are `AAD` (Azure Active Directory), `Certificate` and `Radius`.
</dd>
    ...
    <dd>A `azure_active_directory_authentication` block as defined below.
</dd>
    ...
    <dd>One or more `client_revoked_certificate` blocks as defined below.
</dd>
    ...
    <dd>One or more `client_root_certificate` blocks as defined below.
</dd>
    ...
    <dd>A `ipsec_policy` block as defined below.
</dd>
    ...
    <dd>The Azure location where this VPN Server Configuration should be created. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>The Name which should be used for this VPN Server Configuration. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>A `radius_server` block as defined below.
</dd>
    ...
    <dd>A list of VPN Protocols to use for this Server Configuration. Possible values are `IkeV2` and `OpenVPN`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The Audience which should be used for authentication.
</dd>
    ...
    <dd>The Issuer which should be used for authentication.
</dd>
    ...
    <dd>The Tenant which should be used for authentication.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A name used to uniquely identify this certificate.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The Public Key Data associated with the Certificate.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The DH Group, used in IKE Phase 1. Possible values include `DHGroup1`, `DHGroup2`, `DHGroup14`, `DHGroup24`, `DHGroup2048`, `ECP256`, `ECP384` and `None`.
</dd>
    ...
    <dd>The IKE encryption algorithm, used for IKE Phase 2. Possible values include `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128` and `GCMAES256`.
</dd>
    ...
    <dd>The IKE encryption integrity algorithm, used for IKE Phase 2. Possible values include `GCMAES128`, `GCMAES256`, `MD5`, `SHA1`, `SHA256` and `SHA384`.
</dd>
    ...
    <dd>The IPSec encryption algorithm, used for IKE phase 1. Possible values include `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128`, `GCMAES192`, `GCMAES256` and `None`.
</dd>
    ...
    <dd>The IPSec integrity algorithm, used for IKE phase 1. Possible values include `GCMAES128`, `GCMAES192`, `GCMAES256`, `MD5`, `SHA1` and `SHA256`.
</dd>
    ...
    <dd>The Pfs Group, used in IKE Phase 2. Possible values include `ECP256`, `ECP384`, `PFS1`, `PFS2`, `PFS14`, `PFS24`, `PFS2048`, `PFSMM` and `None`.
</dd>
    ...
    <dd>The IPSec Security Association payload size in KB for a Site-to-Site VPN tunnel.
</dd>
    ...
    <dd>The IPSec Security Association lifetime in seconds for a Site-to-Site VPN tunnel.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The Secret used to communicate with the Radius Server.
</dd>
    ...
    <dd>One or more `server_root_certificate` blocks as defined below.
</dd>
    ...
    <dd>One or more `client_root_certificate` blocks as defined above.
</dd>
