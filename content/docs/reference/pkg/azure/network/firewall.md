...
<dl class="resources-properties">
    ...
    <dd>A `ip_configuration` block as documented below.
</dd>
    ...
    <dd>Specifies the name of the Firewall. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>Specifies the availability zones in which the Azure Firewall should be created.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the name of the IP Configuration.
</dd>
    ...
    <dd>The Resource ID of the Public IP Address associated with the firewall.
</dd>
    ...
    <dd>The private IP address of the Azure Firewall.
</dd>
    ...
    <dd>Reference to the subnet associated with the IP Configuration.
</dd>
