...
title_tag: "Resource PublicIpPrefix | Module network | Package Azure"
meta_desc: "Explore the PublicIpPrefix resource of the network module, including examples, input properties, output properties, lookup functions, and supporting types. Manages a Public IP Prefix."
---
...
<dl class="resources-properties">
    ...
    <dd>The name of the resource group in which to create the Public IP Prefix.
</dd>
    ...
    <dd>Specifies the name of the Public IP Prefix resource . Changing this forces a new resource to be created.
</dd>
    ...
    <dd>Specifies the number of bits of the prefix. The value can be set between 28 (16 addresses) and 31 (2 addresses). Changing this forces a new resource to be created.
</dd>
    ...
    <dd>The SKU of the Public IP Prefix. Accepted values are `Standard`. Defaults to `Standard`. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>A collection containing the availability zone to allocate the Public IP Prefix in.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The IP address prefix value that was allocated.
</dd>
