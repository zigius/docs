...
<dl class="resources-properties">
    ...
    <dd>The IoT Hub endpoint to connect to (ie. messages/events, messages/operationsMonitoringEvents, etc.).
</dd>
    ...
    <dd>The name of an Event Hub Consumer Group that should be used to read events from the Event Hub. Specifying distinct consumer group names for multiple inputs allows each of those inputs to receive the same events from the Event Hub.
</dd>
    ...
    <dd>The name or the URI of the IoT Hub.
</dd>
    ...
    <dd>The shared access policy key for the specified shared access policy.
</dd>
    ...
    <dd>The shared access policy name for the Event Hub, Service Bus Queue, Service Bus Topic, etc.
</dd>
    ...
    <dd>The name of the Stream Input IoTHub. Changing this forces a new resource to be created.
</dd>
