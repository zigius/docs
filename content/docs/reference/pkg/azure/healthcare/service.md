...
<dl class="resources-properties">
    ...
    <dd>The name of the Resource Group in which to create the Service.
</dd>
    ...
    <dd>An `authentication_configuration` block as defined below.
</dd>
    ...
    <dd>A `cors_configuration` block as defined below.
</dd>
    ...
    <dd>The provisioned throughput for the backing database. Range of `400`-`1000`. Defaults to `400`.
</dd>
    ...
    <dd>The type of the service. Values at time of publication are: `fhir`, `fhir-Stu3` and `fhir-R4`. Default value is `fhir`.
</dd>
    ...
    <dd>Specifies the supported Azure Region where the Service should be created.
</dd>
    ...
    <dd>The name of the service instance. Used for service endpoint, must be unique within the audience.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The intended audience to receive authentication tokens for the service. The default value is https://azurehealthcareapis.com
</dd>
    ...
    <dd>The Azure Active Directory (tenant) that serves as the authentication authority to access the service. The default authority is the Directory defined in the authentication scheme in use when running this provider.
Authority must be registered to Azure AD and in the following format: https://{Azure-AD-endpoint}/{tenant-id}.
    ...
    <dd>Enables the 'SMART on FHIR' option for mobile and web implementations.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>If credentials are allowed via CORS.
</dd>
    ...
    <dd>A set of headers to be allowed via CORS.
</dd>
    ...
    <dd>The methods to be allowed via CORS.
</dd>
    ...
    <dd>A set of origins to be allowed via CORS.
</dd>
    ...
    <dd>The max age to be allowed via CORS.
</dd>
