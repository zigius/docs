...
<dl class="resources-properties">
    ...
    <dd>The ID of the App Service Plan within which to create this App Service.
</dd>
    ...
    <dd>The name of the resource group in which to create the App Service.
</dd>
    ...
    <dd>A `backup` block as defined below.
</dd>
    ...
    <dd>Should the App Service send session affinity cookies, which route client requests in the same session to the same instance?
</dd>
    ...
    <dd>Does the App Service require client certificates for incoming requests? Defaults to `false`.
</dd>
    ...
    <dd>One or more `connection_string` blocks as defined below.
</dd>
    ...
    <dd>Can the App Service only be accessed via HTTPS? Defaults to `false`.
</dd>
    ...
    <dd>A `logs` block as defined below.
</dd>
    ...
    <dd>Specifies the name of the App Service. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>One or more `storage_account` blocks as defined below.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A `source_control` block as defined below, which contains the Source Control information when `scm_type` is set to `LocalGit`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Specifies the name for this Backup.
</dd>
    ...
    <dd>A `schedule` block as defined below.
</dd>
    ...
    <dd>The SAS URL to a Storage Container where Backups should be saved.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Sets how often the backup should be executed.
</dd>
    ...
    <dd>Sets the unit of time for how often the backup should be executed. Possible values are `Day` or `Hour`.
</dd>
    ...
    <dd>Should at least one backup always be kept in the Storage Account by the Retention Policy, regardless of how old it is?
</dd>
    ...
    <dd>Specifies the number of days after which Backups should be deleted.
</dd>
    ...
    <dd>Sets when the schedule should start working.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The version of the .net framework's CLR used in this App Service. Possible values are `v2.0` (which will use the latest version of the .net framework for the .net CLR v2 - currently `.net 3.5`) and `v4.0` (which corresponds to the latest version of the .net CLR v4 - which at the time of writing is `.net 4.7.1`). [For more information on which .net CLR version to use based on the .net framework you're targeting - please see this table](https://en.wikipedia.org/wiki/.NET_Framework_version_history#Overview). Defaults to `v4.0`.
</dd>
    ...
    <dd>State of FTP / FTPS service for this App Service. Possible values include: `AllAllowed`, `FtpsOnly` and `Disabled`.
</dd>
    ...
    <dd>The Java Container to use. If specified `java_version` and `java_container_version` must also be specified. Possible values are `JAVA`, `JETTY`, and `TOMCAT`.
</dd>
    ...
    <dd>Linux App Framework and version for the App Service. Possible options are a Docker container (`DOCKER|<user/image:tag>`), a base-64 encoded Docker Compose file (`COMPOSE|${filebase64("compose.yml")}`) or a base-64 encoded Kubernetes Manifest (`KUBE|${filebase64("kubernetes.yml")}`).
</dd>
    ...
    <dd>The version of PHP to use in this App Service. Possible values are `5.5`, `5.6`, `7.0`, `7.1`, `7.2`, and `7.3`.
</dd>
    ...
    <dd>The version of Python to use in this App Service. Possible values are `2.7` and `3.4`.
</dd>
    ...
    <dd>The type of Source Control enabled for this App Service. Defaults to `None`. Possible values are: `BitbucketGit`, `BitbucketHg`, `CodePlexGit`, `CodePlexHg`, `Dropbox`, `ExternalGit`, `ExternalHg`, `GitHub`, `LocalGit`, `None`, `OneDrive`, `Tfs`, `VSO`, and `VSTSRM`
</dd>
    ...
    <dd>Should the App Service run in 32 bit mode, rather than 64 bit mode?
</dd>
    ...
    <dd>The Windows Docker container image (`DOCKER|<user/image:tag>`)
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The IP Address used for this IP Restriction in CIDR notation.
</dd>
    ...
    <dd>The Virtual Network Subnet ID used for this IP Restriction.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Branch name of the Git repository for this App Service.
</dd>
    ...
    <dd>URL of the Git repository for this App Service.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The access key for the storage account.
</dd>
    ...
    <dd>The name of the storage account.
</dd>
    ...
    <dd>The name of the storage account identifier.
</dd>
    ...
    <dd>The name of the file share (container name, for Blob storage).
</dd>
    ...
    <dd>The type of storage. Possible values are `AzureBlob` and `AzureFiles`.
</dd>
    ...
    <dd>The path to mount the storage within the site's runtime environment.
</dd>
