...
<dl class="resources-properties">
    ...
    <dd>The name of the Function App resource.
</dd>
    ...
    <dd>The name of the Resource Group where the Function App exists.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The default hostname associated with the Function App.
</dd>
    ...
    <dd>A comma separated list of outbound IP addresses.
</dd>
    ...
    <dd>A comma separated list of outbound IP addresses, not all of which are necessarily in use. Superset of `outbound_ip_addresses`.
</dd>
