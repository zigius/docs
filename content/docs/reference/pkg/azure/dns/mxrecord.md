...
<dl class="resources-properties">
    ...
    <dd>A list of values that make up the MX record. Each `record` block supports fields documented below.
</dd>
    ...
    <dd>The name of the DNS MX Record. Defaults to `@` (root). Changing this forces a new resource to be created.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The FQDN of the DNS MX Record.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The mail server responsible for the domain covered by the MX record.
</dd>
    ...
    <dd>String representing the "preference” value of the MX records. Records with lower preference value take priority.
</dd>
