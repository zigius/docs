...
<dl class="resources-properties">
    ...
    <dd>Name of fabric that should contains the protection container to map.
</dd>
    ...
    <dd>Id of the policy to use for this mapping.
</dd>
    ...
    <dd>Name of the source protection container to map.
</dd>
    ...
    <dd>Id of target protection container to map to.
</dd>
