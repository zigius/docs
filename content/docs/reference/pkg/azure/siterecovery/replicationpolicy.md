...
<dl class="resources-properties">
    ...
    <dd>Specifies the frequency(in minutes) at which to create application consistent recovery points.
</dd>
    ...
    <dd>The duration in minutes for which the recovery points need to be stored.
</dd>
