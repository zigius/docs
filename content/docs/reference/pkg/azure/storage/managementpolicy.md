...
<dl class="resources-properties">
    ...
    <dd>Specifies the id of the storage account to apply the management policy to.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The age in days after last modification to delete the blob. Must be at least 0.
</dd>
    ...
    <dd>The age in days after last modification to tier blobs to archive storage. Supports blob currently at Hot or Cool tier. Must be at least 0.
</dd>
    ...
    <dd>The age in days after last modification to tier blobs to cool storage. Supports blob currently at Hot tier. Must be at least 0.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The age in days after create to delete the snaphot. Must be at least 0.
</dd>
