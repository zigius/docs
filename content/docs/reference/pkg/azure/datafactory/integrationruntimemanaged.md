...
<dl class="resources-properties">
    ...
    <dd>Specifies the name of the Data Factory the Managed Integration Runtime belongs to. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>The size of the nodes on which the Managed Integration Runtime runs. Valid values are: `Standard_D2_v3`, `Standard_D4_v3`, `Standard_D8_v3`, `Standard_D16_v3`, `Standard_D32_v3`, `Standard_D64_v3`, `Standard_E2_v3`, `Standard_E4_v3`, `Standard_E8_v3`, `Standard_E16_v3`, `Standard_E32_v3`, `Standard_E64_v3`, `Standard_D1_v2`, `Standard_D2_v2`, `Standard_D3_v2`, `Standard_D4_v2`, `Standard_A4_v2` and `Standard_A8_v2`
</dd>
    ...
    <dd>The name of the resource group in which to create the Managed Integration Runtime. Changing this forces a new resource to be created.
</dd>
    ...
    <dd>A `catalog_info` block as defined below.
</dd>
    ...
    <dd>A `custom_setup_script` block as defined below.
</dd>
    ...
    <dd>The Managed Integration Runtime edition. Valid values are `Standard` and `Enterprise`. Defaults to `Standard`.
</dd>
    ...
    <dd>The type of the license that is used. Valid values are `LicenseIncluded` and `BasePrize`. Defaults to `LicenseIncluded`.
</dd>
    ...
    <dd>Defines the maximum parallel executions per node. Defaults to `1`. Max is `16`.
</dd>
    ...
    <dd>Specifies the name of the Managed Integration Runtime. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
</dd>
    ...
    <dd>Number of nodes for the Managed Integration Runtime. Max is `10`. Defaults to `1`.
</dd>
    ...
    <dd>A `vnet_integration` block as defined below.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Administrator login name for the SQL Server.
</dd>
    ...
    <dd>Administrator login password for the SQL Server.
</dd>
    ...
    <dd>The endpoint of an Azure SQL Server that will be used to host the SSIS catalog.
</dd>
    ...
    <dd>Pricing tier for the database that will be created for the SSIS catalog. Valid values are: `Basic`, `Standard`, `Premium` and `PremiumRS`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>A container SAS token that gives access to the files. See [https://docs.microsoft.com/en-us/azure/data-factory/how-to-configure-azure-ssis-ir-custom-setup](https://docs.microsoft.com/en-us/azure/data-factory/how-to-configure-azure-ssis-ir-custom-setup) for more information.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>Name of the subnet to which the nodes of the Managed Integration Runtime will be added.
</dd>
    ...
    <dd>ID of the virtual network to which the nodes of the Managed Integration Runtime will be added.
</dd>
