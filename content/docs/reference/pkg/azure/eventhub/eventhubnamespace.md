...
<dl class="resources-properties">
    ...
    <dd>Defines which tier to use. Valid options are `Basic` and `Standard`.
</dd>
    ...
    <dd>Specifies the Capacity / Throughput Units for a `Standard` SKU namespace. Valid values range from `1` - `20`.
</dd>
    ...
    <dd>Specifies the maximum number of throughput units when Auto Inflate is Enabled. Valid values range from `1` - `20`.
</dd>
    ...
    <dd>A `network_rulesets` block as defined below.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The default action to take when a rule is not matched. Possible values are `Allow` and `Deny`.
</dd>
    ...
    <dd>One or more `virtual_network_rule` blocks as defined below.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The action to take when the rule is  matched. Possible values are `Allow`.
</dd>
...
<dl class="resources-properties">
    ...
    <dd>The id of the subnet to match on.
</dd>
    ...
    <dd>Are missing virtual network service endpoints ignored? Defaults to `false`.
</dd>
